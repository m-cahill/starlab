"""CLI: emit V15-M21 operator T1 execution JSON + report + runbook."""
...
from starlab.v15.operator_t1_30min_gpu_run_execution_io import (
    ...
    emit_operator_preflight_execution,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Emit V15-M21 operator T1 30-minute GPU run execution artifacts. "
    ...
    parser.add_argument(
        ...
        help="fixture_default (CI) or operator_preflight validation snapshot.",
    )
    parser.add_argument(
