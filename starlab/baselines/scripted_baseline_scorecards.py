"""Build M20-conformant scorecards for the M21 scripted baseline suite."""
...
from starlab.baselines.scripted_baseline_models import (
    SCRIPTED_BASELINE_SCORECARD_NON_CLAIMS_V1,
    SCRIPTED_BASELINE_SCORECARD_WARNINGS_V1,
)
from starlab.benchmarks.benchmark_scorecard_schema import validate_benchmark_scorecard


def build_scripted_scorecard(
    *,
    ...
    warnings = sorted(SCRIPTED_BASELINE_SCORECARD_WARNINGS_V1)
    non_claims = sorted(SCRIPTED_BASELINE_SCORECARD_NON_CLAIMS_V1)
