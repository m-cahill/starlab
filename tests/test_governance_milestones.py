...
_MILESTONE_COMPLETE_ROWS = [
    ...
    pytest.param("M41", "Replay-Imitation Training Pipeline", marks=pytest.mark.smoke),
    pytest.param("M42", "Learned-Agent Comparison", marks=pytest.mark.smoke),
    pytest.param("M43", "Hierarchical Training Pipeline", marks=pytest.mark.smoke),
    pytest.param("M45", "Self-Play / RL Bootstrap", marks=pytest.mark.smoke),
    ...
    pytest.param("M52", "V1 Endgame Recharter", marks=pytest.mark.smoke),
]
...
_MILESTONE_FOLDERS: list[Any] = [
    ...
    pytest.param(
        _MilestoneFolder("M36", _closeout_filenames("M36")),
        marks=pytest.mark.smoke,
        id="M36",
    ),
    pytest.param(
    ...
    pytest.param(
        _MilestoneFolder("M40", ("M40_plan.md", "M40_toolcalls.md")),
        marks=pytest.mark.smoke,
        id="M40",
    ),
    pytest.param(
        _MilestoneFolder("M41", ("M41_plan.md", "M41_toolcalls.md")),
        marks=pytest.mark.smoke,
        id="M41",
    ),
    pytest.param(
        _MilestoneFolder("M42", ("M42_plan.md", "M42_toolcalls.md")),
        marks=pytest.mark.smoke,
        id="M42",
    ),
    pytest.param(
        _MilestoneFolder("M43", ("M43_plan.md", "M43_toolcalls.md")),
        marks=pytest.mark.smoke,
        id="M43",
    ),
    pytest.param(
        _MilestoneFolder("M44", ("M44_plan.md", "M44_toolcalls.md")),
        marks=pytest.mark.smoke,
        id="M44",
    ),
    pytest.param(
        _MilestoneFolder("M45", _closeout_filenames("M45")),
        marks=pytest.mark.smoke,
        id="M45",
    ),
    pytest.param(
        _MilestoneFolder("M46", _closeout_filenames("M46")),
        marks=pytest.mark.smoke,
        id="M46",
    ),
    pytest.param(
        _MilestoneFolder("M47", _closeout_filenames("M47")),
        marks=pytest.mark.smoke,
        id="M47",
    ),
    pytest.param(
        _MilestoneFolder("M48", _closeout_filenames("M48")),
        marks=pytest.mark.smoke,
        id="M48",
    ),
    pytest.param(
    ...
    pytest.param(
        _MilestoneFolder("M51", ("M51_plan.md", "M51_toolcalls.md")),
        marks=pytest.mark.smoke,
        id="M51",
    ),
    pytest.param(
        _MilestoneFolder("M52", _closeout_filenames("M52")),
        marks=pytest.mark.smoke,
        id="M52",
    ),
    pytest.param(
        _MilestoneFolder("M53", ("M53_plan.md", "M53_toolcalls.md")),
        marks=pytest.mark.smoke,
        id="M53",
    ),
]
