...
_GOVERNANCE_DOCS = [
    ...
    "docs/runtime/px1_full_industrial_campaign_execution_evidence_v1.md",
    ...
    "docs/runtime/px2_neural_bootstrap_from_replays_v1.md",
    "docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md",
    "docs/runtime/px2_industrial_self_play_campaign_v1.md",
    ...
    "docs/runtime/v15_sc2_backed_candidate_checkpoint_evaluation_package_v1.md",
    ...
    "docs/runtime/v15_twelve_hour_blocker_discovery_launch_rehearsal_v1.md",
