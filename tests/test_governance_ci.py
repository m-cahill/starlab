...
@pytest.mark.smoke
def test_current_milestone_is_m41_in_progress_after_m40_closeout() -> None:
    text = (REPO_ROOT / "docs" / "starlab.md").read_text(encoding="utf-8")
...
def test_ledger_milestone_table_m37_m45_rows() -> None:
    ...
    assert "| M41 |" in sec and "Replay-Imitation Training Pipeline" in sec and "In progress" in sec
