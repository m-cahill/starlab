...
**Commit SHA (current PR tip after ledger alignment):** `22b2b57654c9bc5124059227f363b27ccc63ed6f`
...
| PR head SHA | `22b2b57654c9bc5124059227f363b27ccc63ed6f` |
...
| Run ID (authoritative, current tip) | **24053264747** |
| URL | https://github.com/m-cahill/starlab/actions/runs/24053264747 |
| Event | `pull_request` |
| Head SHA | `22b2b57654c9bc5124059227f363b27ccc63ed6f` |
| Conclusion | **success** |
| Authoritative for merge? | **Yes** — green run on latest PR tip (verified `gh run list` / `gh pr view 3`) |

**Earlier PR-head runs (older tips; not the current ledger contract):** `24053218335` on `d80ae12…`; `24052325999` on `f457cf5…`; `24052291273` on `79b341a…`; `24052230417` on `5f5c8a5…`; `24052172714` on `59dcf15…`; `24052112581` on `1bd98f1…`; `24052043305` on `8884078…`.
...
- After push of doc alignment commit `d80ae12322c3d2c45c754bb298ac895a8cbe7335`, GitHub **CI** run **`24053218335`** (success) was the gate for that tip; subsequent tip **`22b2b57654c9bc5124059227f363b27ccc63ed6f`** + run **`24053264747`** is the **current** authoritative pair (ledger rows above).
