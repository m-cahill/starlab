...
**Commit SHA (current PR tip after ledger alignment):** `3952c4071d82a77e633b0cd428da19caac2720ff`
...
| PR head SHA | `3952c4071d82a77e633b0cd428da19caac2720ff` |
...
| Run ID (authoritative, current tip) | **24053430560** |
| URL | https://github.com/m-cahill/starlab/actions/runs/24053430560 |
| Event | `pull_request` |
| Head SHA | `3952c4071d82a77e633b0cd428da19caac2720ff` |
| Conclusion | **success** |
| Authoritative for merge? | **Yes** — green run on latest PR tip (verified `gh run list` / `gh pr view 3`) |

**Earlier PR-head runs (older tips; not the current ledger contract):** `24053381609` on `08fb582…`; `24053317502` on `10a2b13…`; `24053264747` on `22b2b57…`; `24053218335` on `d80ae12…`; `24052325999` on `f457cf5…`; `24052291273` on `79b341a…`; `24052230417` on `5f5c8a5…`; `24052172714` on `59dcf15…`; `24052112581` on `1bd98f1…`; `24052043305` on `8884078…`.
...
- After push of doc alignment commit `d80ae12322c3d2c45c754bb298ac895a8cbe7335`, GitHub **CI** run **`24053218335`** (success) was the gate for that tip; intermediate tips included **`22b2b57654c9bc5124059227f363b27ccc63ed6f`** + **`24053264747`**, then **`10a2b13ba8115e50037948c014facaa502da6978`** + **`24053317502`**, then **`08fb582fa8fe969a02de82257d64dedfea2ff35f`** + **`24053381609`**. **Current** ledger row (above): **`3952c4071d82a77e633b0cd428da19caac2720ff`** + **`24053430560`** — **session ended**; further doc-only pushes will advance the tip again.
