...
| PR-head CI | Run `24053218335` — **success** on head `d80ae12322c3d2c45c754bb298ac895a8cbe7335` — see `M02_run1.md`. |
...
| CI green without SC2 | **Met** | Run `24053218335` |
...
| PR head (at CI) | `d80ae12322c3d2c45c754bb298ac895a8cbe7335` |
| PR-head CI | https://github.com/m-cahill/starlab/actions/runs/24053218335 |
