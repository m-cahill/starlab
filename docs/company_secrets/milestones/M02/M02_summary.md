...
| PR-head CI | Run `24054586191` — **success** on head `c03691b61b8d11aafda55f866232f6d623c70628` — see `M02_run1.md`. |
...
| CI green without SC2 | **Met** | Run `24054586191` |
...
| PR head (at CI) | `c03691b61b8d11aafda55f866232f6d623c70628` |
| PR-head CI | https://github.com/m-cahill/starlab/actions/runs/24054586191 |
