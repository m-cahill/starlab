...
| PR-head CI | Run `24052230417` — **success** on head `5f5c8a52684b7bc29642b8d52ba5758d21f28f20` — see `M02_run1.md`. |
...
| CI green without SC2 | **Met** | Run `24052230417` |
...
| PR head (at CI) | `5f5c8a52684b7bc29642b8d52ba5758d21f28f20` |
| PR-head CI | https://github.com/m-cahill/starlab/actions/runs/24052230417 |
