...
| PR-head CI | Run `24053381609` — **success** on head `08fb582fa8fe969a02de82257d64dedfea2ff35f` — see `M02_run1.md`. |
...
| CI green without SC2 | **Met** | Run `24053381609` |
...
| PR head (at CI) | `08fb582fa8fe969a02de82257d64dedfea2ff35f` |
| PR-head CI | https://github.com/m-cahill/starlab/actions/runs/24053381609 |
