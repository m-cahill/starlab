...
| Last closed milestone (PX1 arc) | **PX1-M02** — Play-Quality Evaluation & Demo Candidate Selection — **closed** on `main` (milestone closeout [PR #89](https://github.com/m-cahill/starlab/pull/89)). **Prior:** **PX1-M01** — Full Industrial Campaign Execution Evidence — **closed** on `main` (milestone closeout [PR #87](https://github.com/m-cahill/starlab/pull/87)). **Prior:** **PX1-M00** — Full Industrial Run & Demonstration Charter — **closed** on `main` (implementation [PR #83](https://github.com/m-cahill/starlab/pull/83); closeout [PR #84](https://github.com/m-cahill/starlab/pull/84)). **Governance-first** charter only (**PX1-M00**) — **no** campaign execution; **no** demo recording; **did not** open **PX1-M03**+ or **v2** at PX1-M00 closeout. |
...
| Current milestone | **`PX1-M03`** — Candidate Strengthening & Demo Readiness Remediation — **open** on `main` (PR1: ledger + runtime + protocol freeze + hybrid **`local_live_sc2`** surface). **PX1-M02** — Play-Quality Evaluation & Demo Candidate Selection — **closed** on `main` (closeout [PR #89](https://github.com/m-cahill/starlab/pull/89)); honest **`no-candidate-selected`** (authoritative operator-local series under `out/training_campaigns/px1_m01_full_run_2026_04_17_a/px1_m02_eval_series_final`). **PX1-M01** — **closed** on `main` (closeout [PR #87](https://github.com/m-cahill/starlab/pull/87)). **`PX1-M04`–`PX1-M05`** are **planned / not yet opened** (governed demo/video only if justified after **PX1-M03**). **v2** is **not** opened. **PV1** is **closed** and **historical** — bounded **PV1** outcome (**unchanged**). **v1** **M00–M61** remains **closed** — **no** **M62**. |
...
| PX1 demo readiness status (PX1-M03) | **remediation in progress** — PR1 open; bounded hybrid live action surface + **`px1_demo_readiness_*`** protocol freeze; honest closeout will record **`demo-ready-candidate-selected`** or **`no-demo-ready-candidate-within-scope`**; public runtime **`docs/runtime/px1_candidate_strengthening_demo_readiness_v1.md`**. |
...
| Next planned follow-on | **`PX1-M04`–`PX1-M05`** remain **planned / not yet opened** until **separately** chartered — **`PX1-M03` closeout does not open them**. **`PX1-M02`** **did not** open automatically from **PX1-M01** closeout; **`PX1-M03`** opened by explicit PR (not automatic from **PX1-M02**). **`PX1-M04`** (governed demo/video) **does not** open automatically from **PX1-M03**. **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **not** opened. |
...
| Still **not** proved today (present tense) | **Benchmark integrity** (global / beyond bounded milestone scope), **replay↔execution equivalence** (global / gameplay-semantic), **live SC2 in CI as default merge-gate / global proof**, **ladder / public performance**, **statistical significance of ranking** (M42 does **not** claim this), **operating manual v1** — see §11 *explicit non-claims*. **M61** **closed** with operator-local evidence + **`ready_within_scope`** **does not** change these boundaries — **not** global benchmark integrity; **not** universal replay↔execution equivalence; **not** merge-gate live SC2; **not** ladder/public performance. The *Remaining v1 proof-track map* below is **historical** — all Phase VII rows are **complete** on `main`. **PX1-class gaps (present tense):** **PX1-M02** is **closed** with **`no-candidate-selected`** — **demo-worthy** bounded selection under the play-quality protocol was **not** achieved. **PX1-M03** is **open** for **corrective demo-readiness remediation** (not the winning-video milestone). **Governed demo proof pack / winning video** (**PX1-M04**) is **not** closed until separately opened and completed after **PX1-M03**. **PX1-M01** is **closed** with **authoritative** operator-local **`threshold-met`** — **not** play-quality proof; **not** demo/video proof; **not** ladder strength. **PX1-M00** is **closed** as a **governance charter** milestone — **does not** claim play-quality or demo proof are satisfied. |
...
### PX1 roadmap (PX1-M00 **closed**; **PX1-M01** **closed**; **PX1-M02** **closed**; **PX1-M03** **open**; **PX1-M04**+ **not** opened)
...
| `PX1-M03` | Candidate Strengthening & Demo Readiness Remediation | **current / open** | Corrective milestone after **PX1-M02**; bounded hybrid live surface + **`px1_demo_readiness_*`** protocol; closes with **`demo-ready-candidate-selected`** or **`no-demo-ready-candidate-within-scope`** — **not** the winning-video milestone |
| `PX1-M04` | Governed Demo Proof Pack & Winning Video | **planned / not yet opened** | Only if **PX1-M03** produces a genuinely demo-ready candidate — **does not** open automatically |
...
**Roadmap disclaimer:** **PX1-M04**–**PX1-M05** are **not** opened by **PX1-M00**/**PX1-M01**/**PX1-M02** (closed) or by **PX1-M03** merge alone. **PX1** is **not** implied by closed **PV1** merges.

**Ledger truths (PX1 phase, **PX1-M03** **open**):**
...
- **`current milestone`** = **`PX1-M03`** — **PX1-M02** **closed** with **`no-candidate-selected`** (no demo-ready candidate under that protocol). **PX1-M01** **closed** on `main` with **authoritative** operator-local **`threshold-met`** — industrial run success **only**.
- **v2** is **not** opened.
- **`PX1-M04`–`PX1-M05`** are **planned / not yet opened** — **PX1-M04** **does not** open automatically from **PX1-M03** closeout.
- **Governed winning demo / video proof** (**PX1-M04**) is **not** earned by **PX1-M02** or **PX1-M03** PR1 merge alone — **PX1-M03** must complete with evidence + honest declaration.
...
**Current (PX1-M03 open / PR1):** **`current milestone`** = **`PX1-M03`** — Candidate Strengthening & Demo Readiness Remediation — **open** on `main` (governance + hybrid bounded **`local_live_sc2`** surface + **`px1_demo_readiness_*`** protocol freeze + deterministic emitters). **PX1-M02** — Play-Quality Evaluation & Demo Candidate Selection — **closed** on `main` (closeout [PR #89](https://github.com/m-cahill/starlab/pull/89)); final authoritative bounded **`local_live_sc2`** evaluation under **protocol profile v2** (`px1_m02_eval_series_final`) concluded with honest **`no-candidate-selected`** — **preserved**; **not** reinterpreted as success. **PX1-M01** — Full Industrial Campaign Execution Evidence — **closed** on `main` (closeout [PR #87](https://github.com/m-cahill/starlab/pull/87)) — **`threshold-met`** — **not** play-quality. **`PX1-M04`–`PX1-M05`** **planned / not yet opened** — **PX1-M04** (governed demo/video) **does not** open automatically from **PX1-M03**. **v2** is **not** opened. **v1** (**M00–M61**) is **closed** and **historical**. **PV1** is **closed** and **historical** (bounded outcome **unchanged**).

### PX1-M03 — Candidate Strengthening & Demo Readiness Remediation — **open** (`main`)

**PR1 (opening / freeze):** Delivers public runtime **`docs/runtime/px1_candidate_strengthening_demo_readiness_v1.md`**; **`starlab.sc2.emit_px1_demo_readiness_protocol`** + **`starlab.sc2.emit_px1_demo_readiness_evidence`**; hybrid **`burnysc2_policy`** `px1_m03_hybrid_v1` (Terran macro scaffold + narrow M43-throttled combat) + proof tallies on **`match_execution_proof.json`**; fixtures under **`tests/fixtures/px1_m03/`**; private **`PX1-M03_*`** milestone docs — **does not** claim **`demo-ready-candidate-selected`** until operator reruns + honest closeout; **does not** open **PX1-M04** or **v2**.

**Intent:** Corrective milestone after **PX1-M02** **`no-candidate-selected`** — bounded capability uplift + fresh remediation evaluation — **not** the winning-video milestone (**PX1-M04**).

**Non-claims (PX1-M03 PR1):** **not** governed winning demo proof; **not** automatic **PX1-M04**; operator-local decisive reruns follow merge.
...
### 2026-04-18 — **PX1-M03** Candidate Strengthening & Demo Readiness Remediation — **opened** on `main` (PR1 — ledger + runtime + protocol freeze + hybrid surface)
...
- **Post-PR1 ledger:** **`PX1-M03`** **open** until operator remediation reruns + PR2 closeout.
