...
| ----- | ------------------------ |
| Program arc | **62 milestones (M00–M61)** — see §7 (**M55**–**M57** **closed** on `main` — benchmark-integrity **charter** (**M55**) + bounded **evidence/gates** (**M56**) + narrow live-SC2-in-CI **charter + controlled runner** (**M57**) — **not** global benchmark integrity proof; **not** global live-SC2-in-CI proof; **M58**–**M61** **stub/planned** except as closed later). |
| Last closed milestone | **M57** — Narrow live SC2 in CI charter & controlled runner v1 (merged to `main`; see §11 / §18). |
| Current milestone | **M58** — Live SC2 in CI hardening & cost guardrails v1 — **stub/planned** (Phase VII; follows **M57** **closed** — bounded charter + **M44** wrap — **not** default merge-gate live SC2). **M56** **closed** — bounded benchmark-integrity evidence + gates — **not** global proof. **Not** replay↔execution equivalence (**M52**–**M54** **closed**). |
...
Planned program arc (**62 milestones**, **M00**–**M61** — **M52**–**M57** **closed** on `main` (through benchmark-integrity **charter** (**M55**) + bounded **evidence/gates** (**M56**) + narrow live-SC2-in-CI **charter + controlled runner** (**M57**) milestones); **M58**–**M61** stub/planned; **M51** **closed** on `main`):
...
**Status:** current milestone pointer (**Phase VII**). **Depends on:** **M57** **closed** on `main` — narrow live-SC2-in-CI charter + controlled runner — **not** default merge-gate live SC2; **not** global live-SC2-in-CI proof.

**Intent (stub):** hardening + cost guardrails following the bounded **M57** surface — **not** defined at this ledger revision. Folder: `docs/company_secrets/milestones/M58/`.
