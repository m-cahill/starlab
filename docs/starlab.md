...
| **M32** | **Public flagship proof pack** (planned; **stub-only** until chartered). |
...
**Explicit non-claims (M31):** not benchmark integrity, not live SC2, not web UI, not M32 flagship proof pack product.
...
- **Public flagship proof pack** (M32 charter — **stub-only** until authorized).
...
- Product: `docs/runtime/replay_explorer_surface_v1.md`, `starlab/explorer/*`, `tests/fixtures/m31/`, `tests/test_replay_explorer_surface.py`; **558** pytest on merge-boundary `main` CI [`24226308356`](https://github.com/m-cahill/starlab/actions/runs/24226308356) (one pre-existing `s2protocol` deprecation warning in replay CLI tests — unchanged)
