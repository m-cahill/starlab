...
| Last closed milestone (PX2 arc) | **PX2-M00** — Autonomous Full-Game Agent Charter & Success Criteria — **closed** on `main` (governance closeout [PR #94](https://github.com/m-cahill/starlab/pull/94)). **Prior:** (none). **Governance-first** charter + ledger only — **not** Terran runtime; **not** training; **not** Blackwell execution. |
| Current milestone | **`PX2-M01`** — Full Terran Runtime & Action Surface — **open** on `main` (runtime/action substrate only — public **`docs/runtime/px2_full_terran_runtime_action_surface_v1.md`** + `starlab.sc2.px2` — **not** training; **not** Blackwell execution; **not** strength proof). **PX2-M00** — **closed** — charter **`docs/runtime/px2_autonomous_full_game_agent_charter_v1.md`**. **PX1-M04** — **closed** ([PR #93](https://github.com/m-cahill/starlab/pull/93)) — **packaging / proof governance** only; **does not** auto-open **`PX1-M05`** or **v2**. **`PX1-M05`** remains **optional / not yet opened**. **`PX2-M02`** — **not** opened automatically by **`PX2-M01`**. **v2** is **not** opened. **v1** (**M00–M61**), **PV1**, and the **PX1** milestone arc (**PX1-M00**–**PX1-M04**) remain **closed** / **historical** as stated. |
...
| Next planned follow-on | **`PX2-M02`** — Neural Bootstrap from Replays — next **recorded** follow-on on the **PX2** roadmap — **not** opened automatically by **`PX2-M01`**. **`PX1-M05`** remains **optional / not yet opened** — **does not** open automatically from **PX1-M04** closeout. **`PX1-M04`** **does not** open **PX1-M05** or **v2**. **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **deferred** / **not** opened. |
...
| **PX2** | **PX2-M00** **closed** (charter). **PX2-M01** **open** — versioned Terran runtime/action substrate (`docs/runtime/px2_full_terran_runtime_action_surface_v1.md`; **not** strength proof) | Replay-bootstrap policy (**PX2-M02**+); industrial Blackwell campaign; demo refresh — **later milestones** | **PX2-M00**–**PX2-M05** (roadmap) |
...
### PX2 roadmap (**PX2-M00** **closed**; **PX2-M01** **open** on `main`; **PX2-M02**–**PX2-M05** **planned**)
...
| `PX2-M01` | Full Terran Runtime & Action Surface | **open** on `main` | Public **`docs/runtime/px2_full_terran_runtime_action_surface_v1.md`**; `starlab.sc2.px2` — structured actions, legality, compiler, receipts — **not** training; **not** strength proof |
| `PX2-M02` | Neural Bootstrap from Replays | **planned** | First replay-bootstrapped learned full-game policy (bounded claims) — **not** opened by **PX2-M01** |
| `PX2-M03` | Industrial Self-Play Campaign | **planned** | Long Blackwell-class campaign with checkpoints/evals — **not** **PX2-M00** |
...
**Roadmap disclaimer:** **PX2-M02**+ are **not** opened automatically by **PX2-M01**. **PX2-M01** was **not** opened automatically by **PX2-M00** closeout (separate governance).

### Explicit non-claims (PX2 phase)

PX2 **does not** silently authorize: ladder/public strength proof; benchmark universality; multi-race coverage; **v2** opening; automatic Blackwell execution; or “charter merged” ⇒ “strong agent exists.” **PX2-M00** does **not** implement the Terran action surface, replay training, or industrial campaigns. **PX2-M01** delivers the **Terran runtime/action substrate** — **not** replay-bootstrap training (**PX2-M02**), **not** industrial Blackwell campaigns (**PX2-M03**), **not** autonomous strength proof.

**Ledger truths (PX2 phase, `current milestone` = **`PX2-M01`**):**
...
- **`PX2-M01`** **open** on `main` — Terran core v1 runtime/action surface — **not** training; **not** Blackwell execution; **not** strength certification.
- **`PX2-M02`** **not** opened automatically by **`PX2-M01`**.
...
| PX2-M01 | Full Terran runtime & action substrate v1 — **open** on `main` (`docs/runtime/px2_full_terran_runtime_action_surface_v1.md`; **not** training / Blackwell / strength proof) |
| PX2-M02 | Create the first learned replay-bootstrapped full-game policy |
...
**Current:** **`PX2-M01`** — Full Terran Runtime & Action Surface — **open** on `main`. **Runtime/action substrate only:** public **`docs/runtime/px2_full_terran_runtime_action_surface_v1.md`** and **`starlab.sc2.px2`** (structured Terran actions, legality/masking, internal commands, optional Burny bridge hints, compile receipts). **Not** replay-bootstrap training (**PX2-M02**); **not** Blackwell industrial execution (**PX2-M03**); **not** autonomous strength proof. **`PX2-M02`** — **not** opened automatically. **PX2-M00** — Autonomous Full-Game Agent Charter & Success Criteria — **closed** on `main` — **`docs/runtime/px2_autonomous_full_game_agent_charter_v1.md`**. **PX1-M04** — **closed** ([PR #93](https://github.com/m-cahill/starlab/pull/93)) — **packaging / proof governance** only — **does not** auto-open **`PX1-M05`** or **v2**. **`PX1-M05`** **optional / not yet opened**. **v2** is **not** opened. **v1** (**M00–M61**), **PV1**, and **PX1** (**PX1-M00**–**PX1-M04**) remain **closed** / **historical** as stated.

### PX2-M01 — Full Terran Runtime & Action Surface — **open** (`main`)

**In scope:** Versioned **Terran core v1** structured action schema; placement/target vocabulary; legality/masking over a conservative **`GameStateSnapshot`**; `compile_terran_action` → **`Px2InternalCommand`**; **`burny_bridge`** semantic hints for traceability; deterministic compile receipts; fixture tests — see **`docs/runtime/px2_full_terran_runtime_action_surface_v1.md`**.
