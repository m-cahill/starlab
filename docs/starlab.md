...
| Current milestone | **`V15-M06`** — *Human Panel Benchmark Protocol* — **in progress** (protocol + contract + fixture; **not** live human panel; **not** “beats most humans” **claim**; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; **`docs/starlab-v1.5.md`**). **Last closed (v1.5):** **`V15-M05`** on `main` ([PR #125](https://github.com/m-cahill/starlab/pull/125); **not** benchmark **execution**; **not** strong-agent **claim**). M06 runtime **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; M05 (closed) **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**. M04 **`docs/runtime/v15_xai_evidence_contract_v1.md`**. M03 **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**. M02 **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**. Default **CI** remains **CPU** fixture self-play / bootstrap. **`V15-M07`** (GPU shakedown) — **not** started. **`PX2-M04`** / **`PX2-M05`** — **planned**; **v2** not opened. |
...
| Next planned follow-on | **`V15-M07`** — *Training Smoke and Short GPU Shakedown* — **not** started (see **`docs/starlab-v1.5.md`**; awaits explicit plan approval; **not** a long GPU **campaign**). **Current in-flight (v1.5):** **`V15-M06`** (human panel **protocol** only). **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only** on the **PX2** namespace. **v2** is **deferred** / **not** opened. |
...
| **v1.5 (V15)** | **`V15-M00`** through **`V15-M05`** **closed** on `main`; **`V15-M06`** — *Human Panel Benchmark Protocol* — **in progress** (protocol + `fixture_ci` + optional **operator_declared** — **not** human-panel **execution**; `starlab.v15.human_panel_benchmark.v1` + `v15_human_panel_benchmark.json` + report; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**). Checkpoint lineage + XAI + strong-agent protocol surfaces remain **governance/contract** until execution milestones. | Full GPU run + **strong-agent** eval + XAI + **human-panel** eval — **chartered in v1.5**, not satisfied by **PX2** alone | **M06** human-panel **protocol**; **M07+** (GPU shakedown, then long run, then **M11** human **execution** per roadmap) |
...
**Current (v1.5):** **`V15-M06`** — *Human Panel Benchmark Protocol* — **in progress** (protocol + contract only; `starlab.v15.human_panel_benchmark.v1`; **not** live human **matches**; **not** “beats most humans” **claim**; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**). **Closed v1.5 line on `main`:** **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M03`**, **`V15-M04`**, **`V15-M05`**. **Authority:** **`docs/starlab-v1.5.md`**. M06: **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; M05: **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**; M04: **`docs/runtime/v15_xai_evidence_contract_v1.md`**; M03: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; M02: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**.

### V15-M06 — *Human Panel Benchmark Protocol* — **in progress**

**Intent:** Deterministic **human panel benchmark protocol** JSON + report (`v15_human_panel_benchmark.json` / `v15_human_panel_benchmark_report.json`); default **`fixture_ci`**; optional **`operator_declared`** with **`--protocol-json`** and optional SHA-only bindings. **Not** human-panel **recruitment** or **execution**; **not** public human-panel result **rows**; **not** a strong-agent or human-benchmark **claim**; public authority: **`docs/starlab-v1.5.md`** and **`docs/human_benchmark_register.md`**.
