...
| Still **not** proved today (present tense) | **Benchmark integrity**, **replay↔execution equivalence** (global / gameplay-semantic), **live SC2 in CI as default merge-gate / global proof**, **ladder / public performance**, **Phase VI integrated test campaign** completion (post-M45 operator work), **statistical significance of ranking** (M42 does **not** claim this), **operating manual v1** — see §11 *explicit non-claims*. The **remaining v1 foundation-completion arc** is **M61** only — **stub/planned** — not silently deferred to **v2** — see *Remaining v1 proof-track map* below. |
...
**Status:** **Phase VII** — next **v1 foundation-completion** milestone after **M60** — **not** implemented in repo yet; see §6–§7.
