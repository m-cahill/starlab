...
| Current milestone | **`PX1-M04`** — Governed Demo Proof Pack & Winning Video — **open** on `main` (**packaging / proof governance** — **not** default gameplay remediation). **PX1-M03** — Candidate Strengthening & Demo Readiness Remediation — **closed** on `main` (closeout [PR #91](https://github.com/m-cahill/starlab/pull/91)); **`demo-ready-candidate-selected`** for **`px1_m01_weighted_refit_rl_bootstrap_v1`** (**remediation milestone complete**). **PX1-M02** — **closed** on `main` (closeout [PR #89](https://github.com/m-cahill/starlab/pull/89)); **`no-candidate-selected`**. **PX1-M01** — **closed** on `main` (closeout [PR #87](https://github.com/m-cahill/starlab/pull/87)). **`PX1-M05`** remains **optional / not yet opened**. **v2** is **not** opened. **PV1** is **closed** and **historical**. **v1** **M00–M61** remains **closed** — **no** **M62**. |
...
| PX1 demo pack status (PX1-M04) | **open** — governed **demo proof pack** + winning-video **packaging** only (**not** further remediation by default; **not** new industrial campaign); public runtime **`docs/runtime/px1_governed_demo_proof_pack_v1.md`**; canonical run/video **references** operator-local — **not** merge-gate CI proof. |
| Next planned follow-on | **`PX1-M05`** remains **optional / not yet opened** until **separately** chartered — **does not** open automatically from **PX1-M04** PR1. **`PX1-M02`** **did not** open automatically from **PX1-M01** closeout; **`PX1-M03`** opened by explicit PR (not automatic from **PX1-M02**). **`PX1-M04`** opened by **explicit PR** after **PX1-M03** successful closeout — **not** automatic remediation continuation. **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **not** opened. |
...
### PX1 roadmap (PX1-M00 **closed**; **PX1-M01** **closed**; **PX1-M02** **closed**; **PX1-M03** **closed**; **PX1-M04** **current / open**; **PX1-M05** **optional / not yet opened**)
...
| **Replay** | `px1_m03_validation.SC2Replay` adjacent to sealed run JSON (typical layout) |
...
**Ledger truths (PX1 phase, **PX1-M04** **open**):**
...
- **`current milestone`** = **`PX1-M04`** — **PX1-M03** **closed** with operator-local **`demo-ready-candidate-selected`** (**remediation** successful; **not** “superhuman agent” claim). **PX1-M04** **packages** bounded demo proof references — **not** new remediation by default. **PX1-M02** **`no-candidate-selected`** (**preserved**). **PX1-M01** **`threshold-met`** — industrial run **only**.
- **v2** is **not** opened.
- **`PX1-M05`** is **optional / not yet opened** — **does not** open automatically from **PX1-M04** PR1.
- **Governed demo proof pack** completion is **PX1-M04** closeout scope — **separate** from **PX1-M03** remediation closure.
...
**Current:** **`current milestone`** = **`PX1-M04`** — Governed Demo Proof Pack & Winning Video — **open** on `main` (**packaging / proof governance** — **not** default gameplay remediation). **PX1-M03** — Candidate Strengthening & Demo Readiness Remediation — **closed** on `main` (closeout [PR #91](https://github.com/m-cahill/starlab/pull/91)); **`demo-ready-candidate-selected`** for **`px1_m01_weighted_refit_rl_bootstrap_v1`** — **remediation milestone complete** (watchable optional media + replay-backed wins on authoritative series — operator-local). **PX1-M02** — **closed** (closeout [PR #89](https://github.com/m-cahill/starlab/pull/89)); **`no-candidate-selected`** — **preserved**. **PX1-M01** — **closed** (closeout [PR #87](https://github.com/m-cahill/starlab/pull/87)) — **`threshold-met`**. **`PX1-M05`** **optional / not yet opened**. **v2** is **not** opened. **v1** (**M00–M61**) and **PV1** remain **closed** and **historical**.
...
**Non-claims (PX1-M04 PR1):** **not** ladder strength; **not** benchmark universality; **not** replay↔execution gameplay semantics; **not** **v2** readiness.
