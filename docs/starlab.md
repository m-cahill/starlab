...
| M35 | Audit Closure IV — Structural Decoupling and Module Decomposition | V | In progress | v0.0.35-m35 | — |
| M36 | Audit Closure V — Governance Surface Rationalization and Documentation Density Control | V | Planned | v0.0.36-m36 | — |
...
| **M35** | **Audit closure IV** — structural decoupling and module decomposition (in progress). |
| **M36** | **Audit closure V** — governance surface rationalization and documentation density control (planned). |
...
Until **M35** is **merged and closed** on `main` with authoritative CI, treat the following as **not proved**:

- **M37** public flagship proof-pack **product** work (**not** M35 scope).
...
- **Operating manual** promoted to canonical **v1** (**not** claimed by M35).
