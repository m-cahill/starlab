...
| Current milestone | **`V15-M26`** — *Real Operator T1 30-Minute GPU Run Attempt After Manifest Alignment* — **open** on [PR #162](https://github.com/m-cahill/starlab/pull/162) (branch `v15-m26-real-t1-30min-gpu-run`; **not** merged to `main`). **Outcome:** **`t1_checkpoint_plumbing_completed_but_sc2_training_not_yet_meaningful`**. **Synthetic CUDA** path: **`t1_30min_checkpoint_produced_package_ready`**, **candidate** `.pt` **SHA-256** **`cb375b77a92f6f07b406d8579a60f3539568be12877808d600826c049e146e78`** (**plumbing** — **no** promotion; **not** SC2 gameplay learning). **SC2 rollout path:** bounded smoke/bootstrap — **not meaningful SC2 training**. Attempt A **`t1_30min_completed_without_candidate_checkpoint`**. **Public narrative:** M26 completed T1 checkpoint-production plumbing and produced a candidate checkpoint via synthetic CUDA, but the SC2 rollout path remained bounded smoke/bootstrap only and is not yet meaningful SC2 training. **Merge** **PR #162** when **governance** **CI** is **green** as **honest M26 closeout** — **do not** **describe** that merge as **successful SC2 T1 training**. **Last closed v1.5 on `main`:** **`V15-M25`**. **`V15-M27`** — *SC2 Rollout Duration and Training-Loop Integration Fix* — **proposed / not opened**. **PX2** **transition-complete**. |
| v1.5 ID anchors (M00–M27 proposed, quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**. **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
