...
| ----- | ------------------------ |
| Program arc | **52 milestones (M00–M51)** — see §7 (**M51** in development). |
| Last closed milestone | **M50** — Industrial-scale hidden rollout & governed campaign execution v1 (merged to `main`; see §11 / §18). |
| Current milestone | **M51** — Governed post-bootstrap phase orchestration v1 (branch `m51-governed-post-bootstrap-phase-orchestration`; see §11). |
...
Planned program arc (52 milestones, M00–M51 — **M51** in development):
...
| M51 | Governed post-bootstrap phase orchestration v1 | VI | In progress | — | `m51-governed-post-bootstrap-phase-orchestration` |
...
| M51 | Governed post-bootstrap phase orchestration v1 — optional refit + M42 skip + watchable M44 on refit (orchestration; **not** M42 semantics extension) |
