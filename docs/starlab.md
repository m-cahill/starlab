...
| ----- | ------------------------ |
| Program arc | **62 milestones (M00–M61)** — see §7 (**M52** **closed** on `main`; **M53**–**M61** **stub/planned** except as closed later). |
| Last closed milestone | **M52** — V1 endgame recharter & replay↔execution equivalence charter v1 (merged to `main`; see §11 / §18). |
| Current milestone | **M53** — Replay↔execution equivalence evidence surface v1 — **stub/planned** (Phase VII; see §11). |
...
| Phase VII pipeline (compact) | **M52**–**M61** — trust, equivalence, benchmark integrity, live SC2-in-CI posture, ladder/public evaluation protocol, audit hardening, v1 release lock — see §6; **M52** ledger + equivalence **charter** **closed** on `main`; **M53**–**M61** **stub/planned** until chartered/closed. |
...
- **M53** — Replay↔execution equivalence evidence surface v1 (**stub/planned** — next Phase VII product milestone after **M52** closeout).
...
Planned program arc (**62 milestones**, **M00**–**M61** — **M52** **closed** on `main`; **M53**–**M61** stub/planned; **M51** **closed** on `main`):
...
**Status:** current milestone pointer (**Phase VII**). **No** M53 product work is authorized until chartered on a feature branch; folder: `docs/company_secrets/milestones/M53/` (`M53_plan.md`, `M53_toolcalls.md` stub only). **Depends on:** **M52** closed — runtime `docs/runtime/replay_execution_equivalence_charter_v1.md` + `starlab.equivalence` charter emitters. **Explicit non-claims:** **M53** does **not** silently claim paired replay↔execution equivalence proof until its own scope says so; benchmark integrity, live SC2-in-CI proof, and ladder surfaces remain **not** proved by default.
...
**M51**–**M52** are **closed** on `main`; **M53**–**M61** (**Phase VII**) are **the remaining planned v1 proof track** — **not** implied solved because they appear in the milestone table. **M52** delivered **governance + charter** only; **M53** onward remain **stub/planned** until chartered/closed.
...
- **Post-closeout `main` CI:** *(recorded after closeout ledger/tag push — not PR #63 merge authority; merge-boundary remains [`24435208211`](https://github.com/m-cahill/starlab/actions/runs/24435208211) on `c80a47b…`.)*
