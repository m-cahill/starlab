...
| Current milestone | **`V15-M30`** — *SC2-Backed Candidate Checkpoint Evaluation Package* — **`starlab.v15.candidate_checkpoint_evaluation_package.v1`** + **`package_profile_id`** **`starlab.v15.m30.sc2_backed_candidate_checkpoint_evaluation_package.v1`** — **`python -m starlab.v15.emit_v15_m30_sc2_backed_candidate_checkpoint_evaluation_package`** — **`docs/runtime/v15_sc2_backed_candidate_checkpoint_evaluation_package_v1.md`** (**`docs/starlab-v1.5.md`** **§V15-M30**) — assembly/**SHA** consistency posture — **not** strength evaluation / benchmark execution |
...
| Next planned follow-on | **`V15-M31`** — *evaluation harness dry-run / checkpoint evaluation execution* (roadmap seed — **`docs/starlab-v1.5.md`** **§V15-M31** placeholder until chartered). |
