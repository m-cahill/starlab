...
**Status:** **Planned** — **current** milestone; **M21** is **closed** on `main` (see §18). **Phase IV** continues (benchmark / evaluation plane). **M22** is **stub-only** until authorized (`docs/company_secrets/milestones/M22/`).

**Goal (high level):** **M22** introduces a **heuristic baseline suite** — **not** started in M21; see `docs/company_secrets/milestones/M22/M22_plan.md` (stub).

**Primary references:** `docs/company_secrets/milestones/M22/M22_plan.md`; `docs/starlab.md` §6 / §10.

**Note:** **M21** proves **fixture-only scripted baseline suite emission** with embedded M20 scorecards (`docs/runtime/scripted_baseline_suite_v1.md`, `starlab/baselines/`) — **not** heuristic baselines (**M22**), **not** evaluation runner / tournament harness (**M23**).

#### Current milestone — explicit non-claims (standing)

Until **M22** explicitly closes a claim, treat the following as **not proved** for **M22** planning:
