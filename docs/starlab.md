...
| Current milestone | **`V15-M28`** — *SC2-Backed T1 Candidate Training Attempt* — **implementation** (**merge pending**); **`docs/starlab-v1.5.md`** **§V15-M28** — **`fixture_only`** (CI) / operator-local sample **`sc2_backed_candidate_training_completed_with_candidate_checkpoint`** (**not** strength). **Last merge:** **`V15-M27`** [PR #163](https://github.com/m-cahill/starlab/pull/163). **PX2** **transition-complete**. |
