...
**Status:** Active — M00–**M02** merged to `main` ([PR #1](https://github.com/m-cahill/starlab/pull/1), [PR #2](https://github.com/m-cahill/starlab/pull/2), [PR #3](https://github.com/m-cahill/starlab/pull/3)); **M03** — Run Identity & Lineage Seed **PR open** — [PR #4](https://github.com/m-cahill/starlab/pull/4) on branch `m03-run-identity-lineage-seed`; authoritative **PR-head CI** [`24058833260`](https://github.com/m-cahill/starlab/actions/runs/24058833260) (**success**) on PR head `8634da377fedf61c436f8b3678648b35e45067c3`. **Not** merged to `main` yet; **not** replay binding; **not** canonical run artifact v0. Merge + closeout pending.  
