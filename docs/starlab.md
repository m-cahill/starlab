...
| ----- | ------------------------ |
| Program arc | **53 milestones (M00–M52)** — see §7 (**M52** stub active). |
| Last closed milestone | **M51** — Governed post-bootstrap phase orchestration v1 (merged to `main`; see §11 / §18). |
| Current milestone | **M52** — **stub** (placeholder; see §11). |
...
In this ledger, **v1** means the **governed, replay-native, local-first SC2 research substrate release**: deterministic artifacts and evidence surfaces, bounded local validation where stated, governed bootstrap and campaign execution paths, and **truthful CI with explicit non-claims**. It is **not** an open-ended promise to later prove benchmark integrity, full replay↔execution equivalence, live SC2 in CI, or public ladder performance.

| **v1 means** | **v1 does *not* mean (post-v1 proof targets unless separately closed)** |
| ----- | ----- |
| Governed, replay-native, local-first SC2 research substrate | **Benchmark integrity** (tournament / ranking truth beyond stated harness semantics) |
| Deterministic artifacts and operator-facing evidence surfaces | **Replay↔execution equivalence** |
| Bounded local validation where a milestone explicitly says so | **Live SC2 in CI** as merge proof |
| Governed bootstrap (**M45**) and campaign execution (**M49**–**M51**) with honest receipts | **Ladder / public performance** claims |
...
Planned program arc (53 milestones, M00–M52 — **M52** stub; **M51** **closed** on `main`):
...
| M52 | **Stub** — scope TBD in `M52_plan.md` (see §11) |
...
**Status:** placeholder milestone — **`M52_plan.md`** / **`M52_toolcalls.md`** only until chartered; **no** product scope in this section yet.
...
- **Post-closeout `main` CI:** any green run on a follow-up commit that updates the public ledger after the merge boundary — **not** merge authority for PR #62 (merge-boundary remains [`24429524114`](https://github.com/m-cahill/starlab/actions/runs/24429524114) on `1e88466…`).
