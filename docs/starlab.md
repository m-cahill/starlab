...
- public flagship proof pack (**M39**)

### Phase VI — Expansion Decision and Platform Boundary Review

Focus:

- SC2 substrate review and expansion decision (**M40**)
- platform boundary review and multi-environment charter (**M41** — earned only; **OD-007** target)

---

## 7. Milestone table

Planned program arc (42 milestones, M00–M41):
...
| M37 | Audit Closure VI — Coverage Margin Recovery and CI Evidence Hardening | V | In progress | v0.0.37-m37 | — |
| M38 | Audit Closure VII — Public Face Refresh, Governance Rationalization, and Code-Health Tightening | V | Planned | v0.0.38-m38 | — |
| M39 | Public Flagship Proof Pack | V | Planned | v0.0.39-m39 | — |
| M40 | SC2 Substrate Review & Expansion Decision | VI | Planned | v0.0.40-m40 | — |
| M41 | Platform Boundary Review & Multi-Environment Charter | VI | Planned | v0.0.41-m41 | — |
...
| M40 | SC2 substrate review and expansion decision |
| M41 | Platform boundary review and multi-environment charter (**OD-007**) |
...
| **M37** | **Audit closure VI** — coverage margin recovery + CI evidence hardening (**in progress**; see §11). |
| **M38** | **Audit closure VII** — public face refresh, governance rationalization, code-health tightening (**planned**). |
| **M39** | **Public flagship proof pack** (**planned**). |

### Phase VI progression (compact)

| Milestone | What it proves (Phase VI) |
| --------- | ------------------------- |
| **M40** | **SC2 substrate review & expansion decision** (planned). |
| **M41** | **Platform boundary review & multi-environment charter** (planned; earned only; **OD-007**). |
...
**Status:** **Current** — charter `docs/company_secrets/milestones/M37/M37_plan.md`. Scope: restore **material** coverage margin (target **≥80%** total line coverage on the branch; **~85%** remains a **stretch** across the **M37**–**M39** campaign — see status line), **disciplined** `fail_under` (~measured − **~2** percentage points, **never** lowered below the prior gate as a cheat), **branch** coverage visible in CI logs + `$GITHUB_STEP_SUMMARY`, `if: always()` on diagnostic artifact uploads where appropriate, `make check`, governance tests aligned to the **42**-milestone arc, **M38**–**M41** stubs per §7. **M38** / **M39** (audit closure VII + flagship) and **M40** / **M41** (Phase VI) remain **planned** per §7 until chartered/closed.
...
**Predecessor (M32):** **Audit Closure I** — measured **`coverage.xml` / `pytest-junit.xml`** in CI, **`fail_under`** line gate, SHA-pinned actions, **`@pytest.mark.smoke`** + `make smoke`, **`Makefile`**, **`docs/audit/DeferredIssuesRegistry.md`**, **42 milestones (M00–M41)** (per §7; M32 closeout originally recorded a shorter arc — historical); **OD-007** → **M41**.
...
Until **M39** is **merged and closed** on `main` with authoritative CI (when implemented), treat the following as **not proved**:

- **M39** public flagship proof-pack **product** work (**not** claimed until M39 closes).
...
| OD-007 | Second-environment posture       | Deferred | M41              | Explicitly not a starting decision                                 |
