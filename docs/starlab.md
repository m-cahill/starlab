...
| Last closed milestone | **M37** — Audit Closure VI (merged to `main`; see §11). |
| Current milestone | **M38** — Audit Closure VII (see §11). |
| Next flagship | **M39** — public flagship proof pack (**planned**; **not** claimed until merged and closed with authoritative CI). |
...
| M38 | Audit Closure VII — Public Face Refresh, Governance Rationalization, and Code-Health Tightening | V | In progress | v0.0.38-m38 | — |
...
| **M38** | **Audit closure VII** — public face refresh, governance rationalization, code-health tightening (**current**; see §11). |
...
**Status:** **Current** — charter `docs/company_secrets/milestones/M38/M38_plan.md`. Implementation proceeds on an **M38** branch per governance; closeout updates this ledger with PR/CI evidence.

**Not** flagship proof pack (**M39**), **not** Phase VI (**M40** / **M41**) unless explicitly chartered.
