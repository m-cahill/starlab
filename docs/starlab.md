...
**v1.5 arc (V15) — authoritative public governance:** `docs/starlab-v1.5.md` (strategic anchor: `docs/starlab-v1.5moonshot.md`; M02 environment lock: `docs/runtime/v15_long_gpu_run_environment_lock_v1.md`; M03 checkpoint lineage / resume discipline: `docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`)
...
| Current milestone | **`V15-M03`** — *Checkpoint Lineage and Resume Discipline* — **in progress** (M03 **not** closed on `main` until the M03 PR merges + green merge-boundary CI). **Last closed (v1.5):** **`V15-M02`** on `main` ([PR #118](https://github.com/m-cahill/starlab/pull/118); merge `3f7e226f…`; PR-head CI [`24918006750`](https://github.com/m-cahill/starlab/actions/runs/24918006750); merge-boundary [`24918563270`](https://github.com/m-cahill/starlab/actions/runs/24918563270)). **Authority** **`docs/starlab-v1.5.md`**; M03 runtime **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; prior M02 runtime **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**; **PX2** did **not** perform a **long wall-clock GPU training session** as a program deliverable. Default **CI** remains **CPU** fixture self-play / bootstrap paths. **`PX2-M04`** / **`PX2-M05`** — **planned**; **`PX1-M05`** optional; **v2** not opened. |
...
| Next planned follow-on | After **`V15-M03`** closeout: **`V15-M04`** (XAI evidence contract) — do **not** start until **explicit** approval. **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only** on the **PX2** namespace. **`PX1-M05`** optional. **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **deferred** / **not** opened. |
...
| **v1.5 (V15)** | **`V15-M00`**, **`V15-M01`**, **`V15-M02`** **closed** on `main` (PR #116–#118); **`V15-M03`** **in progress** (checkpoint lineage **manifest** `starlab.v15.checkpoint_lineage_manifest.v1` — **not** training **execution**). Registers + M01/M02/M03 **fixture**-safe contracts; **not** long GPU **training**; **not** claim-critical asset approval. | Full GPU training session + **strong-agent** benchmark + replay-native **XAI** + checkpoint **lineage** + data/**weight** provenance + **human-panel** or bounded “beats most humans” eval — **chartered in v1.5**, not in **PX2** | **V15-M04**+ (after M03 closeout) |
...
**Ledger truths (PX2 phase, **closeout**; program **current** v1.5 = **`V15-M03`** (checkpoint lineage — **in progress**); **last closed** v1.5 = **`V15-M02`** / **`V15-M01`** / **`V15-M00`** — authority **`docs/starlab-v1.5.md`**; M03 runtime `docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`):**
...
**Current (v1.5):** **`V15-M03`** — *Checkpoint Lineage and Resume Discipline* — **in progress** (not closed on `main` until M03 PR + green CI). **Authority:** **`docs/starlab-v1.5.md`**. M03: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**. **Prior** M02: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**.
...
**Last closed (v1.5) before M03:** **`V15-M01`** — *Training-Scale Provenance and Asset Registers* — **closed** on `main` ([PR #117](https://github.com/m-cahill/starlab/pull/117); merge `f618a1f…`; **authoritative PR-head CI** [`24914804421`](https://github.com/m-cahill/starlab/actions/runs/24914804421); **merge-boundary `main` CI** [`24916076997`](https://github.com/m-cahill/starlab/actions/runs/24916076997) — **success**). **Prior:** **`V15-M00`** — **closed** ([PR #116](https://github.com/m-cahill/starlab/pull/116); merge `1391518e…`; PR-head [`24911939851`](https://github.com/m-cahill/starlab/actions/runs/24911939851); merge-boundary [`24913025515`](https://github.com/m-cahill/starlab/actions/runs/24913025515)). **Authoritative public detail:** **`docs/starlab-v1.5.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**; **PX2** did **not** run a **long wall-clock GPU** training **campaign** as a program deliverable. **PX2-M03** readiness (historical): **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`**; runtime **`docs/runtime/px2_industrial_self_play_campaign_v1.md`** (slices + §8q). **Last closed PX2 milestone:** **`PX2-M03`** — prior **`PX2-M02`** ([PR #96](https://github.com/m-cahill/starlab/pull/96)). **`PX2-M04`** / **`PX2-M05`** — **planned only**. **`PX1-M05`** **optional**; **v2** **not** opened.
