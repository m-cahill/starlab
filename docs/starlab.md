...
**PX2-M03 opening discipline:** **`PX2-M03`** opens only after a **positive** readiness/preflight decision recorded in **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`** — **not** automatically when **`PX2-M02`** closes.
...
| `PX2-M03` | Industrial Self-Play Campaign | **open** on `main` | Preflight **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`** — operator-local / Blackwell-class intent; checkpoints/evals/promotion/rollback/opponent pool — **not** **PX2-M04**; **not** demo refresh |
...
**Non-claims:** **not** self-play **evidence** in-repo; **not** Blackwell run **completed** by opening; **not** strength proof.
