...
| Current milestone | **`V15-M26`** — *Real Operator T1 30-Minute GPU Run Attempt After Manifest Alignment* — **proposed / not opened** on `main` (see **`docs/starlab-v1.5.md`**). **`V15-M25`** **closed** on `main` ([PR #160](https://github.com/m-cahill/starlab/pull/160); merge-boundary [`25039367953`](https://github.com/m-cahill/starlab/actions/runs/25039367953)) — **`m21_dry_run_preflight_passed` / `ready_for_v15_m26_t1_attempt`**; **real T1** **not** entered; **no** checkpoint. **Last closed v1.5 on `main`:** **`V15-M25`**. **Prior:** **`V15-M24`** — [PR #159](https://github.com/m-cahill/starlab/pull/159). **Prior:** **`V15-M23`** — [PR #156](https://github.com/m-cahill/starlab/pull/156) (branch `v15-m23-cuda-pytorch-operator-env-remediation`) — CUDA **`.venv`**. **Prior:** **`V15-M22`** — [PR #154](https://github.com/m-cahill/starlab/pull/154). **Prior:** **`V15-M21`** — [PR #153](https://github.com/m-cahill/starlab/pull/153). **Prior:** **`V15-M20`** — [PR #152](https://github.com/m-cahill/starlab/pull/152). **PX2** **transition-complete**. |
| v1.5 ID anchors (M00–M26 proposed, quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**. **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
