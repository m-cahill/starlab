...
- **Merge / CI:** pending PR to `main`; authoritative PR-head + merge-boundary CI — **TBD** at merge time (this entry updated when available). **Out of scope:** **M42** `--contract` path mismatch — separate follow-on.
