...
**Status:** Active — M00–**M02** merged to `main` ([PR #1](https://github.com/m-cahill/starlab/pull/1), [PR #2](https://github.com/m-cahill/starlab/pull/2), [PR #3](https://github.com/m-cahill/starlab/pull/3)); **M03** — Run Identity & Lineage Seed **PR open** — [PR #4](https://github.com/m-cahill/starlab/pull/4) on branch `m03-run-identity-lineage-seed`; authoritative **PR-head CI** [`24058879334`](https://github.com/m-cahill/starlab/actions/runs/24058879334) (**success**) on PR head `8e751429c315601a5c85b8b349c6cb1f4b06796d`. **Not** merged to `main` yet; **not** replay binding; **not** canonical run artifact v0. Merge + closeout pending.  
