...
| PX1 play-quality status (PX1-M02) | **in progress** — public runtime **`docs/runtime/px1_play_quality_demo_candidate_selection_v1.md`**; frozen protocol/evidence artifact families — **not** authoritative play-quality proof until milestone closeout; **not** ladder proof; **not** **PX1-M03**. |
...
| Next planned follow-on | **`PX1-M03`–`PX1-M04`** remain **planned / not yet opened** until **separately** chartered. **`PX1-M02`** **does not** open automatically from **PX1-M01** closeout — it is opened by **explicit** governance (PR). **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **not** opened. |
...
| Still **not** proved today (present tense) | **Benchmark integrity** (global / beyond bounded milestone scope), **replay↔execution equivalence** (global / gameplay-semantic), **live SC2 in CI as default merge-gate / global proof**, **ladder / public performance**, **statistical significance of ranking** (M42 does **not** claim this), **operating manual v1** — see §11 *explicit non-claims*. **M61** **closed** with operator-local evidence + **`ready_within_scope`** **does not** change these boundaries — **not** global benchmark integrity; **not** universal replay↔execution equivalence; **not** merge-gate live SC2; **not** ladder/public performance. The *Remaining v1 proof-track map* below is **historical** — all Phase VII rows are **complete** on `main`. **PX1-class gaps (present tense):** **PX1-M02** is **open** — bounded play-quality evaluation is **in progress**; **demo-worthy candidate** selection and **governed winning demo / video proof pack** are **not** closed claims until **PX1-M02**/**PX1-M03** closeouts respectively. **PX1-M01** is **closed** with **authoritative** operator-local **`threshold-met`** under the **frozen PX1** threshold package — **not** play-quality proof; **not** demo/video proof; **not** ladder strength. **PX1-M00** is **closed** as a **governance charter** milestone — **does not** claim play-quality or demo proof are satisfied. |
...
### PX1 roadmap (PX1-M00 **closed**; **PX1-M01** **closed**; **PX1-M02** **open**; **PX1-M03**+ **not** opened)
...
**Roadmap disclaimer:** **PX1-M03**–**PX1-M04** are **not** opened by **PX1-M00**/**PX1-M01** (closed) or by **PX1-M02** PR1 (protocol freeze) alone. **PX1** is **not** implied by closed **PV1** merges.

**Ledger truths (PX1 phase, **PX1-M02** **open**):**
...
- **`current milestone`** = **`PX1-M02`** — **open** — play-quality evaluation + demo-candidate selection (**PR1** freezes protocol; **not** authoritative candidate selection until closeout). **PX1-M01** **closed** on `main` with **authoritative** operator-local **`threshold-met`** — **not** play-quality or demo proof.
- **v2** is **not** opened.
- **`PX1-M03`–`PX1-M04`** are **planned / not yet opened** — **PX1-M03** **does not** open automatically from **PX1-M02** protocol freeze or merge alone.
- The program has **not** yet **closed** **PX1-M02** with a **demo-worthy** candidate selection outcome; **governed winning demo proof** (**PX1-M03**+) is **not** earned until a separate milestone closeout.
