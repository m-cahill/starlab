...
| M36 | Audit Closure V — Governance Surface Rationalization and Documentation Density Control | V | In progress | v0.0.36-m36 | — |
| M37 | Public Flagship Proof Pack | V | Planned | v0.0.37-m37 | — |
...
| **M36** | **Audit closure V** — governance surface rationalization and documentation density control (**in progress**; ledger archive + doc/test surface rationalization; **not** M37 flagship product). |
| **M37** | **Public flagship proof pack** (planned). |
...
**Status:** **Current milestone** — **M36** is **governance / documentation-density** work (see `docs/company_secrets/milestones/M36/M36_plan.md`): ledger readability (`docs/starlab_archive.md` for verbatim **M01–M27** §7 notes), governance-test clarity — **not** M37 flagship proof-pack **product** code. **M37** — **Public Flagship Proof Pack** — remains **planned** after **M36**. The **M35 full audit** artifacts (`M35_fullaudit.md`, `M35_fullaudit.json`) record a **“proceed directly to flagship”** recommendation; the program **later chose** to insert **M35–M36** corrective milestones first for a **stricter audit-maximizing path** — the audit files are **historical**; this ledger records the **governance decision** without rewriting that audit.

**Not** benchmark-integrity proof, **not** live SC2 in CI, **not** operating manual v1, **not** M37 flagship proof-pack product work in M36.
...
Until **M36** is **merged and closed** on `main` with authoritative CI, treat the following as **not proved**:

- **M37** public flagship proof-pack **product** work (**not** M36 scope).
...
- **Operating manual** promoted to canonical **v1** (**not** claimed by M36).
...
### 2026-04-10 — M36 implementation (branch): ledger archive + governance test rationalization

- **Governance / docs:** add `docs/starlab_archive.md` (verbatim **§7** milestone table notes **M01–M27** moved from `docs/starlab.md` for readability); **§7** retains the milestone table, archival policy line, pointer to the archive, and full inline notes for **M28–M35**; `tests/test_governance_milestones.py` / `tests/test_governance_runtime.py` deduplicated where obvious; `docs/starlab_archive.md` added to governance doc existence list.
- **Not** M37 flagship proof-pack product work; **not** benchmark-integrity upgrades; **not** CI topology change; coverage floor **75.4** remains the governed gate (do not lower).
