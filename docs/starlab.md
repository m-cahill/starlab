...
**v1.5 pointer:** Last closed **`V15-M50`** on `main` ([PR #187](https://github.com/m-cahill/starlab/pull/187); merge **`3c9a11dd68981587f12e2ee598b6fbad759e36e7`** merged **2026-05-01T05:28:23Z** UTC; **final PR-head SHA** **`304cd4f31c4e88c1554af14203298ec87c5e5a71`**; **authoritative PR-head CI** [`25203480523`](https://github.com/m-cahill/starlab/actions/runs/25203480523) — **success**; **superseded PR-head CI:** **none**; **merge-boundary `main` CI** [`25203653963`](https://github.com/m-cahill/starlab/actions/runs/25203653963) — **success**); prior **`V15-M49`** closed ([PR #186](https://github.com/m-cahill/starlab/pull/186); merge **`8db3341d2bc0c724c63dba4b8687be43585bca8b`**). Current / next **`V15-M51`** (**provisional**; **`docs/runtime/v15_live_candidate_watchability_harness_v1.md`**; **`emit_v15_m51_live_candidate_watchability_harness`** / **`run_v15_m51_live_candidate_watchability_harness`**); **`V15-M52`** / **`V15-M53`** — 12-hour path (**provisional**). Authoritative **`docs/starlab-v1.5.md`**. **V15-M50** (**v1.5**) is **not** Phase VI **M50** (industrial rollout). **ensure all documentation is updated as necessary**.
...
| Last closed milestone (v1.5) | **`V15-M50`** — scorecard result readout / benchmark pass-fail refusal decision — **closed** on `main` ([PR #187](https://github.com/m-cahill/starlab/pull/187); merge **`3c9a11dd68981587f12e2ee598b6fbad759e36e7`** merged **2026-05-01T05:28:23Z** UTC; **final PR-head** **`304cd4f31c4e88c1554af14203298ec87c5e5a71`**; **authoritative PR-head CI** [`25203480523`](https://github.com/m-cahill/starlab/actions/runs/25203480523); **superseded PR-head CI:** **none**; **merge-boundary `main` CI** [`25203653963`](https://github.com/m-cahill/starlab/actions/runs/25203653963) — **success**); **`starlab.v15.scorecard_result_readout_decision.v1`** / **`python -m starlab.v15.emit_v15_m50_scorecard_result_readout_decision`**; **`docs/runtime/v15_scorecard_result_readout_decision_v1.md`**. **Prior:** **`V15-M49`** — bounded scorecard result execution surface — **closed** on `main` ([PR #186](https://github.com/m-cahill/starlab/pull/186); merge **`8db3341d2bc0c724c63dba4b8687be43585bca8b`** merged **2026-05-01T03:59:58Z** UTC; **final PR-head** **`2e6b426cad0185c21afd61d30cc9489878f3d0e0`**; **authoritative PR-head CI** [`25201470203`](https://github.com/m-cahill/starlab/actions/runs/25201470203); **superseded PR-head CI:** [`25201297251`](https://github.com/m-cahill/starlab/actions/runs/25201297251) — **failure** (coverage gate); **merge-boundary `main` CI** [`25201572889`](https://github.com/m-cahill/starlab/actions/runs/25201572889) — **success**); **`starlab.v15.bounded_scorecard_result_execution.v1`** / **`python -m starlab.v15.emit_v15_m49_bounded_scorecard_result_execution`**; **`docs/runtime/v15_bounded_scorecard_result_execution_surface_v1.md`**. **Prior:** **`V15-M48`** — bounded scorecard execution preflight / evidence requirements gate — **closed** on `main` ([PR #185](https://github.com/m-cahill/starlab/pull/185); merge **`71a0fcc466b7f0f757de0138088f6ca13e7ee7fd`** merged **2026-05-01T03:00:39Z** UTC; **final PR-head** **`d7ff11b914c0090395143986e1b7229f5279af49`**; **authoritative PR-head CI** [`25199986904`](https://github.com/m-cahill/starlab/actions/runs/25199986904); **superseded PR-head CI:** **none**; **merge-boundary `main` CI** [`25200180386`](https://github.com/m-cahill/starlab/actions/runs/25200180386) — **success**); **`starlab.v15.bounded_scorecard_execution_preflight.v1`** / **`python -m starlab.v15.emit_v15_m48_bounded_scorecard_execution_preflight`**; **`docs/runtime/v15_bounded_scorecard_execution_preflight_v1.md`**. **Prior:** **`V15-M47`** — bounded scorecard result surface design / refusal gate — **closed** on `main` ([PR #183](https://github.com/m-cahill/starlab/pull/183); merge **`168c5b9ac30e0c9256d638c3b0563a5682547528`** merged **2026-04-30T23:54:32Z** UTC; **final PR-head** **`ee28b51fbce4b025607a6df01acb50a1be0ce616`**; **authoritative PR-head CI** [`25195093742`](https://github.com/m-cahill/starlab/actions/runs/25195093742); **superseded PR-head CI:** **none**; **merge-boundary `main` CI** [`25195228064`](https://github.com/m-cahill/starlab/actions/runs/25195228064) — **success**); **`starlab.v15.bounded_scorecard_result_surface_design.v1`** / **`python -m starlab.v15.emit_v15_m47_bounded_scorecard_result_surface_design`**; **`docs/runtime/v15_bounded_scorecard_result_surface_design_v1.md`**. **Prior:** **`V15-M46`** — bounded evaluation readout / promotion refusal decision — **closed** on `main` ([PR #182](https://github.com/m-cahill/starlab/pull/182); merge **`f5472c91f7a10db23938e06ffefb7726fb69968b`** merged **2026-04-30T23:08:28Z** UTC; **final PR-head** **`ea77cdc4e27eda5f9398e4826eabe19b9873ebe8`**; **authoritative PR-head CI** [`25193641388`](https://github.com/m-cahill/starlab/actions/runs/25193641388); **merge-boundary `main` CI** [`25193802506`](https://github.com/m-cahill/starlab/actions/runs/25193802506) — **success**); **`starlab.v15.bounded_evaluation_readout_decision.v1`** / **`python -m starlab.v15.emit_v15_m46_bounded_evaluation_readout_decision`**; **`docs/runtime/v15_bounded_evaluation_readout_decision_v1.md`**. **Prior:** **`V15-M45`** — bounded candidate evaluation execution surface — **closed** on `main` ([PR #181](https://github.com/m-cahill/starlab/pull/181); merge **`c5c5abdc094431e9a218e4aa9575cc4167ebb76c`** merged **2026-04-30T21:56:22Z** UTC; **final PR-head** **`7c6900557cb34196aab91eec04afcbb0af3ea5fc`**; **authoritative PR-head CI** [`25190918123`](https://github.com/m-cahill/starlab/actions/runs/25190918123); **merge-boundary `main` CI** [`25191304029`](https://github.com/m-cahill/starlab/actions/runs/25191304029) — **success**); **`starlab.v15.bounded_candidate_evaluation_execution.v1`** / **`python -m starlab.v15.emit_v15_m45_bounded_candidate_evaluation_execution`**; **`docs/runtime/v15_bounded_candidate_evaluation_execution_surface_v1.md`** (**bounded execution/refusal bookkeeping only** — **not** benchmark pass/fail). **Prior:** **`V15-M44`** — bounded evaluation execution preflight — **closed** on `main` ([PR #180](https://github.com/m-cahill/starlab/pull/180); merge **`735b2b6b8c35970b0e4bdbd376bb41365350874b`**; dry-run only — **bounded_evaluation_execution_preflight_ready** is **future preflight bookkeeping only**, **not** benchmark success). **`V15-M43`** — bounded evaluation gate — **closed** on `main` ([PR #179](https://github.com/m-cahill/starlab/pull/179); merge **`47317ae6db017d89dfc208d34678a53c47c7ed7d`**; **final PR-head** **`9c8604e5a04b36a31c42ac223f79b5bf7a1c5e7d`**; **authoritative PR-head CI** [`25156023350`](https://github.com/m-cahill/starlab/actions/runs/25156023350); **superseded PR-head CI** [`25155755421`](https://github.com/m-cahill/starlab/actions/runs/25155755421) — coverage gate **failure** (**not** merge authority); **merge-boundary `main` CI** [`25156226743`](https://github.com/m-cahill/starlab/actions/runs/25156226743) — **success**); **`starlab.v15.bounded_evaluation_gate.v1`** / **`emit_v15_m43_bounded_evaluation_gate`**; **`docs/runtime/v15_bounded_evaluation_gate_v1.md`** (**not** benchmark execution). **Prior:** **`V15-M42`** — *Candidate Checkpoint Evaluation Package from 2-Hour Run* — **closed** on `main` ([PR #178](https://github.com/m-cahill/starlab/pull/178); merge **`8c9039a1d535135f6c1e2e910b71db8df903bdd9`** merged **2026-04-30T07:43:35Z** UTC; **authoritative PR-head CI** [`25153445769`](https://github.com/m-cahill/starlab/actions/runs/25153445769) on head **`a7ad4c5551d1ada195fecbc572f759e529b380d2`**; **superseded PR-head CI** [`25152833597`](https://github.com/m-cahill/starlab/actions/runs/25152833597), [`25153128543`](https://github.com/m-cahill/starlab/actions/runs/25153128543) — **failure** (coverage `fail_under` gate — **not** merge authority); **merge-boundary `main` CI** [`25153637517`](https://github.com/m-cahill/starlab/actions/runs/25153637517) — **success**); **`starlab.v15.candidate_checkpoint_evaluation_package.v1`** / **`emit_v15_m42_two_hour_candidate_checkpoint_evaluation_package`**; **`package_ready_for_future_candidate_evaluation`**; **`ub_m39_expected`** tuple correction = sealed **M41→M42** binding alignment (**not** evaluation-semantics change). **`V15-M41`** — *2-Hour Run Package & Evaluation Readiness* — **closed** on `main` ([PR #177](https://github.com/m-cahill/starlab/pull/177); merge **`71973d7afb8a1dff46f659da60591de41aec01d4`** merged **2026-04-30T05:08:24Z** UTC; **authoritative PR-head CI** [`25148366193`](https://github.com/m-cahill/starlab/actions/runs/25148366193) on head **`f7318bae9a3bcdacfe0a8241cb4a2951aa8306ad`**; **merge-boundary `main` CI** [`25148496084`](https://github.com/m-cahill/starlab/actions/runs/25148496084) — **success**); merge method GitHub **merge commit**; **operator success posture** **`package_ready_for_future_evaluation`** (merge CI **`fixture_schema_only_no_operator_package`**); **M39** receipt **SHA-256** **`675ae631ff2fa8a9f71f2c03a93f3abbffbfe0c45fcb49a59c933920330b010c`**; **source lineage** **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**; **final candidate** **`51cea94ed5324087863b246b7b31a21021eba286924aea4609aa09466430a943`** (**candidate-only**); **`starlab.v15.two_hour_run_package_evaluation_readiness.v1`** / **`emit_v15_m41_two_hour_run_package_evaluation_readiness`**. **Strongest allowed claim:** **V15-M41** packages the completed **V15-M39** **7200-second** operator-local SC2-backed T1 continuation / candidate-training run into a governed evaluation-readiness bundle, binding the sealed **M39** receipt, source/final candidate SHA roles, telemetry summary, checkpoint inventory, transcript metadata, retention counters, and non-claims — **not** benchmark execution, strength evaluation, checkpoint promotion, scorecard results, **`torch.load`**, checkpoint blob loading, live SC2 merge-gate proof, XAI, human-panel, showcase, **v2**, or **T2**/**T3**. **`V15-M39` Phase A** (implementation / receipt surface / fixture CI) — **closed** on `main` ([PR #175](https://github.com/m-cahill/starlab/pull/175); merge `ada97dda5d32bc97541fa4a5386add8b4c241693`; **authoritative PR-head CI** [`25140098888`](https://github.com/m-cahill/starlab/actions/runs/25140098888) on head `e7ef910a9c13ad989e84978a1392073f60dd4e82`; **superseded PR-head CI** [`25139836736`](https://github.com/m-cahill/starlab/actions/runs/25139836736) — **failure**, **not** merge authority; **merge-boundary `main` CI** [`25140243730`](https://github.com/m-cahill/starlab/actions/runs/25140243730) — **success**); **`starlab.v15.two_hour_operator_run_attempt.v1`** / **`emit_v15_m39_two_hour_operator_run_attempt`** / **`run_v15_m39_two_hour_operator_run_attempt`**; **`docs/runtime/v15_two_hour_operator_run_attempt_v1.md`** — **Phase A does not** execute the **7200s** run in merge CI; **Phase B** — historical first attempt **`operator_preflight_blocked_missing_m38_rehearsal`**; **`V15-M40`** operator remediation restored sealed **M37→M38→M39 preflight**; **authorized operator Phase B** then completed — **`two_hour_operator_run_completed_with_candidate_checkpoint`**; sealed attempt receipt **SHA-256** **`675ae631ff2fa8a9f71f2c03a93f3abbffbfe0c45fcb49a59c933920330b010c`** (**`full_wall_clock_satisfied`** **true**); **execution evidence only** (**not** promoted; **not** benchmark pass, strength, **T2**/**T3**, XAI, human-panel, showcase, or **v2**). **`V15-M40`** — *2-Hour Run Remediation / Retry Gate* — **closed** on `main` ([PR #176](https://github.com/m-cahill/starlab/pull/176); merge `7f16a9a9e996716babc6a7f579e11ecb096a9a72`; **authoritative PR-head CI** [`25142710989`](https://github.com/m-cahill/starlab/actions/runs/25142710989) on head `c878fa3cbeb542f4202e85aa98cadf7a291d141c`; **superseded PR-head CI** [`25142675947`](https://github.com/m-cahill/starlab/actions/runs/25142675947) — **cancelled** — **not** merge authority; **merge-boundary `main` CI** [`25142983709`](https://github.com/m-cahill/starlab/actions/runs/25142983709) — **success**); **7200s** subprocess **not** run in **V15-M40**; public posture after **M40** operator work remained **`m39_operator_preflight_ready_awaiting_7200s_launch_authorization`** until explicit Phase B launch (see **`docs/starlab-v1.5.md`** **§V15-M40**). **Prior:** **`V15-M38`** — *2-Hour Run Remediation & Launch Rehearsal* — **closed** on `main` ([PR #174](https://github.com/m-cahill/starlab/pull/174); merge `9cf2944d8ff1f9ca2ad1a9c9bce3a4b3641296fd`; **authoritative PR-head CI** [`25138210391`](https://github.com/m-cahill/starlab/actions/runs/25138210391) on head `5843bbdf58f5ffc666e6109d9edd7261d8e1bcf4`; **merge-boundary `main` CI** [`25138442045`](https://github.com/m-cahill/starlab/actions/runs/25138442045) — **success**); **`starlab.v15.two_hour_run_remediation_launch_rehearsal.v1`** / **`emit_v15_m38_two_hour_run_remediation_launch_rehearsal`**; **`docs/runtime/v15_two_hour_run_remediation_launch_rehearsal_v1.md`** — remediation + **M28/M29** checkpoint retention + frozen **M39** launch command; **does not** execute the **7200s** run. **Prior:** **`V15-M37`** — *2-Hour Run Blocker Discovery* — **closed** ([PR #173](https://github.com/m-cahill/starlab/pull/173); PR-head [`25136254104`](https://github.com/m-cahill/starlab/actions/runs/25136254104); merge-boundary [`25136423879`](https://github.com/m-cahill/starlab/actions/runs/25136423879)). |
...
| Current milestone | **Last closed:** **`V15-M50`** — scorecard readout / benchmark pass-fail refusal ([PR #187](https://github.com/m-cahill/starlab/pull/187); merge **`3c9a11dd68981587f12e2ee598b6fbad759e36e7`**; **final PR-head** **`304cd4f31c4e88c1554af14203298ec87c5e5a71`**; **authoritative PR-head CI** [`25203480523`](https://github.com/m-cahill/starlab/actions/runs/25203480523); **merge-boundary `main` CI** [`25203653963`](https://github.com/m-cahill/starlab/actions/runs/25203653963) — **success**; **`emit_v15_m50_scorecard_result_readout_decision`**; **`docs/runtime/v15_scorecard_result_readout_decision_v1.md`**). **Prior closed:** **`V15-M49`** — bounded scorecard result execution surface — **closed** on `main` ([PR #186](https://github.com/m-cahill/starlab/pull/186); **`emit_v15_m49_bounded_scorecard_result_execution`**; **`docs/runtime/v15_bounded_scorecard_result_execution_surface_v1.md`**; merge **`8db3341d2bc0c724c63dba4b8687be43585bca8b`**; **final PR-head** **`2e6b426cad0185c21afd61d30cc9489878f3d0e0`**; **authoritative PR-head CI** [`25201470203`](https://github.com/m-cahill/starlab/actions/runs/25201470203); **superseded PR-head CI:** [`25201297251`](https://github.com/m-cahill/starlab/actions/runs/25201297251) — **failure** (coverage gate); **merge-boundary `main` CI** [`25201572889`](https://github.com/m-cahill/starlab/actions/runs/25201572889) — **success**). **Current / next:** **`V15-M51`** — live candidate watchability harness (**provisional**); **`V15-M52`** / **`V15-M53`** — 12-hour path (**provisional**). **Prior closed:** **`V15-M48`** on `main` ([PR #185](https://github.com/m-cahill/starlab/pull/185); **`emit_v15_m48_bounded_scorecard_execution_preflight`**; **`docs/runtime/v15_bounded_scorecard_execution_preflight_v1.md`**; merge **`71a0fcc466b7f0f757de0138088f6ca13e7ee7fd`**; **final PR-head** **`d7ff11b914c0090395143986e1b7229f5279af49`**; **authoritative PR-head CI** [`25199986904`](https://github.com/m-cahill/starlab/actions/runs/25199986904); **merge-boundary `main` CI** [`25200180386`](https://github.com/m-cahill/starlab/actions/runs/25200180386) — **success**). **Prior closed:** **`V15-M47`** on `main` ([PR #183](https://github.com/m-cahill/starlab/pull/183); **`emit_v15_m47_bounded_scorecard_result_surface_design`**; **`docs/runtime/v15_bounded_scorecard_result_surface_design_v1.md`**; merge **`168c5b9ac30e0c9256d638c3b0563a5682547528`**; **final PR-head** **`ee28b51fbce4b025607a6df01acb50a1be0ce616`**; **authoritative PR-head CI** [`25195093742`](https://github.com/m-cahill/starlab/actions/runs/25195093742); **merge-boundary `main` CI** [`25195228064`](https://github.com/m-cahill/starlab/actions/runs/25195228064) — **success**). **Prior closed:** **`V15-M46`** on `main` ([PR #182](https://github.com/m-cahill/starlab/pull/182); **`emit_v15_m46_bounded_evaluation_readout_decision`**; **`docs/runtime/v15_bounded_evaluation_readout_decision_v1.md`**). **ensure all documentation is updated as necessary**. **`V15-M45`** — bounded candidate evaluation execution surface — **closed** on `main` ([PR #181](https://github.com/m-cahill/starlab/pull/181)). Authoritative V15 narrative: **`docs/starlab-v1.5.md`**. **`V15-M44`** — bounded evaluation execution preflight — **closed** on `main` ([PR #180](https://github.com/m-cahill/starlab/pull/180); merge **`735b2b6b8c35970b0e4bdbd376bb41365350874b`**). **`V15-M43`** — bounded evaluation gate — **closed** on `main` ([PR #179](https://github.com/m-cahill/starlab/pull/179)). **`V15-M42`** — *Candidate Checkpoint Evaluation Package from 2-Hour Run* — **closed** on `main` ([PR #178](https://github.com/m-cahill/starlab/pull/178); **authoritative PR-head CI** [`25153445769`](https://github.com/m-cahill/starlab/actions/runs/25153445769); **merge-boundary `main` CI** [`25153637517`](https://github.com/m-cahill/starlab/actions/runs/25153637517) — **success**); **`emit_v15_m42_two_hour_candidate_checkpoint_evaluation_package`**; **`docs/runtime/v15_two_hour_candidate_checkpoint_evaluation_package_v1.md`** — **assembly/routing only** (**no** benchmark execution here). **`V15-M41`** — **closed** [PR #177](https://github.com/m-cahill/starlab/pull/177); **§V15-M39** Phase B **`two_hour_operator_run_completed_with_candidate_checkpoint`**. Re-attempt **M39**: **`run_v15_m39_two_hour_operator_run_attempt`** (**7200s**, dual guards) only when sealed **M38** + **`operator_preflight_ready_for_2hour_attempt`** and operator authorization apply. |
| v1.5 ID anchors (M00–M47 quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`**, **`V15-M36`**, **`V15-M37`** **closed** [PR #173](https://github.com/m-cahill/starlab/pull/173), **`V15-M38`** **closed** [PR #174](https://github.com/m-cahill/starlab/pull/174), **`V15-M39`** **Phase A closed** [PR #175](https://github.com/m-cahill/starlab/pull/175), **`V15-M40`** **closed** on `main` [PR #176](https://github.com/m-cahill/starlab/pull/176) (merge `7f16a9a9e996716babc6a7f579e11ecb096a9a72`; PR-head [`25142710989`](https://github.com/m-cahill/starlab/actions/runs/25142710989); merge-boundary [`25142983709`](https://github.com/m-cahill/starlab/actions/runs/25142983709) — **success**), **`V15-M41`** **closed** on `main` [PR #177](https://github.com/m-cahill/starlab/pull/177) (merge `71973d7a…`; PR-head [`25148366193`](https://github.com/m-cahill/starlab/actions/runs/25148366193); merge-boundary [`25148496084`](https://github.com/m-cahill/starlab/actions/runs/25148496084) — **success**), **`V15-M42`** **closed** on `main` [PR #178](https://github.com/m-cahill/starlab/pull/178) (*Candidate Checkpoint Evaluation Package from 2-Hour Run* — **§V15-M42**), **`V15-M43`** **closed** on `main` [PR #179](https://github.com/m-cahill/starlab/pull/179) (*Bounded Evaluation Gate for 2-Hour Candidate*), **`V15-M44`** **closed** on `main` ([PR #180](https://github.com/m-cahill/starlab/pull/180)), **`V15-M45`** **closed** on `main` ([PR #181](https://github.com/m-cahill/starlab/pull/181); merge **`c5c5abdc094431e9a218e4aa9575cc4167ebb76c`**; authoritative PR-head CI [`25190918123`](https://github.com/m-cahill/starlab/actions/runs/25190918123); merge-boundary `main` CI [`25191304029`](https://github.com/m-cahill/starlab/actions/runs/25191304029) — **success**), **`V15-M46`** **closed** on `main` ([PR #182](https://github.com/m-cahill/starlab/pull/182); merge **`f5472c91…`**; authoritative PR-head CI [`25193641388`](https://github.com/m-cahill/starlab/actions/runs/25193641388); merge-boundary `main` CI [`25193802506`](https://github.com/m-cahill/starlab/actions/runs/25193802506) — **success**), **`V15-M47`** **closed** on `main` ([PR #183](https://github.com/m-cahill/starlab/pull/183); merge **`168c5b9ac30e0c9256d638c3b0563a5682547528`**; authoritative PR-head CI [`25195093742`](https://github.com/m-cahill/starlab/actions/runs/25195093742); merge-boundary `main` CI [`25195228064`](https://github.com/m-cahill/starlab/actions/runs/25195228064) — **success**), **`V15-M48`** **closed** on `main` ([PR #185](https://github.com/m-cahill/starlab/pull/185)), **`V15-M49`** **closed** on `main` ([PR #186](https://github.com/m-cahill/starlab/pull/186)), **`V15-M50`** **closed** on `main` ([PR #187](https://github.com/m-cahill/starlab/pull/187)), **`V15-M51`** **current / next** (**provisional**), **`V15-M52`** / **`V15-M53`** — 12-hour path (**provisional**). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M51`** — live candidate watchability harness (**provisional**; **`docs/runtime/v15_live_candidate_watchability_harness_v1.md`**); **`V15-M52`** / **`V15-M53`** — 12-hour path (**provisional**). **`V15-M50`** scorecard readout / benchmark pass-fail refusal — **closed** on `main` ([PR #187](https://github.com/m-cahill/starlab/pull/187)). **`V15-M49`** **closed** on `main` [PR #186](https://github.com/m-cahill/starlab/pull/186). **`V15-M48`** **closed** on `main` [PR #185](https://github.com/m-cahill/starlab/pull/185). **`V15-M47`** **closed** on `main` [PR #183](https://github.com/m-cahill/starlab/pull/183). **`V15-M46`** **closed** [PR #182](https://github.com/m-cahill/starlab/pull/182). **`V15-M45`** **closed** [PR #181](https://github.com/m-cahill/starlab/pull/181). **`V15-M44`** **closed** [PR #180](https://github.com/m-cahill/starlab/pull/180). **`V15-M42`** **`emit_v15_m42_two_hour_candidate_checkpoint_evaluation_package`**. **Final candidate** **`51cea94ed5324087863b246b7b31a21021eba286924aea4609aa09466430a943`** (**candidate-only**). **ensure all documentation is updated as necessary** — see **`docs/starlab-v1.5.md`** for V15 authority. |
...
**Current v1.5 focus:** **`V15-M51`** — live candidate watchability harness — **provisional** (**`docs/runtime/v15_live_candidate_watchability_harness_v1.md`**; **`starlab.v15.live_candidate_watchability_harness.v1`**). **`V15-M52`** / **`V15-M53`** — 12-hour path (**provisional**). **`V15-M50`** — scorecard result readout / benchmark pass-fail refusal decision — **closed** on `main` ([PR #187](https://github.com/m-cahill/starlab/pull/187); merge **`3c9a11dd68981587f12e2ee598b6fbad759e36e7`**; **authoritative PR-head CI** [`25203480523`](https://github.com/m-cahill/starlab/actions/runs/25203480523); **merge-boundary `main` CI** [`25203653963`](https://github.com/m-cahill/starlab/actions/runs/25203653963) — **success**). **`V15-M49`** — bounded scorecard result execution surface — **closed** on `main` ([PR #186](https://github.com/m-cahill/starlab/pull/186); merge **`8db3341d2bc0c724c63dba4b8687be43585bca8b`**; **authoritative PR-head CI** [`25201470203`](https://github.com/m-cahill/starlab/actions/runs/25201470203); **merge-boundary `main` CI** [`25201572889`](https://github.com/m-cahill/starlab/actions/runs/25201572889) — **success**). **`V15-M48`** — bounded scorecard execution preflight / evidence requirements gate — **closed** on `main` ([PR #185](https://github.com/m-cahill/starlab/pull/185); merge **`71a0fcc466b7f0f757de0138088f6ca13e7ee7fd`**; **authoritative PR-head CI** [`25199986904`](https://github.com/m-cahill/starlab/actions/runs/25199986904); **merge-boundary `main` CI** [`25200180386`](https://github.com/m-cahill/starlab/actions/runs/25200180386) — **success**). **`V15-M47`** — bounded scorecard result surface design / refusal gate — **closed** on `main` ([PR #183](https://github.com/m-cahill/starlab/pull/183); merge **`168c5b9ac30e0c9256d638c3b0563a5682547528`** merged **2026-04-30T23:54:32Z** UTC; **final PR-head** **`ee28b51fbce4b025607a6df01acb50a1be0ce616`**; **authoritative PR-head CI** [`25195093742`](https://github.com/m-cahill/starlab/actions/runs/25195093742); **merge-boundary `main` CI** [`25195228064`](https://github.com/m-cahill/starlab/actions/runs/25195228064) — **success**); **`starlab.v15.bounded_scorecard_result_surface_design.v1`** / **`python -m starlab.v15.emit_v15_m47_bounded_scorecard_result_surface_design`** / **`docs/runtime/v15_bounded_scorecard_result_surface_design_v1.md`**. **No M47 scorecard results, benchmark pass/fail, scorecard total, strength evaluation, checkpoint promotion, torch.load, checkpoint blob loading, live SC2, XAI, human-panel, showcase, v2, or T2–T5 execution is claimed.** **`V15-M46`** — bounded evaluation readout / promotion refusal decision — **closed** on `main` ([PR #182](https://github.com/m-cahill/starlab/pull/182); merge **`f5472c91f7a10db23938e06ffefb7726fb69968b`** merged **2026-04-30T23:08:28Z** UTC; **final PR-head** **`ea77cdc4e27eda5f9398e4826eabe19b9873ebe8`**; **authoritative PR-head CI** [`25193641388`](https://github.com/m-cahill/starlab/actions/runs/25193641388); **merge-boundary `main` CI** [`25193802506`](https://github.com/m-cahill/starlab/actions/runs/25193802506) — **success**); **`starlab.v15.bounded_evaluation_readout_decision.v1`** / **`python -m starlab.v15.emit_v15_m46_bounded_evaluation_readout_decision`** / **`docs/runtime/v15_bounded_evaluation_readout_decision_v1.md`**. **`V15-M45`** — bounded candidate evaluation execution surface — **closed** on `main` ([PR #181](https://github.com/m-cahill/starlab/pull/181); merge **`c5c5abdc094431e9a218e4aa9575cc4167ebb76c`** merged **2026-04-30T21:56:22Z** UTC; **final PR-head** **`7c6900557cb34196aab91eec04afcbb0af3ea5fc`**; **authoritative PR-head CI** [`25190918123`](https://github.com/m-cahill/starlab/actions/runs/25190918123); **merge-boundary `main` CI** [`25191304029`](https://github.com/m-cahill/starlab/actions/runs/25191304029)); **`starlab.v15.bounded_candidate_evaluation_execution.v1`** / **`emit_v15_m45_bounded_candidate_evaluation_execution`** / **`docs/runtime/v15_bounded_candidate_evaluation_execution_surface_v1.md`**. **No M45 benchmark pass/fail, scorecard result, strength evaluation, checkpoint promotion, torch.load, checkpoint blob loading, live SC2, XAI, human-panel, showcase, v2, or T2–T5 execution is claimed.** **No M46 benchmark pass/fail, scorecard result, strength evaluation, checkpoint promotion, torch.load, checkpoint blob loading, live SC2, XAI, human-panel, showcase, v2, or T2–T5 execution is claimed.** **`V15-M44`** — bounded evaluation execution preflight — **closed** on `main` ([PR #180](https://github.com/m-cahill/starlab/pull/180); merge **`735b2b6b8c35970b0e4bdbd376bb41365350874b`** merged **2026-04-30T20:23:01Z** UTC; **final PR-head** **`48f81486412ba09c5fcc8da14b5eeb465f6a924f`**; **authoritative PR-head CI** [`25187277616`](https://github.com/m-cahill/starlab/actions/runs/25187277616); **merge-boundary `main` CI** [`25187476188`](https://github.com/m-cahill/starlab/actions/runs/25187476188)). **`V15-M43`** — bounded evaluation gate — **closed** on `main` ([PR #179](https://github.com/m-cahill/starlab/pull/179); **authoritative PR-head CI** [`25156023350`](https://github.com/m-cahill/starlab/actions/runs/25156023350); **merge-boundary `main` CI** [`25156226743`](https://github.com/m-cahill/starlab/actions/runs/25156226743) — **success**). **`V15-M42`** **closed** on `main` ([PR #178](https://github.com/m-cahill/starlab/pull/178); merge **`8c9039a1d535135f6c1e2e910b71db8df903bdd9`**; **authoritative PR-head CI** [`25153445769`](https://github.com/m-cahill/starlab/actions/runs/25153445769); **merge-boundary `main` CI** [`25153637517`](https://github.com/m-cahill/starlab/actions/runs/25153637517) — **success**); **`package_ready_for_future_candidate_evaluation`**; **`ub_m39_expected`** tuple fix = **binding-only** (**not** evaluation semantics). **`V15-M41`** — *2-Hour Run Package & Evaluation Readiness* — **closed** on **`main`** ([PR #177](https://github.com/m-cahill/starlab/pull/177); merge **`71973d7afb8a1dff46f659da60591de41aec01d4`**; **authoritative PR-head CI** [`25148366193`](https://github.com/m-cahill/starlab/actions/runs/25148366193); **merge-boundary `main` CI** [`25148496084`](https://github.com/m-cahill/starlab/actions/runs/25148496084) — **success**); **packages** sealed **M39** Phase B evidence (**receipt** **`675ae631ff2fa8a9f71f2c03a93f3abbffbfe0c45fcb49a59c933920330b010c`**; **final candidate** **`51cea94ed5324087863b246b7b31a21021eba286924aea4609aa09466430a943`**) for future evaluation routing — **not** benchmark execution, strength proof, or promotion. **`starlab.v15.two_hour_run_package_evaluation_readiness.v1`** / **`emit_v15_m41_two_hour_run_package_evaluation_readiness`** / **`docs/runtime/v15_two_hour_run_package_evaluation_readiness_v1.md`**. Underlying run: **`two_hour_operator_run_completed_with_candidate_checkpoint`**; **`full_wall_clock_satisfied`** **true** — **execution evidence only**. **`V15-M39`** — *2-Hour Operator Run Attempt* — **Phase A** **closed** on **`main`** ([PR #175](https://github.com/m-cahill/starlab/pull/175)); **Phase B** authorized operator **`7200s`** attempt **completed** per **`docs/starlab-v1.5.md`**; **`starlab.v15.two_hour_operator_run_attempt.v1`** / **`emit_v15_m39_two_hour_operator_run_attempt`** / **`run_v15_m39_two_hour_operator_run_attempt`** / **`docs/runtime/v15_two_hour_operator_run_attempt_v1.md`** — fixture **`fixture_schema_only_no_operator_run`** in merge CI; **no** benchmark pass, strength, promotion, **T2**/**T3**, XAI, human-panel, showcase, or **v2** in receipts. **`V15-M38`** — *2-Hour Run Remediation & Launch Rehearsal* — **closed** on **`main`** ([PR #174](https://github.com/m-cahill/starlab/pull/174); merge `9cf2944d8ff1f9ca2ad1a9c9bce3a4b3641296fd`; authoritative PR-head [`25138210391`](https://github.com/m-cahill/starlab/actions/runs/25138210391); merge-boundary `main` [`25138442045`](https://github.com/m-cahill/starlab/actions/runs/25138442045) — **success**); **`starlab.v15.two_hour_run_remediation_launch_rehearsal.v1`** / **`emit_v15_m38_two_hour_run_remediation_launch_rehearsal`** / **`docs/runtime/v15_two_hour_run_remediation_launch_rehearsal_v1.md`** — **does not** execute the **7200s** run; **M28/M29** checkpoint retention + frozen **M39** launch posture — follows **`V15-M37`** **closed** on **`main`** ([PR #173](https://github.com/m-cahill/starlab/pull/173); merge `291aa417a95e5fe7e1047b3406bfbf8296972a4a`; authoritative PR-head [`25136254104`](https://github.com/m-cahill/starlab/actions/runs/25136254104); superseded PR-head [`25135628928`](https://github.com/m-cahill/starlab/actions/runs/25135628928), [`25135999735`](https://github.com/m-cahill/starlab/actions/runs/25135999735) — **not** merge authority; merge-boundary `main` [`25136423879`](https://github.com/m-cahill/starlab/actions/runs/25136423879) — **success**); **`starlab.v15.two_hour_run_blocker_discovery.v1`** / **`emit_v15_m37_two_hour_run_blocker_discovery`** / **`docs/runtime/v15_two_hour_run_blocker_discovery_v1.md`** — **discovery/audit only** — **does not** execute the **7200s** run; planned **V15-M39** attempt remains governed future scope. **`V15-M36`** — *Smoke Benchmark Execution Surface* — **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172); merge `aa0adba4406b5977020c5b8f66255fd198fb0816`; authoritative PR-head [`25131688817`](https://github.com/m-cahill/starlab/actions/runs/25131688817); merge-boundary `main` [`25131917336`](https://github.com/m-cahill/starlab/actions/runs/25131917336) — **success**); contract **`starlab.v15.smoke_benchmark_execution.v1`** (**`emit_v15_m36_smoke_benchmark_execution`**; **`docs/runtime/v15_smoke_benchmark_execution_surface_v1.md`**) — **M36 is smoke execution/refusal bookkeeping only — not** T2/T3, **not** a 2-hour run, **not** benchmark pass, **not** strength evaluation, **not** checkpoint promotion; **`benchmark_execution_performed`** **`false`**; see **`docs/starlab-v1.5.md`** (**§V15-M36**, **M36 non-claims block**). **`V15-M35`** — *Candidate Checkpoint Smoke Benchmark Readiness* — **closed** on **`main`** ([PR #171](https://github.com/m-cahill/starlab/pull/171); merge `3bf3fa461e07f023869d511525883a6066f2451c`; authoritative PR-head [`25129363401`](https://github.com/m-cahill/starlab/actions/runs/25129363401); merge-boundary `main` [`25129578504`](https://github.com/m-cahill/starlab/actions/runs/25129578504) — **success**); **`starlab.v15.candidate_checkpoint_smoke_benchmark_readiness.v1`** / **`python -m starlab.v15.emit_v15_m35_candidate_checkpoint_smoke_benchmark_readiness`**; **`docs/runtime/v15_candidate_checkpoint_smoke_benchmark_readiness_v1.md`**; merge CI **`--fixture-ci`** — **not** executed smoke benchmark; **strongest allowed claim:** readiness/refusal for **future** smoke benchmark **surface** — **readiness does not equal** benchmark execution, benchmark pass, strength evaluation, or checkpoint promotion. See **`docs/starlab-v1.5.md`** (**§V15-M35**, **M35 non-claims block**). **`V15-M34`** — *operator candidate checkpoint chain execution* — **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170); merge `201c907e9bedef205359ddcfba36c8b8111633ae`; authoritative PR-head [`25100127219`](https://github.com/m-cahill/starlab/actions/runs/25100127219); merge-boundary `main` [`25101174419`](https://github.com/m-cahill/starlab/actions/runs/25101174419) — **success**); operator-local **`candidate_model_load_cuda_probe_completed`** for candidate SHA-256 **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`** — **not** promotion, benchmark pass, strength, **72-hour** run, live SC2 eval, XAI, human-panel, showcase, **v2**, **T2/T3**. **`V15-M33`** — *candidate checkpoint model-load and CUDA inference probe* — **closed** on **`main`** ([PR #169](https://github.com/m-cahill/starlab/pull/169); merge `d543f1fc7fdac1fd5227cfef9a5014095b7412e5`; authoritative PR-head [`25096724285`](https://github.com/m-cahill/starlab/actions/runs/25096724285); merge-boundary `main` [`25097559273`](https://github.com/m-cahill/starlab/actions/runs/25097559273) — **success**) — **`emit_v15_m33_candidate_checkpoint_model_load_cuda_probe`** — default **`main`** CI **`--fixture-ci`** / **`fixture_schema_only_no_checkpoint_blob`** — **not** operator real-load unless separately authorized. **`V15-M32`** — *bounded candidate checkpoint evaluation execution* — **closed** on **`main`** ([PR #168](https://github.com/m-cahill/starlab/pull/168); merge `c853205c3f24a6196d582fa5f7f496c29e8c1942`; authoritative PR-head [`25095213484`](https://github.com/m-cahill/starlab/actions/runs/25095213484); merge-boundary `main` [`25095686610`](https://github.com/m-cahill/starlab/actions/runs/25095686610) — **success**); **`python -m starlab.v15.emit_v15_m32_candidate_checkpoint_evaluation_execution`** — **`evaluation_execution_performed`** denotes bounded harness/metadata execution only — **not** synonymous with **`benchmark_passed`**. **`V15-M31`** — *Candidate Checkpoint Evaluation Harness Dry-Run…* — **closed** on `main` ([PR #167](https://github.com/m-cahill/starlab/pull/167); merge `6fa7efc9372aa2e5015b0fbc87878d87dd867cc5`; authoritative PR-head [`25092872655`](https://github.com/m-cahill/starlab/actions/runs/25092872655); merge-boundary `main` [`25093208089`](https://github.com/m-cahill/starlab/actions/runs/25093208089) — **success**); **`python -m starlab.v15.emit_v15_m31_candidate_checkpoint_evaluation_harness_gate`** consumes sealed **`§V15-M30`** packages — **`evaluation_harness_ready` ≠ benchmark pass**. **`V15-M28`** — *SC2-Backed T1 Candidate Training Attempt* — **closed** on `main` ([PR #164](https://github.com/m-cahill/starlab/pull/164); merge `35d59f11e64b5b8fcb2c2937572478bfa9f37863`; **authoritative PR-head CI** [`25083196925`](https://github.com/m-cahill/starlab/actions/runs/25083196925); **merge-boundary `main` CI** [`25083354466`](https://github.com/m-cahill/starlab/actions/runs/25083354466) — **success**; **`docs/starlab-v1.5.md`** **§V15-M28** — **`fixture_only`** in CI; operator-local sample **`sc2_backed_candidate_training_completed_with_candidate_checkpoint`** — **not** strength). **`V15-M27`** — *SC2 Rollout Duration and Training-Loop Integration Fix* — **closed** on `main` ([PR #163](https://github.com/m-cahill/starlab/pull/163); merge `960f925afb2d1913055fe3ae18dc0b76a4c0951f` merged **2026-04-28T21:41:00Z** UTC; **authoritative PR-head CI** [`25078974410`](https://github.com/m-cahill/starlab/actions/runs/25078974410) on head `f5915527b7bc8e3c64cb617b6a83d08b9e70a074`; **merge-boundary `main` CI** [`25079150705`](https://github.com/m-cahill/starlab/actions/runs/25079150705) — **success**). **Operator-local outcome** (see **`docs/starlab-v1.5.md`** §V15-M27): **`sc2_rollout_training_loop_integration_completed`** — real **SC2** rollout + integration-smoke training binding; **not** strength / benchmark / v2. **`V15-M26`** — **closed** on `main` ([PR #162](https://github.com/m-cahill/starlab/pull/162); merge `393adb7fb91536c16927b93216bc7045981061e5` merged **2026-04-28T10:15:38Z** UTC) — outcome **`t1_checkpoint_plumbing_completed_but_sc2_training_not_yet_meaningful`**: **synthetic CUDA** **`t1_30min_checkpoint_produced_package_ready`** (**candidate** `.pt` — **plumbing** / hash recorded — **no** promotion; **not** SC2 gameplay learning); **SC2 rollout path** bounded smoke/bootstrap — **not yet meaningful SC2 training**. **Authoritative PR-head CI** [`25046959088`](https://github.com/m-cahill/starlab/actions/runs/25046959088) (head `9d877da21bd94df1d0685215ca9f29aac808ac98`); **merge-boundary `main` CI** [`25047132158`](https://github.com/m-cahill/starlab/actions/runs/25047132158) on merge commit `393adb7f…` — **success**. Attempt A **`t1_30min_completed_without_candidate_checkpoint`**. **Honest closeout:** **not** **successful SC2 T1 training**. See **`docs/starlab-v1.5.md`** **§V15-M26**. **`V15-M25`** — **closed** on `main` ([PR #160](https://github.com/m-cahill/starlab/pull/160); PR-head [`25039149033`](https://github.com/m-cahill/starlab/actions/runs/25039149033); merge-boundary [`25039367953`](https://github.com/m-cahill/starlab/actions/runs/25039367953); merge `e4ecc95e…`): **`m21_dry_run_preflight_passed` / `ready_for_v15_m26_t1_attempt`**; **`--dry-run-preflight-only`**; **real T1** **not** entered; **no** checkpoint (**M15** **`fixture_ci`**). **`V15-M24`** — *Real Operator T1 30-Minute GPU Run Attempt & Evidence Capture* — **closed** on `main` ([PR #159](https://github.com/m-cahill/starlab/pull/159); PR-head [`25036985830`](https://github.com/m-cahill/starlab/actions/runs/25036985830); merge-boundary [`25037125881`](https://github.com/m-cahill/starlab/actions/runs/25037125881); merge `4d8e8464…`); operator-local **`operator_preflight_blocked` / `missing_private_manifest_inputs`**; **`.venv`** CUDA re-verified; **M21** **not** invoked. **Immediately preceding v1.5 milestone on `main` (before M27):** **`V15-M26`** ([PR #162](https://github.com/m-cahill/starlab/pull/162); merge `393adb7f…`). **Prior closed:** **`V15-M23`** — *CUDA PyTorch Operator Environment Remediation* — **closed** on `main` ([PR #156](https://github.com/m-cahill/starlab/pull/156); PR-head [`25032909816`](https://github.com/m-cahill/starlab/actions/runs/25032909816); merge-boundary [`25033137726`](https://github.com/m-cahill/starlab/actions/runs/25033137726); merge `7ceb750a…`; branch `v15-m23-cuda-pytorch-operator-env-remediation`). CUDA **`.venv`** (`torch 2.11.0+cu128`); **`torch.cuda.is_available()`** **true** in **`.venv`**; **RTX** **5090**; default **PATH** **Python** **CPU-only**; **M21** dry-run **not** rerun in **M23**; **no** real **T1** claim. **Prior:** **`V15-M22`** — **closed** on `main` ([PR #154](https://github.com/m-cahill/starlab/pull/154); PR-head [`25031597888`](https://github.com/m-cahill/starlab/actions/runs/25031597888); merge-boundary [`25031726394`](https://github.com/m-cahill/starlab/actions/runs/25031726394); merge `364ce5b6…`); **`operator_preflight_blocked`** / **`torch_cuda_unavailable`**; **`run_v15_m21_t1_30min_gpu_run_execution`** **not** invoked. **v1.5 GPU ladder:** T1 real 30-minute operator run → T2 2-hour scale-up → T3 12-hour campaign; evaluation, XAI, human benchmark, showcase, and v2 remain downstream of governed checkpoint evidence. **`V15-M21`** — operator-local **T1** execution/evidence tooling — **closed** on `main` ([PR #153](https://github.com/m-cahill/starlab/pull/153); PR-head [`25029512815`](https://github.com/m-cahill/starlab/actions/runs/25029512815); merge-boundary [`25029902265`](https://github.com/m-cahill/starlab/actions/runs/25029902265)); **`docs/runtime/v15_operator_t1_30min_gpu_run_execution_v1.md`**, `starlab.v15.operator_t1_30min_gpu_run_execution.v1`, `python -m starlab.v15.emit_v15_operator_t1_30min_gpu_run_execution`, `python -m starlab.v15.run_v15_m21_t1_30min_gpu_run_execution`; **dry-run preflight** posture only; **full T1** **not** merge CI; **default** **`t1_30min_run_not_started`**. **`V15-M20`** — *Real Candidate Checkpoint Production Gate* — **closed** on `main` ([PR #152](https://github.com/m-cahill/starlab/pull/152); PR-head [`25027412708`](https://github.com/m-cahill/starlab/actions/runs/25027412708); merge-boundary [`25027870414`](https://github.com/m-cahill/starlab/actions/runs/25027870414)) — `docs/runtime/v15_real_candidate_checkpoint_production_gate_v1.md`, `starlab.v15.real_candidate_checkpoint_production_gate.v1`, `python -m starlab.v15.emit_v15_real_candidate_checkpoint_production_gate`, `python -m starlab.v15.run_v15_t1_30min_candidate_checkpoint_gate` — **`fixture_no_operator_run`** default; **full T1** GPU run **not** merge CI; **not** strength evaluation; see **§V15-M20** in **`docs/starlab-v1.5.md`**. **Last closed (package assembly):** **`V15-M19`** — *Candidate checkpoint evaluation **package** assembly* — **closed** on `main` ([PR #151](https://github.com/m-cahill/starlab/pull/151); merge `e9a40a21…`; **authoritative PR-head CI** [`25025083247`](https://github.com/m-cahill/starlab/actions/runs/25025083247); **merge-boundary `main` CI** [`25025427887`](https://github.com/m-cahill/starlab/actions/runs/25025427887) — **success**). `starlab.v15.candidate_checkpoint_evaluation_package.v1` — **`docs/runtime/v15_candidate_checkpoint_evaluation_package_v1.md`** — **package assembly / SHA cross-checks only**; **not** strength evaluation; default **`blocked_missing_candidate_checkpoint_evidence`** on merge CI paths. **Last closed (readiness / refusal):** **`V15-M18`** — *Candidate Checkpoint Evaluation Readiness & Refusal Contract v1* — **closed** on `main` ([PR #150](https://github.com/m-cahill/starlab/pull/150); merge `e58e249e…`; **authoritative PR-head CI** [`25023439537`](https://github.com/m-cahill/starlab/actions/runs/25023439537); **merge-boundary `main` CI** [`25023582158`](https://github.com/m-cahill/starlab/actions/runs/25023582158) — **success**). Contract `starlab.v15.checkpoint_evaluation_readiness.v1`; runtime **`docs/runtime/v15_checkpoint_evaluation_readiness_v1.md`**; `python -m starlab.v15.emit_v15_checkpoint_evaluation_readiness`. Default fixture posture **`no_candidate_refusal`**. Strongest allowed claim: STARLAB can **deterministically classify** whether governed inputs exist to begin a **future** candidate-checkpoint **evaluation** milestone. **`candidate_ready_for_evaluation`** means structural readiness only — **not** strength evaluation. **Prior closed:** **`V15-M17`** — *Long GPU Campaign Evidence Collection* — [PR #143](https://github.com/m-cahill/starlab/pull/143) (`starlab.v15.long_gpu_campaign_evidence.v1`; **`docs/runtime/v15_long_gpu_campaign_evidence_v1.md`**) — **evidence / preflight** **surface ready**; **not** a real long campaign in implementation PR/CI; **M08** `run_v15_long_gpu_campaign` for real runs; default **`long_gpu_run_authorized` false**. **Prior closed:** **`V15-M16`** — [PR #142](https://github.com/m-cahill/starlab/pull/142) — **`docs/runtime/v15_short_gpu_environment_evidence_v1.md`**. **`V15-M15`** — [PR #141](https://github.com/m-cahill/starlab/pull/141); **preflight** only. **`V15-M14`** — [PR #140](https://github.com/m-cahill/starlab/pull/140). **`V15-M13`** — [PR #139](https://github.com/m-cahill/starlab/pull/139); default no-go. **Full V15:** **`docs/starlab-v1.5.md`**. **V15-M12** — [PR #138](https://github.com/m-cahill/starlab/pull/138). **V15-M11** — [PR #137](https://github.com/m-cahill/starlab/pull/137). **V15-M10** — [PR #136](https://github.com/m-cahill/starlab/pull/136). **Prior closed packaging / harness gate anchors:** **`§V15-M31`** (**closed** [**PR #167**](https://github.com/m-cahill/starlab/pull/167)); sealed **`§V15-M30`** assembly (**[**PR #166**](https://github.com/m-cahill/starlab/pull/166)**). **`V15-M26`** — **closed** on `main` ([PR #162](https://github.com/m-cahill/starlab/pull/162)) — bounded **non-dry-run** **T1** + **`t1_30min_checkpoint_produced_package_ready`** (**candidate** `.pt` only — **no** promotion); Attempt A **`t1_30min_completed_without_candidate_checkpoint`**. **`V15-M00`**, **`V15-M01`** — registers: **`docs/runtime/v15_training_scale_provenance_asset_registers_v1.md`**. **PX2 (closed / transition):** **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`**, **`docs/runtime/px2_industrial_self_play_campaign_v1.md`**. M08: **`docs/runtime/v15_long_gpu_campaign_execution_v1.md`**. M07: **`docs/runtime/v15_training_smoke_short_gpu_shakedown_v1.md`**. **`V15-M06`**: **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; **`V15-M05`**: **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**; **`V15-M04`**: **`docs/runtime/v15_xai_evidence_contract_v1.md`**; **`V15-M03`**: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; **`V15-M02`**: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**.
