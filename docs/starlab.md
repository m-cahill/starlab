...
| Current milestone | **`V15-M16`** — *Short GPU / Environment Evidence Collection* — **proposed** / **not started** (after closed **`V15-M15`**, [PR #141](https://github.com/m-cahill/starlab/pull/141) — *Operator Evidence Collection Preflight*; preflight/sequencing only; **not** operator evidence collection; default **`preflight_plan_ready`**, **operator** evidence collection **`not_started`**; **v2** **not** authorized; **`docs/runtime/v15_operator_evidence_collection_preflight_v1.md`**). **Authority:** **`docs/starlab-v1.5.md`**. **PX2** **transition-complete**; **no** long GPU program deliverable. |
...
| Next planned follow-on | **`V15-M16`** — *Short GPU / Environment Evidence Collection* — **proposed / not started** (after **closed** **`V15-M15`**, [PR #141](https://github.com/m-cahill/starlab/pull/141); **`docs/starlab-v1.5.md`**). **`V15-M15`**: **closed**; preflight/sequencing only; **not** operator collection. **Proposed (not started):** **`V15-M16`**–**`V15-M21`** per **`docs/starlab-v1.5.md`**. **Default posture:** gather **operator evidence** before v2 / **`v1_5_hardening`**. **`V15-M13`**, **`V15-M12`** **closed** — [PR #139](https://github.com/m-cahill/starlab/pull/139), [PR #138](https://github.com/m-cahill/starlab/pull/138). **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only**. **v2** **not** opened. |
...
| **v1.5 (V15)** | **`V15-M00`** through **`V15-M15`** **closed** on `main`; **`V15-M16`**–**`V15-M21`** **proposed / not started**; next follow-on **`V15-M16`** *Short GPU / Environment Evidence Collection*; closed **M15** ([PR #141](https://github.com/m-cahill/starlab/pull/141)) — *Operator Evidence Collection Preflight* — preflight/sequencing only — **`docs/runtime/v15_operator_evidence_collection_preflight_v1.md`** (**not** operator evidence collection; **not** v2). Prior closed **M14** ([PR #140](https://github.com/m-cahill/starlab/pull/140)) — evidence remediation + operator acquisition **readiness** only — **`docs/runtime/v15_evidence_remediation_operator_acquisition_v1.md`**. (M11: [PR #137](https://github.com/m-cahill/starlab/pull/137); M10: [PR #136](https://github.com/m-cahill/starlab/pull/136); M09: [PR #135](https://github.com/m-cahill/starlab/pull/135); M08: [PR #133](https://github.com/m-cahill/starlab/pull/133); M07: [PR #129](https://github.com/m-cahill/starlab/pull/129); M06: [PR #127](https://github.com/m-cahill/starlab/pull/127); M12: [PR #138](https://github.com/m-cahill/starlab/pull/138); M13: [PR #139](https://github.com/m-cahill/starlab/pull/139)). **`V15-M08`** — **`implementation_ready_waiting_for_operator_run`**. **`V15-M11`** — human-panel **execution** + **claim-decision** **surface** — **`docs/runtime/v15_human_panel_bounded_benchmark_v1.md`**; **closed** on `main`; **not** a merge-bar human run. **`V15-M12`** — showcase release-pack **surface** — **`docs/runtime/v15_showcase_agent_release_pack_v1.md`**. **`V15-M13`** — v2 go/no-go **decision** — **`docs/runtime/v15_v2_go_no_go_decision_v1.md`**. **`V15-M09`** / **`V15-M10`** — see checkpoint / XAI runtime docs; **default** honest paths remain **blocked** / **fixture** where declared. M07: training-run **receipt** + shakedown **tooling** — **not** long campaign. M06: protocol + `fixture_ci` + optional **operator_declared** — **not** human-panel **match execution**; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**. **Proposed:** **`V15-M16`**–**`V15-M21`** — see **`docs/starlab-v1.5.md`**. | Full GPU run + **strong-agent** eval + XAI + **human-panel** eval — **chartered in v1.5**, not satisfied by **PX2** alone; **M14** **closed** as **remediation planning** only (**not** operator collection); **M15** **closed** as preflight/sequencing only | **V15-M13** is the **final planned** public V15 **decision** **milestone** (closed); **M14** **closed** — **readiness** / inventory / gap plan; **M15** **closed** — preflight/sequencing; **M16**+ **proposed**; **M11** **metadata** **surface** (not a default-benchmark pass) |
