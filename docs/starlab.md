...
| Current milestone | **`V15-M23`** — *CUDA PyTorch Operator Environment Remediation* — **proposed / not opened** (operator-local). **Last closed v1.5 on `main`:** **`V15-M22`** — [PR #154](https://github.com/m-cahill/starlab/pull/154) — **`operator_preflight_blocked`** / **`torch_cuda_unavailable`**; **full T1** **not** started (`run_v15_m21_t1_30min_gpu_run_execution` **not** invoked). **Prior:** **`V15-M21`** — [PR #153](https://github.com/m-cahill/starlab/pull/153) — `docs/runtime/v15_operator_t1_30min_gpu_run_execution_v1.md` — tooling + dry-run preflight **closed**; **full T1** GPU run **not** merge CI. **Prior:** **`V15-M20`** — [PR #152](https://github.com/m-cahill/starlab/pull/152). **PX2** **transition-complete**. |
| v1.5 ID anchors (M00–M22, quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**. **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
