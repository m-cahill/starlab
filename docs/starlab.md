...
| Current milestone | **`V15-M27`** — *T1 No-Checkpoint Analysis & Trainer Adjustment* — **proposed / not opened** on `main` (see **`docs/starlab-v1.5.md`** **§V15-M26**). **Last closed v1.5 on `main`:** **`V15-M26`** ([PR #162](https://github.com/m-cahill/starlab/pull/162)) — **real non-dry-run T1** captured; **no** candidate checkpoint. **Prior:** **`V15-M25`** — [PR #160](https://github.com/m-cahill/starlab/pull/160). **PX2** **transition-complete**. |
