...
| Current milestone | **`V15-M12`** — *Showcase Agent Release Pack* — **implementation** on `main` (PR pending). **Runtime:** **`docs/runtime/v15_showcase_agent_release_pack_v1.md`**. **Last closed (v1.5):** **`V15-M11`** — [PR #137](https://github.com/m-cahill/starlab/pull/137) — **`docs/runtime/v15_human_panel_bounded_benchmark_v1.md`**. **Authority:** **`docs/starlab-v1.5.md`**. **PX2** **transition-complete**. **`V15-M13`** — **not started**. |
...
| Next planned follow-on | **`V15-M12`** (*Showcase Agent Release Pack* — **implementation**; **`docs/runtime/v15_showcase_agent_release_pack_v1.md`**). **`V15-M13`** (*v2 Go / No-Go*) — **not started**. **`V15-M11`** **closed** — [PR #137](https://github.com/m-cahill/starlab/pull/137). **`V15-M06`** — [PR #127](https://github.com/m-cahill/starlab/pull/127); **`V15-M07`** — [PR #129](https://github.com/m-cahill/starlab/pull/129); **`V15-M09`** — [PR #135](https://github.com/m-cahill/starlab/pull/135). **`V15-M01`**; **`V15-M02`** — training-scale / provenance registers (**`docs/runtime/v15_training_scale_provenance_asset_registers_v1.md`**). **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only**. **v2** **deferred**. |
...
| **v1.5 (V15)** | **`V15-M00`** through **`V15-M11`** **closed** on `main` (M11: [PR #137](https://github.com/m-cahill/starlab/pull/137); M10: [PR #136](https://github.com/m-cahill/starlab/pull/136); M09: [PR #135](https://github.com/m-cahill/starlab/pull/135); M08: [PR #133](https://github.com/m-cahill/starlab/pull/133); M07: [PR #129](https://github.com/m-cahill/starlab/pull/129); M06: [PR #127](https://github.com/m-cahill/starlab/pull/127)); **`V15-M08`** — **`implementation_ready_waiting_for_operator_run`**. **`V15-M11`** — human-panel **execution** + **claim-decision** **surface** — **`docs/runtime/v15_human_panel_bounded_benchmark_v1.md`**; **closed** on `main`; **not** a merge-bar human run. **`V15-M12`** — showcase release-pack **surface** — **`docs/runtime/v15_showcase_agent_release_pack_v1.md`** (implementation; PR pending; **not** a default agent release). **`V15-M09`** / **`V15-M10`** — see **`docs/runtime/v15_checkpoint_evaluation_promotion_v1.md`** and **`docs/runtime/v15_replay_native_xai_demonstration_v1.md`**; **default** honest paths remain **blocked** / **fixture** where declared. M07: training-run **receipt** + shakedown **tooling** — **not** long campaign. M06: protocol + `fixture_ci` + optional **operator_declared** — **not** human-panel **match execution**; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**. | Full GPU run + **strong-agent** eval + XAI + **human-panel** eval — **chartered in v1.5**, not satisfied by **PX2** alone | **M12+** (showcase / go-no-go) per roadmap; **M11** **metadata** **surface** (not a default-benchmark pass) |
