...
| Current milestone | **`V15-M11`** — *Human Panel / Bounded Human Benchmark* — **not started** (awaits explicit plan; **M10** is **closed** on `main` [PR #136](https://github.com/m-cahill/starlab/pull/136) — `emit_v15_replay_native_xai_demonstration`, **`docs/runtime/v15_replay_native_xai_demonstration_v1.md`**, default fixture/report only; **not** real inference or faithfulness proof). **Prior (v1.5):** **`V15-M10`** *Replay-Native XAI Demonstration* — **closed** [PR #136](https://github.com/m-cahill/starlab/pull/136). **Prior:** **`V15-M09`** — *Checkpoint Evaluation and Promotion* — **closed** on `main` ([PR #135](https://github.com/m-cahill/starlab/pull/135)). **Prior:** **`V15-M08`** — [PR #133](https://github.com/m-cahill/starlab/pull/133) — **`implementation_ready_waiting_for_operator_run`**. **Authority:** **`docs/starlab-v1.5.md`**. **PX2** (through **M03**) **closed** / **transition-complete**. **`PX2-M04`/`PX2-M05`** — **planned**; **v2** not opened. |
...
| Next planned follow-on | **`V15-M11`** (human panel / benchmark **execution surface** — **not started**; **M10** **closed** on `main` [PR #136](https://github.com/m-cahill/starlab/pull/136); runtime **`docs/runtime/v15_replay_native_xai_demonstration_v1.md`**). **V15-M09** **closed** — [PR #135](https://github.com/m-cahill/starlab/pull/135). **V15-M08** long-run **execution** (operator-authorized) remains **separate** from M09’s evaluation **surface** — see **`docs/starlab-v1.5.md`**. **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only**. **v2** **deferred**. |
...
| **v1.5 (V15)** | **`V15-M00`** through **`V15-M10`** **closed** on `main` (M10: [PR #136](https://github.com/m-cahill/starlab/pull/136); M09: [PR #135](https://github.com/m-cahill/starlab/pull/135); M08: [PR #133](https://github.com/m-cahill/starlab/pull/133); M07: [PR #129](https://github.com/m-cahill/starlab/pull/129); M06: [PR #127](https://github.com/m-cahill/starlab/pull/127)); **`V15-M08`** — **`implementation_ready_waiting_for_operator_run`**. **`V15-M09`** / **`V15-M10`** — see **`docs/runtime/v15_checkpoint_evaluation_promotion_v1.md`** and **`docs/runtime/v15_replay_native_xai_demonstration_v1.md`**; **default** honest paths remain **blocked** / **fixture** where declared; M10 is **not** real XAI execution proof. M07: training-run **receipt** + shakedown **tooling** — **not** long campaign. M06: protocol + `fixture_ci` + optional **operator_declared** — **not** human-panel **execution**; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**. | Full GPU run + **strong-agent** eval + XAI + **human-panel** eval — **chartered in v1.5**, not satisfied by **PX2** alone | **M11+** (human / bounded execution) per roadmap; **V15-M11** **not started** |
...
**Current (v1.5):** **`V15-M11`** — *Human Panel / Bounded Human Benchmark* — **not started** (awaits explicit plan). **Last closed (v1.5):** **`V15-M10`** — *Replay-Native XAI Demonstration* — [PR #136](https://github.com/m-cahill/starlab/pull/136) — **`docs/runtime/v15_replay_native_xai_demonstration_v1.md`**; default `fixture_contract_only` / `blocked_missing_promoted_checkpoint`; **not** real XAI inference; **not** faithfulness proof; full governance **`docs/starlab-v1.5.md`**. **Prior (examples):** **`V15-M09`** — *Checkpoint Evaluation and Promotion* — **closed** on `main` ([PR #135](https://github.com/m-cahill/starlab/pull/135)); default **`blocked_missing_m08_campaign_receipt`**. **`V15-M08`** — *Long GPU Campaign Execution* — **closed** on `main` ([PR #133](https://github.com/m-cahill/starlab/pull/133)); **`implementation_ready_waiting_for_operator_run`**. **Closed v1.5 through M10 on `main`.** **`V15-M00`**, **`V15-M01`** — registers / training-scale contract: **`docs/runtime/v15_training_scale_provenance_asset_registers_v1.md`**. **PX2 (closed / transition):** **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`**, **`docs/runtime/px2_industrial_self_play_campaign_v1.md`**. M08 runtime: **`docs/runtime/v15_long_gpu_campaign_execution_v1.md`**. M07 (closed) runtime: **`docs/runtime/v15_training_smoke_short_gpu_shakedown_v1.md`**. **`V15-M06`**: **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; **`V15-M05`**: **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**; **`V15-M04`**: **`docs/runtime/v15_xai_evidence_contract_v1.md`**; **`V15-M03`**: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; **`V15-M02`**: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**.
