...
| Last closed milestone (v1.5) | **`V15-M33`** — *Candidate Checkpoint Model-Load and CUDA Inference Probe* — **closed** on `main` ([PR #169](https://github.com/m-cahill/starlab/pull/169); merge `d543f1fc7fdac1fd5227cfef9a5014095b7412e5`; PR-head [`25096724285`](https://github.com/m-cahill/starlab/actions/runs/25096724285); merge-boundary [`25097559273`](https://github.com/m-cahill/starlab/actions/runs/25097559273) — **success**) — **`starlab.v15.candidate_checkpoint_model_load_cuda_probe.v1`** + profile **`starlab.v15.m33.candidate_checkpoint_model_load_cuda_probe.v1`** — **`--fixture-ci`** / **`fixture_schema_only_no_checkpoint_blob`** on default **`main`** CI — **not** operator real-load unless separately run — **not** benchmark, strength, promotion, **72-hour** campaign, XAI, human-panel, showcase, **v2**, or **T2/T3**. **`docs/starlab-v1.5.md`** **§V15-M33**; **`docs/runtime/v15_candidate_checkpoint_model_load_cuda_probe_v1.md`**. **Prior:** **`V15-M32`** bounded execution (**§V15-M32**); **`V15-M31`** harness (**§V15-M31**); **`V15-M30`** sealed package (**§V15-M30**). |
...
| Current milestone | **`V15-M34`** — *Candidate Checkpoint Loader Completion / Operator CUDA Probe Execution* — **provisional** — consumes **`§V15-M33`** surface; may emit or locate real **`§V15-M32`** JSON; **`operator-local`** `.venv` CUDA model-load probe only under explicit dual guards — **not** benchmark pass, strength, promotion, **72-hour** run, XAI, human-panel, showcase, **v2**, or **T2/T3** (see **`docs/starlab-v1.5.md`**) |
| v1.5 ID anchors (M00–M34 provisional, quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`** (provisional next). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | Roadmap: **`V15-M34`** — operator CUDA probe execution / real M32 artifact / rehearsal gate — see **`docs/starlab-v1.5.md`**. **`V15-M33`** **closed** on **`main`** ([PR #169](https://github.com/m-cahill/starlab/pull/169)) — fixture/schema-only default CI posture. |
