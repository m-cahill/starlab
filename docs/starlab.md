...
| Last closed milestone (v1.5) | **`V15-M36`** — *Smoke Benchmark Execution Surface* — **closed** on `main` ([PR #172](https://github.com/m-cahill/starlab/pull/172); merge `aa0adba4406b5977020c5b8f66255fd198fb0816`; **authoritative PR-head CI** [`25131688817`](https://github.com/m-cahill/starlab/actions/runs/25131688817) on head `f06d9721cc50413f2cb282574bf033e5cc79d3ff`; **merge-boundary `main` CI** [`25131917336`](https://github.com/m-cahill/starlab/actions/runs/25131917336) — **success**); **`starlab.v15.smoke_benchmark_execution.v1`** / **`emit_v15_m36_smoke_benchmark_execution`**; merge CI **`--fixture-ci`** — **fixture/schema only** (**not** result-bearing benchmark). **Strongest allowed claim:** governed **smoke execution/refusal** surface over sealed **M35** JSON; synthetic bounded smoke may set **`smoke_execution_performed=true`** while **`benchmark_execution_performed`**, **`benchmark_passed`**, **`scorecard_results_produced`**, **`strength_evaluated`**, **`checkpoint_promoted`** stay **false**. **`docs/starlab-v1.5.md`** **§V15-M36**. **Prior:** **`V15-M35`** ([PR #171](https://github.com/m-cahill/starlab/pull/171)); **`V15-M34`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)). |
...
| Current milestone | **`V15-M37`** — *2-Hour Run Blocker Discovery & Operator Readiness Audit* — **provisional** — see **`docs/starlab-v1.5.md`**. **`V15-M36`** — **`starlab.v15.smoke_benchmark_execution.v1`** (**`emit_v15_m36_smoke_benchmark_execution`**) — **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`docs/runtime/v15_smoke_benchmark_execution_surface_v1.md`**. **V15-M37** inventories readiness/blockers for a planned **V15-M39** **7200s** continuation attempt (**M37** does **not** execute that run); **no** benchmark-pass claim by default; **no** T2/T3 |
| v1.5 ID anchors (M00–M37 quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`**, **`V15-M36`**, (**`V15-M37`** provisional; **`V15-M38`** provisional next). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M37`** — *2-Hour Run Blocker Discovery & Operator Readiness Audit* — **provisional** — blocker discovery / readiness audit (then **V15-M38** remediation); **no** strength claim; **no** checkpoint promotion; **no** showcase / XAI / human-panel / **v2** — see **`docs/starlab-v1.5.md`**. **`V15-M36`** **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`V15-M35`** **closed** ([PR #171](https://github.com/m-cahill/starlab/pull/171)). **`V15-M34`** **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
