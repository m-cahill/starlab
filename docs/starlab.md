...
| Current milestone | **`V15-M27`** — *SC2 Rollout Duration and Training-Loop Integration Fix* — **proposed / not opened** (optional secondary: *T1 No-Checkpoint Analysis & Trainer Adjustment*). **Last closed v1.5 on `main`:** **`V15-M26`** ([PR #162](https://github.com/m-cahill/starlab/pull/162); merge `393adb7f…`; outcome **`t1_checkpoint_plumbing_completed_but_sc2_training_not_yet_meaningful`**). **PX2** **transition-complete**. |
