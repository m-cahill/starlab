...
| Current milestone | **`V15-M15`** — *Operator Evidence Collection Preflight* — **proposed / not started** (next v1.5 follow-on per **`docs/starlab-v1.5.md`**). **v2** **not** authorized. **Last closed (v1.5):** **`V15-M14`** — [PR #140](https://github.com/m-cahill/starlab/pull/140) — *Evidence Remediation / Operator Evidence Acquisition*; default **`remediation_plan_ready`**, **operator evidence not collected**. **Authority:** **`docs/starlab-v1.5.md`**. **PX2** **transition-complete**; **no** long GPU program deliverable. |
...
| Next planned follow-on | **`V15-M15`** — *Operator Evidence Collection Preflight* — **proposed / not started** (after closed **`V15-M14`** [PR #140](https://github.com/m-cahill/starlab/pull/140); **`docs/starlab-v1.5.md`**). **`V15-M14`**: remediation plan + runbook; **not** operator collection. **Proposed (not started):** **`V15-M16`**–**`V15-M21`** per **`docs/starlab-v1.5.md`**. **Default posture:** gather **operator evidence** before v2 / **`v1_5_hardening`**. **`V15-M13`**, **`V15-M12`** **closed** — [PR #139](https://github.com/m-cahill/starlab/pull/139), [PR #138](https://github.com/m-cahill/starlab/pull/138). **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only**. **v2** **not** opened. |
