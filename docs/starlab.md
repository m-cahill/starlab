...
**Status:** **Current (stub)** — charter `docs/company_secrets/milestones/M38/M38_plan.md`. **M38** product scope is **not** started in the M37 closeout commit stream; next work is chartered on an **M38** branch per governance.
