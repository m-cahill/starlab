...
| Current milestone | **`None`** — **no** open **`PX2-MNN`** on `main`. **Last PX2 closeout:** **`PX2-M02`** ([PR #96](https://github.com/m-cahill/starlab/pull/96)) — conservative replay labeling, governed bootstrap dataset + report, first neural policy, legality-aware decode + compile eval, fixture-only CI — **replay-bootstrap only**; **not** self-play; **not** Blackwell execution; **not** ladder or autonomous strength proof. Public **`docs/runtime/px2_neural_bootstrap_from_replays_v1.md`**. **`PX2-M03`** — **planned only**. **PX1-M04** — **closed** ([PR #93](https://github.com/m-cahill/starlab/pull/93)) — **does not** auto-open **`PX1-M05`** or **v2**. **`PX1-M05`** remains **optional / not yet opened**. **v2** is **not** opened. |
...
| **PX2** | **PX2-M00**–**PX2-M02** **closed** (charter; Terran runtime; replay-bootstrap / first neural policy over M01 — **not** strength proof) | Industrial self-play (**PX2-M03**+); demo refresh — **later milestones** | **PX2-M00**–**PX2-M05** (roadmap) |
...
### PX2 roadmap (**PX2-M00**–**PX2-M02** **closed** on `main`; **`PX2-M03`**–**`PX2-M05`** **planned**)
...
- **`PX2-M02`** **closed** on `main` ([PR #96](https://github.com/m-cahill/starlab/pull/96)) — first **replay-bootstrap** supervised path over **M01** — **not** industrial self-play (**PX2-M03**); **not** strength proof.
- **`PX2-M03`** remains **planned only** — **not** opened by **`PX2-M02`** closeout.
...
**Current:** **`None`** — **no** open **`PX2-MNN`** on `main`. **Last PX2 milestone closed:** **`PX2-M02`** — Neural Bootstrap from Replays — **closed** on `main` ([PR #96](https://github.com/m-cahill/starlab/pull/96)). **`PX2-M03`** — **planned only**. **`PX1-M05`** **optional / not yet opened**; **v2** **not** opened.
...
**Post-closeout ledger:** **`current milestone`** = **`None`**; **`PX2-M03`** **planned only**; **`PX1-M05`** / **v2** **not** opened by **`PX2-M02`**.
