...
| Last closed milestone (v1.5) | **V15-M04** — *XAI Evidence Contract v1* — **closed** on `main` ([PR #123](https://github.com/m-cahill/starlab/pull/123); merge `3bf4e2ca5343b116e4e979d5dc50213596b7519b`; **authoritative PR-head CI** [`24922143448`](https://github.com/m-cahill/starlab/actions/runs/24922143448); **merge-boundary `main` CI** [`24922278255`](https://github.com/m-cahill/starlab/actions/runs/24922278255) — **success**). **Prior:** **`V15-M03`** ([PR #120](https://github.com/m-cahill/starlab/pull/120)); **`V15-M02`** ([PR #118](https://github.com/m-cahill/starlab/pull/118)); **`V15-M01`** (PR #117); **`V15-M00`** (PR #116). **Not** long GPU **training** execution, claim-critical **asset rows**, real XAI **inference** proof, or checkpoint-**byte** proof from **fixture** CI. |
...
| Current milestone | **`V15-M05`** — *Strong-Agent Benchmark Protocol* — **not started** (await explicit plan approval). **Last closed (v1.5):** **`V15-M04`** on `main` ([PR #123](https://github.com/m-cahill/starlab/pull/123); contract `starlab.v15.xai_evidence_pack.v1`; runtime **`docs/runtime/v15_xai_evidence_contract_v1.md`**; PR-head [`24922143448`](https://github.com/m-cahill/starlab/actions/runs/24922143448); merge-boundary [`24922278255`](https://github.com/m-cahill/starlab/actions/runs/24922278255)). **Authority** **`docs/starlab-v1.5.md`**; M04 runtime (closed) **`docs/runtime/v15_xai_evidence_contract_v1.md`**; M03 **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; M02 **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**; **PX2** did **not** perform a **long wall-clock GPU training session** as a program deliverable. Default **CI** remains **CPU** fixture self-play / bootstrap paths. **`PX2-M04`** / **`PX2-M05`** — **planned**; **`PX1-M05`** optional; **v2** not opened. |
...
| Next planned follow-on | **`V15-M05`** (*Strong-Agent Benchmark Protocol*) — **not started** (await explicit plan approval). **v1.5** authority: **`docs/starlab-v1.5.md`**. M04 XAI contract (closed): **`docs/runtime/v15_xai_evidence_contract_v1.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only** on the **PX2** namespace. **`PX1-M05`** optional. **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **deferred** / **not** opened. |
...
**Current (v1.5):** **`V15-M04`** — *XAI Evidence Contract v1* — **in progress** (runtime **`docs/runtime/v15_xai_evidence_contract_v1.md`**; emitter `python -m starlab.v15.emit_v15_xai_evidence_pack`). **Closed v1.5 line on `main`:** **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M03`**. **Authority:** **`docs/starlab-v1.5.md`**. **Prior** M03: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; M02: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**.

### V15-M04 — *XAI Evidence Contract v1* — **in progress**

**Intent:** Deterministic **XAI evidence pack** JSON + report (`starlab.v15.xai_evidence_pack.v1`); default **`fixture_ci`**; optional **`operator_declared`** with **`--evidence-json`**. **Not** model inference; **not** real replay or checkpoint-blob I/O; **not** `long_gpu_run_authorized` **true**; see **`docs/starlab-v1.5.md`** M04 non-claims.
