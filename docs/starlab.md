...
| Last closed milestone (v1.5) | **`V15-M35`** — *Candidate Checkpoint Smoke Benchmark Readiness* — **closed** on `main` ([PR #171](https://github.com/m-cahill/starlab/pull/171); merge `3bf3fa461e07f023869d511525883a6066f2451c`; **authoritative PR-head CI** [`25129363401`](https://github.com/m-cahill/starlab/actions/runs/25129363401) (head `159723009b82c11c86961617d7860add624ae1e0`); **merge-boundary `main` CI** [`25129578504`](https://github.com/m-cahill/starlab/actions/runs/25129578504) — **success**) — **`starlab.v15.candidate_checkpoint_smoke_benchmark_readiness.v1`** / **`emit_v15_m35_candidate_checkpoint_smoke_benchmark_readiness`**; merge CI **`--fixture-ci`** = **`fixture_schema_only_no_benchmark_execution`** — **readiness/refusal only**; **readiness does not equal** benchmark execution, benchmark pass, strength evaluation, or checkpoint promotion. **`docs/starlab-v1.5.md`** **§V15-M35**. **Prior:** **`V15-M34`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
...
| Current milestone | **`V15-M36`** — *Smoke Benchmark Execution Surface* — **`starlab.v15.smoke_benchmark_execution.v1`** (**`emit_v15_m36_smoke_benchmark_execution`**) — **`docs/runtime/v15_smoke_benchmark_execution_surface_v1.md`**. **M36 is smoke execution surface only**, **not** a 2-hour run and **not** T2/T3; **`benchmark_execution_performed`** **`false`** in all modes. **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M37`** — *Bounded Operator Smoke Benchmark Attempt* — **provisional** — see **`docs/starlab-v1.5.md`**. **`V15-M36`** tooling: **`starlab.v15.smoke_benchmark_execution.v1`**; **`emit_v15_m36_smoke_benchmark_execution`**; **`v15_smoke_benchmark_execution.json`**. **`V15-M35`** **closed** on **`main`** ([PR #171](https://github.com/m-cahill/starlab/pull/171)). **`V15-M34`** **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
