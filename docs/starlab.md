...
| Current milestone | **`V15-M28`** — *SC2-Backed T1 Candidate Training Attempt* — **recommended next** (implementation **not** yet on `main`; charter in **`docs/starlab-v1.5.md`** **§V15-M27** **Recommended next**). **Last merge:** **`V15-M27`** [PR #163](https://github.com/m-cahill/starlab/pull/163). **PX2** **transition-complete**. |
