...
| Current milestone | **None** — planned **v1** arc (**M00–M61**) **complete** on `main`. **M61** **closed** — release-lock machinery + operator-local campaign **`m61_evidence_2026_04_16_a`** / **`m61_exec_001`** with **`--post-bootstrap-protocol-phases`**, watchable **M44**, proof pack + audit **`ready_within_scope`** — see §11. **M60** **closed** — structural/diligence (private campaign executor split + guardrails + audit mapping) — **not** new governed product artifact family; **not** equivalence/benchmark/ladder/live-SC2 claims. **M59** **closed** — bounded descriptive ladder/public protocol + evidence — **not** ladder/public **performance** proof; **not** benchmark integrity; **not** replay↔execution equivalence (**M52**–**M54** **closed**). **M58** **closed** — bounded **M57** hardening + cost guardrails — **not** global live-SC2-in-CI proof. |
| Next planned follow-on | **v2 / post-v1** work (**multi-game**, **AURORA/audio**, broader productization) — **explicitly outside** the closed **M00–M61** arc unless the ledger is **rechartered**; see §6 **v2** note and `docs/starlab-vision.md`. **No M62** stub. |
