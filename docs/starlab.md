...
| Last closed milestone (v1.5) | **`V15-M34`** — *Operator Candidate Checkpoint Chain Execution* — **closed** on `main` ([PR #170](https://github.com/m-cahill/starlab/pull/170); merge `201c907e9bedef205359ddcfba36c8b8111633ae`; **authoritative PR-head CI** [`25100127219`](https://github.com/m-cahill/starlab/actions/runs/25100127219) (head `6421c8453c65de3a8d09a068738f50607aa540cf`); **merge-boundary `main` CI** [`25101174419`](https://github.com/m-cahill/starlab/actions/runs/25101174419) — **success**) — operator-local **`candidate_model_load_cuda_probe_completed`** for public candidate SHA-256 **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`** (`.venv` CUDA; dual guards; sealed **M32**); artifacts **`v15_candidate_checkpoint_model_load_cuda_probe.json`** (+ report, checklist) — **local-only** — **not** committed; **not** promotion, benchmark, strength, **72-hour** campaign, live SC2 eval, XAI, human-panel, showcase, **v2**, **T2/T3**. **`docs/starlab-v1.5.md`** **§V15-M34**. **Prior:** **`V15-M33`** ([PR #169](https://github.com/m-cahill/starlab/pull/169)) — fixture default CI; operator CUDA probe optional without sealed **M32**. |
...
| Current milestone | **`V15-M35`** — *Candidate Checkpoint Smoke Benchmark Readiness* — **provisional** — **`emit_v15_m35_candidate_checkpoint_smoke_benchmark_readiness`** + **`docs/runtime/v15_candidate_checkpoint_smoke_benchmark_readiness_v1.md`**; **`--fixture-ci`** default in CI — **not** an executed smoke benchmark; see **`docs/starlab-v1.5.md`** |
| v1.5 ID anchors (M00–M35 provisional, quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`** (provisional next). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M35`** — *Candidate Checkpoint Smoke Benchmark Readiness* — **provisional**; **`V15-M36`** forward stub (smoke benchmark **execution** — not chartered in **M35**). See **`docs/starlab-v1.5.md`**. **`V15-M34`** **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
