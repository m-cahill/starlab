...
| Current milestone | **None** — **PX1-M03** — Candidate Strengthening & Demo Readiness Remediation — **closed** on `main` (closeout [PR #CLOSEOUT_PR_NUM](https://github.com/m-cahill/starlab/pull/CLOSEOUT_PR_NUM)); operator-local remediation under the frozen protocol concluded with **`demo-ready-candidate-selected`** for **`px1_m01_weighted_refit_rl_bootstrap_v1`** (replay-backed wins + watchable optional media registration on the authoritative series — **not** default CI). **PX1-M02** — **closed** on `main` (closeout [PR #89](https://github.com/m-cahill/starlab/pull/89)); honest **`no-candidate-selected`**. **PX1-M01** — **closed** on `main` (closeout [PR #87](https://github.com/m-cahill/starlab/pull/87)). **`PX1-M04`–`PX1-M05`** are **planned / not yet opened** — **PX1-M04** **does not** open automatically from **PX1-M03** closeout. **v2** is **not** opened. **PV1** is **closed** and **historical**. **v1** **M00–M61** remains **closed** — **no** **M62**. |
...
| Next planned follow-on | **`PX1-M04`–`PX1-M05`** remain **planned / not yet opened** until **separately** chartered — **`PX1-M03` closeout does not open them**. **`PX1-M02`** **did not** open automatically from **PX1-M01** closeout; **`PX1-M03`** opened by explicit PR (not automatic from **PX1-M02**). **`PX1-M04`** (governed demo/video) **does not** open automatically from **PX1-M03** closeout. **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **not** opened. |
...
### PX1 roadmap (PX1-M00 **closed**; **PX1-M01** **closed**; **PX1-M02** **closed**; **PX1-M03** **closed**; **PX1-M04**+ **not** opened)
...
| `PX1-M03` | Candidate Strengthening & Demo Readiness Remediation | **closed** on `main` (opening [PR #90](https://github.com/m-cahill/starlab/pull/90); closeout [PR #CLOSEOUT_PR_NUM](https://github.com/m-cahill/starlab/pull/CLOSEOUT_PR_NUM)) | Corrective milestone after **PX1-M02** **`no-candidate-selected`**; bounded hybrid live surface + frozen **`px1_demo_readiness_*`** protocol; **closed** with operator-local **`demo-ready-candidate-selected`** (replay-backed + watchable optional media) — **not** **PX1-M04** winning-video pack |
...
**Ledger truths (PX1 phase, **PX1-M03** **closed**):**
...
- **`current milestone`** = **None** — **PX1-M03** **closed** on `main` with operator-local **`demo-ready-candidate-selected`** under the frozen remediation protocol (watchable optional media registration includes **`out/px1_m03_operator_watchable.mp4`** on the counted watchable win — operator-local). **PX1-M02** **closed** with **`no-candidate-selected`** (**preserved**). **PX1-M01** **closed** with operator-local **`threshold-met`** — industrial run success **only**.
- **v2** is **not** opened.
- **`PX1-M04`–`PX1-M05`** are **planned / not yet opened** — **PX1-M04** **does not** open automatically from **PX1-M03** closeout.
- **Governed winning demo / video proof** (**PX1-M04**) is **not** closed by **PX1-M03** — **PX1-M04** awaits **separate** charter; **PX1-M03** satisfied **frozen** demo-readiness **remediation** bar only.
...
**Current:** **`current milestone`** = **None**. **PX1-M03** — Candidate Strengthening & Demo Readiness Remediation — **closed** on `main` (closeout [PR #CLOSEOUT_PR_NUM](https://github.com/m-cahill/starlab/pull/CLOSEOUT_PR_NUM)); frozen-protocol operator-local remediation concluded with **`demo-ready-candidate-selected`** for **`px1_m01_weighted_refit_rl_bootstrap_v1`** (including replay-backed wins and **≥1** watchable win with optional media registration — real captured video path documented under operator-local `out/`). **PX1-M02** — **closed** (closeout [PR #89](https://github.com/m-cahill/starlab/pull/89)); **`no-candidate-selected`** — **preserved**. **PX1-M01** — **closed** (closeout [PR #87](https://github.com/m-cahill/starlab/pull/87)) — **`threshold-met`**. **`PX1-M04`–`PX1-M05`** **planned / not yet opened** — **PX1-M04** **does not** open automatically. **v2** is **not** opened. **v1** (**M00–M61**) and **PV1** remain **closed** and **historical**.
...
**Closeout PR:** [PR #CLOSEOUT_PR_NUM](https://github.com/m-cahill/starlab/pull/CLOSEOUT_PR_NUM) — ledger + **`PX1-M03_summary.md`** / **`PX1-M03_audit.md`** / **`PX1-M03_run2.md`** — records successful remediation closure; **`current milestone`** → **None**; **does not** open **PX1-M04** or **v2**.

**Intent (delivered):** Corrective milestone after **PX1-M02** **`no-candidate-selected`** — bounded capability uplift + fresh **`local_live_sc2`** evaluation under frozen **`px1_demo_readiness_*`** minima — **not** the governed winning-video milestone (**PX1-M04**).

**Non-claims (PX1-M03 overall):** **not** **PX1-M04** demo proof pack; **not** ladder strength; **not** automatic **v2**; operator-local decisive evidence — **not** default merge-gate live SC2.
...
### 2026-04-19 — **PX1-M03** governance closeout — merged to `main` ([PR #CLOSEOUT_PR_NUM](https://github.com/m-cahill/starlab/pull/CLOSEOUT_PR_NUM)) — **closed**; **`current milestone`** → **None**
