...
| Last closed milestone (v1.5) | **`V15-M29`** — *Full 30-Minute SC2-Backed T1 Candidate Run & Evaluation Package Gate* — **operator-local receipts recorded**: **`starlab.v15.full_30min_sc2_backed_t1_run.v1`** — **`profile`** **`operator_local_full_wall_clock`** — **`m29_outcome`** **`sc2_backed_t1_full_30min_completed_with_candidate_checkpoint`** — **1800 s** requested/observed wall clock — **`full_wall_clock_satisfied`** **true** — **`training_update_count`** **2,476,886** / **`checkpoint_count`** **49,537** — sealed M29 **`87d7d00b0fd19bb9f9d85180af9a0245957449ef0160575de146a71dd2ee4ea0`** — delegated M28 **`de214a02f95edd0b281852cd6340fca155c7d839ca52094e8c473d26c62f7c8e`** — M27 **`f9c2ca5aca7a3b15df0567358c1f207f99e112cd8d816f5ac1a1c6ff04022227`** — candidate **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`** (**`not_promoted_candidate_only`**) — **not strength / benchmark / XAI / human-panel / showcase / v2**. **Local bundle:** `out/v15_m29/full_30min_sc2_backed_t1_run1`. Narrative **`docs/starlab-v1.5.md`** **§V15-M29**. **Prior `V15-M28` on `main`:** [PR #164](https://github.com/m-cahill/starlab/pull/164). |
...
| Current milestone | **`V15-M30`** — *SC2-Backed Candidate Checkpoint Evaluation Package* (bind **`starlab.v15.candidate_checkpoint_evaluation_package.v1`** to **`§V15-M27`** / **`§V15-M28`** / **`§V15-M29`** sealed receipts per **`docs/starlab-v1.5.md`** **§V15-M30** stub — **assembly/binding/consistency posture** only; **not** strength evaluation by default). |
| v1.5 ID anchors (M00–M30 proposed, quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**. **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M30`** — *SC2-Backed Candidate Checkpoint Evaluation Package* — bind **`starlab.v15.candidate_checkpoint_evaluation_package.v1`** to **`V15-M29`** receipts + lineage (`docs/starlab-v1.5.md` **§V15-M29**/**§V15-M30**). |
