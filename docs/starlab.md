...
- public flagship proof pack (**M37**)

### Phase VI — Expansion Decision and Platform Boundary Review

Focus:

- SC2 substrate review and expansion decision (**M38**)
- platform boundary review and multi-environment charter (**M39** — earned only)

---

## 7. Milestone table

Planned program arc (40 milestones, M00–M39):
...
| M37 | Public Flagship Proof Pack | V | In progress | v0.0.37-m37 | — |
| M38 | SC2 Substrate Review & Expansion Decision | VI | Planned | v0.0.38-m38 | — |
| M39 | Platform Boundary Review & Multi-Environment Charter | VI | Planned | v0.0.39-m39 | — |
...
| M38 | SC2 substrate review and expansion decision |
| M39 | Platform boundary review and multi-environment charter |
...
**Phase V bridge (compact):** dataset contract → trained imitation baseline → learned-agent evaluation → hierarchy → evidence surface → **audit closure (M32–M34)** → **audit closure IV/V (M35–M36)** → flagship proof (**M37**).
...
| **M35** | **Audit closure IV** — `M14BundleLoader`, `parser_io` / `replay_slice_generation` / observation reconciliation splits, `load_json_object_strict`, ledger **M00–M39** (**proved** on `main`; [PR #46](https://github.com/m-cahill/starlab/pull/46); see §18 / `M35_run1.md`). **Not** M37 flagship proof pack, **not** benchmark integrity, **not** live SC2 in CI. |
| **M36** | **Audit closure V** — `docs/starlab_archive.md` (verbatim **M01–M27** §7 notes), ledger §7 archival policy + **M28–M35** inline notes, governance-test consolidation (**proved** on `main`; [PR #47](https://github.com/m-cahill/starlab/pull/47); see §18 / `M36_run1.md`). **Not** M37 flagship product code. |
| **M37** | **Public flagship proof pack** (**stub**; planned product milestone — **not** started in M36 closeout). |

### Phase VI progression (compact)

| Milestone | What it proves (Phase VI) |
| --------- | ------------------------- |
| **M38** | **SC2 substrate review & expansion decision** (planned). |
| **M39** | **Platform boundary review & multi-environment charter** (planned; earned only). |
...
**Status:** **Current stub milestone** — charter stub `docs/company_secrets/milestones/M37/M37_plan.md`; **no** M37 flagship proof-pack **product** implementation started in this closeout pass (M36 closeout is governance/docs only). **M38** / **M39** (Phase VI) remain **planned** per §7.
...
**Predecessor (M32):** **Audit Closure I** — measured **`coverage.xml` / `pytest-junit.xml`** in CI, **`fail_under`** line gate, SHA-pinned actions, **`@pytest.mark.smoke`** + `make smoke`, **`Makefile`**, **`docs/audit/DeferredIssuesRegistry.md`**, **40 milestones (M00–M39)** (per §7; M32 closeout text remains historical); **OD-007** → **M39**.
...
**Explicit non-claims (M31):** not benchmark integrity, not live SC2, not web UI, not M37 flagship proof pack product.
...
Until **M37** is **merged and closed** on `main` with authoritative CI (when implemented), treat the following as **not proved**:

- **M37** public flagship proof-pack **product** work (**not** claimed until M37 closes).
...
| OD-007 | Second-environment posture       | Deferred | M39              | Explicitly not a starting decision                                 |
...
**M34 note:** Evidence column — **merged** to `main` ([PR #40](https://github.com/m-cahill/starlab/pull/40); §18 / `M34_run1.md`): **`starlab._io`**, split `tests/test_governance_*.py`, **Dependabot** + dev dependency caps, **`docs/diligence/operating_manual_promotion_readiness.md`** (prep only), **`docs/audit/broad_exception_boundaries.md`** (**DIR-005** = **confirming/documenting** approved boundary catches — **not** code narrowing); coverage gate **75.4** unchanged; **green PR-head** [`24261065226`](https://github.com/m-cahill/starlab/actions/runs/24261065226) on `a748bd7…`; **green merge-push `main`** [`24261102337`](https://github.com/m-cahill/starlab/actions/runs/24261102337) on `51e960d…`. **Not** M37 flagship proof pack, **not** benchmark integrity, **not** live SC2 in CI.

**M35 note:** Evidence column — **merged** to `main` ([PR #46](https://github.com/m-cahill/starlab/pull/46); §18 / `M35_run1.md`): **`M14BundleLoader`**, **`parser_io`**, **`replay_slice_generation`**, observation reconciliation split, **`load_json_object_strict`**, ledger **M00–M39** + stubs, governance tests; coverage gate **75.4** unchanged; **green PR-head** [`24265022396`](https://github.com/m-cahill/starlab/actions/runs/24265022396) on `91e45dd…`; **green merge-push `main`** [`24265056432`](https://github.com/m-cahill/starlab/actions/runs/24265056432) on `5b4d24b…`; superseded PR-head [`24264929015`](https://github.com/m-cahill/starlab/actions/runs/24264929015), [`24264963434`](https://github.com/m-cahill/starlab/actions/runs/24264963434) — **not** merge authority. **Not** M37 flagship proof pack, **not** benchmark integrity, **not** live SC2 in CI.

**M36 note:** Evidence column — **merged** to `main` ([PR #47](https://github.com/m-cahill/starlab/pull/47); §18 / `M36_run1.md`): **`docs/starlab_archive.md`**, **§7** archival policy + **M28–M35** inline notes, **`tests/test_governance_milestones.py`** consolidation, duplicate opaque-replay test removal in **`tests/test_governance_runtime.py`**, **`docs/starlab_archive.md`** on governance doc list; coverage gate **75.4** unchanged; **green PR-head** [`24266877684`](https://github.com/m-cahill/starlab/actions/runs/24266877684) on `63fe116…`; **green merge-push `main`** [`24266906173`](https://github.com/m-cahill/starlab/actions/runs/24266906173) on `e73a53b…`; superseded PR-head: none recorded. **Not** M37 flagship proof-pack product, **not** benchmark integrity, **not** live SC2 in CI. **Not** operating manual v1.
...
- **M36 proof (narrow):** ledger readability + governance test surface rationalization — **not** M37 flagship proof-pack product, **not** benchmark integrity, **not** live SC2 in CI, **not** operating manual v1
...
- **M35 proof (narrow):** structural decoupling + module decomposition — **not** M37 flagship proof-pack product, **not** benchmark integrity, **not** live SC2 in CI, **not** operating manual v1
...
- **M34 proof (narrow):** structural hygiene + deferred-issue closure + operating-manual **promotion prep** — **not** M37 flagship proof-pack product, **not** benchmark integrity, **not** live SC2 in CI, **not** operating manual v1
...
- **M33 proof (narrow):** explicit **CI** tiering + fixture-only **`fieldtest-output`** + expanded operator / diligence surfaces — **not** M34 structural hygiene product, **not** M37 flagship proof pack, **not** live SC2 in CI, **not** benchmark integrity, **not** operating manual v1
...
- **Non-claims:** **not** M34 structural hygiene closure, **not** M37 flagship proof pack, **not** live SC2 in CI, **not** benchmark integrity.
...
- **M31 proof (narrow):** deterministic offline **`replay_explorer_surface.json`** / **`replay_explorer_surface_report.json`** — bounded panels over M13 slices, M10–M12 excerpts, M16→M18 anchor frame, **M30** hierarchical traces with **M29** validation; **not** benchmark integrity, **not** live SC2, **not** web UI, **not** M37 flagship proof pack
