...
| Current milestone | **`PX2-M00`** — Autonomous Full-Game Agent Charter & Success Criteria — **open** on `main` (**governance-first**; public runtime **`docs/runtime/px2_autonomous_full_game_agent_charter_v1.md`** — **not** full Terran runtime; **not** training implementation; **not** Blackwell execution). **PX1-M04** — **closed** ([PR #93](https://github.com/m-cahill/starlab/pull/93)) — **packaging / proof governance** only; **does not** auto-open **`PX1-M05`** or **v2**. **`PX1-M05`** remains **optional / not yet opened**. **v2** is **not** opened. **v1** (**M00–M61**), **PV1**, and the **PX1** milestone arc (**PX1-M00**–**PX1-M04**) remain **closed** / **historical** as stated. |
...
| **PX2** | (**PX2-M00** opening) Phase identity, Terran-first scope, definitions, promotion ladder, non-claims — **governance** | Full Terran runtime; replay-bootstrap policy; industrial Blackwell campaign; demo refresh — **later milestones** | **PX2-M00**–**PX2-M05** (roadmap) |
...
### PX2 roadmap (PX2-M00 **open** on `main`; PX2-M01–PX2-M05 **planned**)

| Milestone | Title | Status | Notes |
| --- | --- | --- | --- |
| `PX2-M00` | Autonomous Full-Game Agent Charter & Success Criteria | **open** on `main` | Governance-first: phase identity, Terran-first scope, full-game definitions, scaffolding rules, promotion ladder, non-claims — **no** runtime expansion; **no** training implementation; **no** Blackwell campaign |
...
**Ledger truths (PX2 phase, `current milestone` = `PX2-M00` where this PR applies):**

- **PX2** is **separate** from **PX1** — **PX1-M04** did **not** open **PX2**; **PX2** opens by explicit governance (**PX2-M00**).
- **`current milestone`** = **`PX2-M00`** — charter & success criteria — **not** proof of strength yet.
...
| PX2-M00 | Freeze separate **PX2** phase identity, Terran-first scope, claim boundaries, training/eval regime shape, and promotion ladder for autonomous full-game skill development — **open** on `main` (**governance**; **not** runtime) |
...
**Current:** **`current milestone`** = **`PX2-M00`** — Autonomous Full-Game Agent Charter & Success Criteria — **open** on `main`. Public runtime **`docs/runtime/px2_autonomous_full_game_agent_charter_v1.md`**; **Post-PX1 (PX2)** (above §8). **Governance-first** — **not** full Terran runtime; **not** replay-training implementation; **not** Blackwell industrial execution. **PX1-M04** — **closed** ([PR #93](https://github.com/m-cahill/starlab/pull/93)) — **packaging / proof governance** only — **does not** auto-open **`PX1-M05`** or **v2**. **`PX1-M05`** **optional / not yet opened**. **v2** is **not** opened. **v1** (**M00–M61**), **PV1**, and **PX1** (**PX1-M00**–**PX1-M04**) remain **closed** / **historical** as stated.

### PX2-M00 — Autonomous Full-Game Agent Charter & Success Criteria — **open** (`main`)

**Opening PR:** Records **PX2** phase opening; ledger + runtime charter + governance tests; private **`docs/company_secrets/milestones/post-v1/PX2-M00/`** (plan, working charter memo, toolcalls).
...
### 2026-04-20 — **PX1-M04** governance closeout — merged to `main` ([PR #93](https://github.com/m-cahill/starlab/pull/93)) — **closed**; **`current milestone`** → **None** (superseded by **PX2-M00** open — see entry above)
