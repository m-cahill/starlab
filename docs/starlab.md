...
| Current milestone | **`V15-M26`** — *Real Operator T1 30-Minute GPU Run Attempt After Manifest Alignment* — **proposed / not opened** on `main` (see **`docs/starlab-v1.5.md`**). **`V15-M25`** governance closeout: branch `v15-m25-operator-preflight-json-manifest-alignment` — **`m21_dry_run_preflight_passed` / `ready_for_v15_m26_t1_attempt`** operator-locally (**M15** **`fixture_ci`** preflight JSON + aligned **M21** argv; **`--dry-run-preflight-only`**); **real T1** **not** entered; **no** checkpoint. **Last closed v1.5 on `main`:** **`V15-M24`** — [PR #159](https://github.com/m-cahill/starlab/pull/159) — **`missing_private_manifest_inputs`** / **M21** **not** invoked. **Prior:** **`V15-M23`** — [PR #156](https://github.com/m-cahill/starlab/pull/156) (branch `v15-m23-cuda-pytorch-operator-env-remediation`) — CUDA **`.venv`**. **Prior:** **`V15-M22`** — [PR #154](https://github.com/m-cahill/starlab/pull/154). **Prior:** **`V15-M21`** — [PR #153](https://github.com/m-cahill/starlab/pull/153). **Prior:** **`V15-M20`** — [PR #152](https://github.com/m-cahill/starlab/pull/152). **PX2** **transition-complete**. |
