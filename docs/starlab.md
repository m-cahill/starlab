...
| ----- | ------------------------ |
| Program arc | **42 milestones (M00–M41)** — see §7. |
| Last closed milestone | **M38** — Audit Closure VII (merged to `main`; see §11). |
| Current milestone | **M39** — Public Flagship Proof Pack (**in progress** — proof-pack emitter + CI `flagship`; see §11). |
| Next flagship | **M39** — public flagship proof pack (**not** claimed as *closed milestone* until merged and closed with authoritative CI). |
...
| Still **not** proved (default) | **Benchmark integrity**, **replay↔execution equivalence**, **live SC2 in CI**, **M39 product work**, **operating manual v1** — see §11 *explicit non-claims*. |
...
| M39 | Public Flagship Proof Pack | V | In progress | v0.0.39-m39 | — |
...
**Status:** **Current (in progress)** — charter `docs/company_secrets/milestones/M39/M39_plan.md`. **Product:** `python -m starlab.flagship.emit_public_flagship_proof_pack` / `make flagship` → `out/flagship/`; runtime contract `docs/runtime/public_flagship_proof_pack_v1.md`; narrative `docs/flagship_proof_pack.md`; CI job **`flagship`** uploads **`flagship-proof-pack`**. **Not** Phase VI (**M40** / **M41**) unless explicitly chartered. **Not** **closed** until authoritative PR-head + merge-boundary `main` CI and milestone closeout.
...
Until **M39** is **merged and closed** on `main` with authoritative CI, treat the following as **not proved** as a **closed milestone** (implementation may exist on a branch or PR):

- **M39** as a **completed** flagship proof-pack milestone (**not** claimed until M39 closes with recorded CI).
