...
| Current milestone | **`V15-M39`** — *2-Hour Operator Run Attempt* — **opened / in progress** (Phase A: fixture CI + preflight + receipt surface — **no** merge-gate **7200s** run) — see **`docs/starlab-v1.5.md`** and **`docs/runtime/v15_two_hour_operator_run_attempt_v1.md`**. **`emit_v15_m39_two_hour_operator_run_attempt`** / **`run_v15_m39_two_hour_operator_run_attempt`** (operator-only). Follows **`V15-M38`** **closed** ([PR #174](https://github.com/m-cahill/starlab/pull/174)); **`V15-M37`** **closed** ([PR #173](https://github.com/m-cahill/starlab/pull/173)). **7200s** **M28** path only post-merge with **`m39_launch_ready`** + dual guards; **no** benchmark pass, strength, promotion, **T2**/**T3**, XAI, human-panel, showcase, or **v2** in M39 receipts. **`V15-M38`** — **`starlab.v15.two_hour_run_remediation_launch_rehearsal.v1`** (**`emit_v15_m38_two_hour_run_remediation_launch_rehearsal`**); **`docs/runtime/v15_two_hour_run_remediation_launch_rehearsal_v1.md`** — **closed** — launch rehearsal + retention; **does not** execute the **7200s** run. **`V15-M37`** — **`starlab.v15.two_hour_run_blocker_discovery.v1`** (**`emit_v15_m37_two_hour_run_blocker_discovery`**); **`docs/runtime/v15_two_hour_run_blocker_discovery_v1.md`**. **`V15-M36`** — **`starlab.v15.smoke_benchmark_execution.v1`** (**`emit_v15_m36_smoke_benchmark_execution`**) — **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`docs/runtime/v15_smoke_benchmark_execution_surface_v1.md`**. |
| v1.5 ID anchors (M00–M39 quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`**, **`V15-M36`**, **`V15-M37`** **closed** [PR #173](https://github.com/m-cahill/starlab/pull/173), **`V15-M38`** **closed** [PR #174](https://github.com/m-cahill/starlab/pull/174), **`V15-M39`** **opened / in progress** (Phase A surface). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M40`** — *2-Hour Run Package & Evaluation Readiness* (**success path**) or *2-Hour Run Remediation / Retry Gate* (**blocked**) — provisional after **`V15-M39`** Phase B outcome. **`V15-M39`** — **opened / in progress** — **`docs/runtime/v15_two_hour_operator_run_attempt_v1.md`**; follows **`V15-M38`** **closed** ([PR #174](https://github.com/m-cahill/starlab/pull/174); merge `9cf2944d…`; PR-head [`25138210391`](https://github.com/m-cahill/starlab/actions/runs/25138210391); merge-boundary [`25138442045`](https://github.com/m-cahill/starlab/actions/runs/25138442045)); frozen **M38** launch command/runbook when gated — see **`docs/starlab-v1.5.md`**. **`V15-M36`** **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`V15-M35`** **closed** ([PR #171](https://github.com/m-cahill/starlab/pull/171)). **`V15-M34`** **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
