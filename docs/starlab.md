...
| Next planned follow-on | **`V15-M18`** — [PR #150](https://github.com/m-cahill/starlab/pull/150) — checkpoint **readiness / refusal** (**not** strength evaluation); merge + CI at **closeout**. **Proposed (not started):** **`V15-M19`**–**`V15-M21`** per **`docs/starlab-v1.5.md`**. **`V15-M17`**: **closed** — [PR #143](https://github.com/m-cahill/starlab/pull/143) — `docs/runtime/v15_long_gpu_campaign_evidence_v1.md` — long GPU **evidence/preflight** only; **not** a default long-run **completion** claim. **`V15-M16`**: **closed** — [PR #142](https://github.com/m-cahill/starlab/pull/142) — short GPU / environment **surface**; **not** long campaign. **`V15-M15`**: **closed** ([PR #141](https://github.com/m-cahill/starlab/pull/141)); preflight only. **Default posture:** gather **operator** **evidence** / **M08** **run** before v2 / **`v1_5_hardening`**. **`V15-M13`**, **`V15-M12`** **closed** — [PR #139](https://github.com/m-cahill/starlab/pull/139), [PR #138](https://github.com/m-cahill/starlab/pull/138). **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only**. **v2** **not** opened. |
