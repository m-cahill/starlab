...
| ----- | ------------------------ |
| Program arc | **62 milestones (M00–M61)** — see §7 (**M55**–**M58** **closed** on `main`; **M59**–**M61** **stub/planned** except as closed later). |
| Last closed milestone | **M58** — Live SC2 in CI hardening & cost guardrails v1 (merged to `main`; see §11 / §18). |
| Current milestone | **M59** — Ladder/public evaluation protocol & evidence surface v1 — **stub/planned** (Phase VII — **not** live-SC2 guardrails). **M58** **closed** — bounded **M57** hardening + cost guardrails — **not** global live-SC2-in-CI proof. **Not** replay↔execution equivalence (**M52**–**M54** **closed**). |
...
Planned program arc (**62 milestones**, **M00**–**M61** — **M52**–**M58** **closed** on `main` (through benchmark-integrity **charter** (**M55**) + bounded **evidence/gates** (**M56**) + narrow live-SC2-in-CI **charter + controlled runner** (**M57**) + **M58** guardrails/hardening milestones); tag **`v0.0.58-m58`** on **M58** merge commit; **M59**–**M61** stub/planned; **M51** **closed** on `main`):
...
**Status:** current milestone pointer (**Phase VII**). **Depends on:** **M58** **closed** on `main`. **Not** satisfied by **M58** guardrail JSON or preflight alone; **not** live-SC2-in-CI proof expansion.

**Intent (stub):** bounded ladder/public evaluation protocol + evidence surface — **not** default merge-gate live SC2; **not** benchmark-integrity or replay↔execution equivalence substitute.
