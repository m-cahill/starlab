...
**Status:** **Planned** — **current** milestone; **M18** is **closed** on `main` (see §18). **Phase III** is **in progress** (M15–M18 complete in milestone table; **M19** next).

**Goal (high level):** **M19** is reserved for **cross-mode reconciliation** and **representation audit** — **not** started in M18; see `docs/company_secrets/milestones/M19/M19_plan.md` (stub).

**Primary references:** `docs/company_secrets/milestones/M19/M19_plan.md`; `docs/starlab.md` §6 / §10 (Phase III boundaries).

**Note:** **M18** proves only a **prototype** canonical-state→observation materialization path (`docs/runtime/perceptual_bridge_prototype_v1.md`) — **not** full legality, **not** benchmark claims, **not** M19-style reconciliation.

#### Current milestone — explicit non-claims (standing)

Until **M19** explicitly closes a claim, treat the following as **not proved** for **M19** planning:
