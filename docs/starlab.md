...
| Current milestone | **`V15-M25`** — *Operator Evidence Collection Preflight JSON & M21 Manifest Alignment* — **proposed / not opened** on `main` (see **`docs/starlab-v1.5.md`**). **Last closed v1.5 on `main`:** **`V15-M24`** — [PR #159](https://github.com/m-cahill/starlab/pull/159) — honest preflight block (**`missing_private_manifest_inputs`**); **`.venv`** CUDA verified in attempt; **M21** **not** invoked; **real T1** **not** entered. **Prior:** **`V15-M23`** — [PR #156](https://github.com/m-cahill/starlab/pull/156) (branch `v15-m23-cuda-pytorch-operator-env-remediation`) — CUDA **`.venv`**. **Prior:** **`V15-M22`** — [PR #154](https://github.com/m-cahill/starlab/pull/154). **Prior:** **`V15-M21`** — [PR #153](https://github.com/m-cahill/starlab/pull/153). **Prior:** **`V15-M20`** — [PR #152](https://github.com/m-cahill/starlab/pull/152). **PX2** **transition-complete**. |
