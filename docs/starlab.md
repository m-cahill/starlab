...
| Current milestone | **`V15-M32`** — *candidate checkpoint evaluation execution* (**provisional** — **`docs/starlab-v1.5.md`** **`§V15-M32`**; charter-first; consumes sealed **`§V15-M31`** harness-gate outputs when explicitly opened — **not** an automatic benchmark or strength milestone) |
| v1.5 ID anchors (M00–M32 proposed, quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**. **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | Roadmap sequencing only: bounded **`V15-M32`** evaluation **execution** remains **provisional** until chartered on **`docs/starlab-v1.5.md`** — **not** implied by merge CI; **not** a benchmark pass. Deeper milestones remain **unopened** until **`V15-M32`** exit criteria exist. |
