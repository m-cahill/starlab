...
| Current milestone | **`V15-M07`** — *Training Smoke and Short GPU Shakedown* — **not** started (awaits explicit plan approval; see **`docs/starlab-v1.5.md`**; **not** a long GPU **campaign**). **Last closed (v1.5):** **`V15-M06`** on `main` ([PR #127](https://github.com/m-cahill/starlab/pull/127); **not** human-panel **execution**; **not** “beats most humans” **claim**; protocol + `fixture_ci` + optional **operator_declared**). M07 is **next**; M06 (closed) **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; M05 (closed) **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**. M04 **`docs/runtime/v15_xai_evidence_contract_v1.md`**. M03 **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**. M02 **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**. Default **CI** remains **CPU** fixture self-play / bootstrap. **`PX2-M04`** / **`PX2-M05`** — **planned**; **v2** not opened. |
...
| Next planned follow-on | **`V15-M07`** — *Training Smoke and Short GPU Shakedown* — **not** started (see **`docs/starlab-v1.5.md`**; awaits explicit plan approval; **not** a long GPU **campaign**). **M06 (closed):** human-panel **protocol** + **fixture** only — **not** execution. **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only** on the **PX2** namespace. **v2** is **deferred** / **not** opened. |
...
| **v1.5 (V15)** | **`V15-M00`** through **`V15-M06`** **closed** on `main` ([PR #127](https://github.com/m-cahill/starlab/pull/127) for M06); **`V15-M07`** — *Training Smoke and Short GPU Shakedown* — **not** started. M06: protocol + `fixture_ci` + optional **operator_declared** — **not** human-panel **execution**; `starlab.v15.human_panel_benchmark.v1` + `v15_human_panel_benchmark.json` + report; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**. Checkpoint lineage + XAI + strong-agent + human-panel **protocol** surfaces remain **governance/contract** until execution milestones. | Full GPU run + **strong-agent** eval + XAI + **human-panel** eval — **chartered in v1.5**, not satisfied by **PX2** alone | **M07+** (GPU shakedown, then long run, then **M11** human **execution** per roadmap) |
...
**Current (v1.5):** **`V15-M07`** — *Training Smoke and Short GPU Shakedown* — **not** started (awaits explicit plan approval; see **`docs/starlab-v1.5.md`**; **not** a long GPU **campaign**). **Closed v1.5 line on `main`:** **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M03`**, **`V15-M04`**, **`V15-M05`**, **`V15-M06`**. **Authority:** **`docs/starlab-v1.5.md`**. M07 is **next**; M06 (closed): **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; M05: **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**; M04: **`docs/runtime/v15_xai_evidence_contract_v1.md`**; M03: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; M02: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**.

### V15-M07 — *Training Smoke and Short GPU Shakedown* — **not** started

**Intent (planned only):** Short operator-local or plan-approved **GPU smoke** / **shakedown** (see **`docs/starlab-v1.5.md`**). **Not** a long **campaign**; **not** human-panel or benchmark **execution**; **not** opened until plan approval.
