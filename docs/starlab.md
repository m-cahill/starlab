...
| Current milestone | **`V15-M42`** — *Candidate Checkpoint Evaluation Package from 2-Hour Run* — **opened** — **`python -m starlab.v15.emit_v15_m42_two_hour_candidate_checkpoint_evaluation_package`**; **`docs/runtime/v15_two_hour_candidate_checkpoint_evaluation_package_v1.md`** (**`--m41-package-json`** mandatory; optional **`--m39-*`** cross-checks only) — consumes **M41** evaluation-readiness bundle and **final candidate** SHA **`51cea94ed5324087863b246b7b31a21021eba286924aea4609aa09466430a943`** (**candidate-only**) without benchmark pass or promotion claims. **`V15-M41`** — *2-Hour Run Package & Evaluation Readiness* — **closed** on `main` ([PR #177](https://github.com/m-cahill/starlab/pull/177); **authoritative PR-head CI** [`25148366193`](https://github.com/m-cahill/starlab/actions/runs/25148366193); **merge-boundary `main` CI** [`25148496084`](https://github.com/m-cahill/starlab/actions/runs/25148496084) — **success**). Context: **`V15-M39`** Phase B **`two_hour_operator_run_completed_with_candidate_checkpoint`** — **Phase A** **closed** [PR #175](https://github.com/m-cahill/starlab/pull/175); **`V15-M40`** — **closed** [PR #176](https://github.com/m-cahill/starlab/pull/176). Re-attempt policy for a **new** **M39** run: **`run_v15_m39_two_hour_operator_run_attempt`** (**7200s**, dual guards) only when sealed **M38** + **`operator_preflight_ready_for_2hour_attempt`** hold **and** operator authorization applies on **that** station. |
| v1.5 ID anchors (M00–M42 quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`**, **`V15-M36`**, **`V15-M37`** **closed** [PR #173](https://github.com/m-cahill/starlab/pull/173), **`V15-M38`** **closed** [PR #174](https://github.com/m-cahill/starlab/pull/174), **`V15-M39`** **Phase A closed** [PR #175](https://github.com/m-cahill/starlab/pull/175), **`V15-M40`** **closed** on `main` [PR #176](https://github.com/m-cahill/starlab/pull/176) (merge `7f16a9a9e996716babc6a7f579e11ecb096a9a72`; PR-head [`25142710989`](https://github.com/m-cahill/starlab/actions/runs/25142710989); merge-boundary [`25142983709`](https://github.com/m-cahill/starlab/actions/runs/25142983709) — **success**), **`V15-M41`** **closed** on `main` [PR #177](https://github.com/m-cahill/starlab/pull/177) (merge `71973d7a…`; PR-head [`25148366193`](https://github.com/m-cahill/starlab/actions/runs/25148366193); merge-boundary [`25148496084`](https://github.com/m-cahill/starlab/actions/runs/25148496084) — **success**), **`V15-M42`** **opened** (*Candidate Checkpoint Evaluation Package from 2-Hour Run* — **M41 mandatory**), **`V15-M43`** **provisional / next**. **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M43`** — bounded evaluation gate for the **V15-M42** packaged two-hour candidate (**§V15-M42** **opened** — **`emit_v15_m42_two_hour_candidate_checkpoint_evaluation_package`**; **`docs/runtime/v15_two_hour_candidate_checkpoint_evaluation_package_v1.md`**). **`V15-M42`** consumes **M41** readiness bundle / **final candidate** SHA (**`51cea94ed5324087863b246b7b31a21021eba286924aea4609aa09466430a943`**) without benchmark pass or promotion claims. **`V15-M41`** — *2-Hour Run Package & Evaluation Readiness* — **closed** on `main` ([PR #177](https://github.com/m-cahill/starlab/pull/177); merge **`71973d7afb8a1dff46f659da60591de41aec01d4`**; **authoritative PR-head CI** [`25148366193`](https://github.com/m-cahill/starlab/actions/runs/25148366193); **merge-boundary `main` CI** [`25148496084`](https://github.com/m-cahill/starlab/actions/runs/25148496084) — **success**). Re-attempt policy for a **new** **M39** run: **`run_v15_m39_two_hour_operator_run_attempt`** (**7200s**, dual guards) only when sealed **M38** + **`operator_preflight_ready_for_2hour_attempt`** hold **and** operator authorization applies on **that** station. **`V15-M40`** — **closed** on `main` [PR #176](https://github.com/m-cahill/starlab/pull/176). **`V15-M39`** — **Phase A** **closed** [PR #175](https://github.com/m-cahill/starlab/pull/175); **Phase B** completion recorded with receipt **`675ae631ff2fa8a9f71f2c03a93f3abbffbfe0c45fcb49a59c933920330b010c`**. **`V15-M38`** / **`V15-M37`** / **`V15-M36`** — **closed** on **`main`** as above. |
