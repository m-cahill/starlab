...
| Current milestone | **`V15-M17`** — *Long GPU Campaign Evidence Collection* — **proposed / not started** (after **`V15-M16`** **closed** on `main` — [PR #142](https://github.com/m-cahill/starlab/pull/142); **`docs/starlab-v1.5.md`**). **Prior:** **`V15-M16`** **closed** — bounded short GPU / environment evidence **surface ready**; **`docs/runtime/v15_short_gpu_environment_evidence_v1.md`**; **`long_gpu_run_authorized` false**. **Authority:** **`docs/starlab-v1.5.md`**. **PX2** **transition-complete**; **no** long GPU program deliverable on `main`. |
