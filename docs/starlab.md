...
| Post-PX1 (PX2) | **PX2 — Autonomous Full-Game Skill Development** — **new** post-PX1 capability phase after **closed** **PX1** (**not** “Phase VIII”; **no** **M62**; **not** a stealth extension of **PX1** packaging). Public roadmap: **Post-PX1 (PX2)** (below §7). Runtime charter: **`docs/runtime/px2_autonomous_full_game_agent_charter_v1.md`**. |
...
| Current milestone | **`None`** — **no** **`PX2-MNN`** milestone **open** on `main` after **PX2-M00** governance closeout ([PR #94](https://github.com/m-cahill/starlab/pull/94)). **PX2-M00** — **closed** — public runtime **`docs/runtime/px2_autonomous_full_game_agent_charter_v1.md`**; **PX2** phase **chartered** — **not** proof of autonomous full-game strength. **PX1-M04** — **closed** ([PR #93](https://github.com/m-cahill/starlab/pull/93)) — **packaging / proof governance** only; **does not** auto-open **`PX1-M05`** or **v2**. **`PX1-M05`** remains **optional / not yet opened**. **`PX2-M01`** — **not** opened. **v2** is **not** opened. **v1** (**M00–M61**), **PV1**, and the **PX1** milestone arc (**PX1-M00**–**PX1-M04**) remain **closed** / **historical** as stated. |
...
| **PX2** | (**PX2-M00** **closed**) Phase identity, Terran-first scope, definitions, promotion ladder, non-claims — **governance charter recorded** | Full Terran runtime; replay-bootstrap policy; industrial Blackwell campaign; demo refresh — **later milestones** | **PX2-M00**–**PX2-M05** (roadmap) |
...
### PX2 roadmap (PX2-M00 **closed** on `main`; PX2-M01–PX2-M05 **planned / not yet opened**)
...
| `PX2-M01` | Full Terran Runtime & Action Surface | **planned** | Governed substrate for full Terran game surface |
| `PX2-M02` | Neural Bootstrap from Replays | **planned** | First replay-bootstrapped learned full-game policy (bounded claims) |
...
**Roadmap disclaimer:** Milestones **PX2-M01**+ are **not** opened automatically by **PX2-M00** closeout.

### Explicit non-claims (PX2 phase)

PX2 **does not** silently authorize: ladder/public strength proof; benchmark universality; multi-race coverage; **v2** opening; automatic Blackwell execution; or “charter merged” ⇒ “strong agent exists.” **PX2-M00** does **not** implement the Terran action surface, replay training, or industrial campaigns.

**Ledger truths (PX2 phase, `current milestone` = `None` after **PX2-M00** closeout):**
...
- **`PX2-M00`** **closed** on `main` — charter & success criteria **recorded** — **not** proof of strength; **`PX2-M01`** **not** opened.
- **`current milestone`** = **`None`** — **no** **`PX2-MNN`** **open** until **`PX2-M01`**+ is **separately** chartered.
...
| PX2-M01 | Build the governed full Terran runtime / action substrate |
...
**Current:** **`current milestone`** = **`None`** — **no** **`PX2-MNN`** milestone **open** on `main` after **PX2-M00** governance closeout ([PR #94](https://github.com/m-cahill/starlab/pull/94)). **PX2-M00** — Autonomous Full-Game Agent Charter & Success Criteria — **closed** on `main` — public runtime **`docs/runtime/px2_autonomous_full_game_agent_charter_v1.md`**; **Post-PX1 (PX2)** (above §8). **`PX2-M01`** — **not** opened. **Governance-first** — **not** full Terran runtime; **not** replay-training implementation; **not** Blackwell industrial execution. **PX1-M04** — **closed** ([PR #93](https://github.com/m-cahill/starlab/pull/93)) — **packaging / proof governance** only — **does not** auto-open **`PX1-M05`** or **v2**. **`PX1-M05`** **optional / not yet opened**. **v2** is **not** opened. **v1** (**M00–M61**), **PV1**, and **PX1** (**PX1-M00**–**PX1-M04**) remain **closed** / **historical** as stated.
...
**Post-closeout ledger:** **`current milestone`** → **`None`**; **`PX2-M01`** **not** opened; **`PX1-M05`** / **v2** **not** opened.
