...
| Current milestone | **`V15-M06`** — *Human Panel Benchmark Protocol* — **not** started (await **explicit** plan approval; see **`docs/starlab-v1.5.md`**). **Last closed (v1.5):** **`V15-M05`** on `main` ([PR #125](https://github.com/m-cahill/starlab/pull/125); contracts `starlab.v15.strong_agent_scorecard.v1` + `starlab.v15.strong_agent_benchmark_protocol.v1`; **not** benchmark **execution**; **not** strong-agent **claim**). **Last prior:** **`V15-M04`** ([PR #123](https://github.com/m-cahill/starlab/pull/123); `starlab.v15.xai_evidence_pack.v1`). **Authority** **`docs/starlab-v1.5.md`**. M05 (closed) **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**; M04 **`docs/runtime/v15_xai_evidence_contract_v1.md`**; M03 **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; M02 **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**; **PX2** did **not** perform a **long wall-clock GPU training session** as a program deliverable. Default **CI** remains **CPU** fixture self-play / bootstrap paths. **`PX2-M04`** / **`PX2-M05`** — **planned**; **`PX1-M05`** optional; **v2** not opened. |
...
| Next planned follow-on | **`V15-M06`** — *Human Panel Benchmark Protocol* — **not** started (see **`docs/starlab-v1.5.md`**; await **explicit** plan approval; **not** live human-panel **execution** from **fixture** CI). M05 (closed) strong-agent **protocol** surface: **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**. **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only** on the **PX2** namespace. **`PX1-M05`** optional. **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **deferred** / **not** opened. |
...
| **v1.5 (V15)** | **`V15-M00`** through **`V15-M05`** **closed** on `main` (PR #116–#120, [PR #123](https://github.com/m-cahill/starlab/pull/123), [PR #125](https://github.com/m-cahill/starlab/pull/125)). M05 (strong-agent **protocol** + scorecard **contract**) **closed** — **not** executed benchmark, **not** strong-agent **claim**; **`V15-M06`** **not** started. Checkpoint lineage **manifest** is **metadata** — **not** training **execution**, **not** byte verification by default. XAI pack contract **`starlab.v15.xai_evidence_pack.v1`** is **closed** (fixture + schema; **not** real XAI inference or faithfulness proof). Registers + **fixture**-safe M01–M05 contracts; **not** long GPU **training**; **not** claim-critical asset approval. | Full GPU training session + **strong-agent** benchmark + replay-native **XAI demo** + (full program) data/**weight** provenance + **human-panel** or bounded “beats most humans” eval — **chartered in v1.5**, not satisfied by **PX2** alone | **V15-M06+** (human panel **protocol**; **M06** not started) |
...
**Current (v1.5):** **`V15-M06`** — *Human Panel Benchmark Protocol* — **not** started (see **`docs/starlab-v1.5.md`**; await **explicit** plan approval). **Closed v1.5 line on `main`:** **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M03`**, **`V15-M04`**, **`V15-M05`**. **Authority:** **`docs/starlab-v1.5.md`**. M05: **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**; M04: **`docs/runtime/v15_xai_evidence_contract_v1.md`**; M03: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; M02: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**.

### V15-M06 — *Human Panel Benchmark Protocol* — **not** started

**Intent (pending approval):** Future milestone — **not** started; **not** a human-panel **execution** claim. Public authority: **`docs/starlab-v1.5.md`**.
