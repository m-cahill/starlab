...
| Current milestone | **`V15-M09`** — *Checkpoint Evaluation and Promotion* — **not started** (awaits explicit plan approval). **Prior (v1.5):** **`V15-M08`** — implementation surface **closed** on `main` ([PR #133](https://github.com/m-cahill/starlab/pull/133)); **`implementation_ready_waiting_for_operator_run`**; **`long_gpu_run_authorized` false** in **fixture** / public path; **no** operator-local long campaign completed. **M08 artifacts:** `emit_v15_long_gpu_training_manifest`, `run_v15_long_gpu_campaign`, **`docs/runtime/v15_long_gpu_campaign_execution_v1.md`**. **Prior closed:** **`V15-M07`** ([PR #129](https://github.com/m-cahill/starlab/pull/129)) — **`docs/runtime/v15_training_smoke_short_gpu_shakedown_v1.md`**; **`V15-M00`**–**`V15-M06`** — see **`docs/starlab-v1.5.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**. Default **CI** remains **CPU** fixture self-play / bootstrap. **`PX2-M04`** / **`PX2-M05`** — **planned**; **v2** not opened. |
...
| Next planned follow-on | **`V15-M09`** — *Checkpoint Evaluation and Promotion* — **not started**. **V15-M08** operator-local long-run **execution** (when explicitly authorized) and honest campaign closeout remain **outstanding** — see **`docs/starlab-v1.5.md`**. **M07 (closed on `main`):** training-run receipt + optional operator shakedown **tooling** — **not** the long campaign; public record: **`operator_local_short_gpu_not_run`** for this program snapshot. **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only**. **v2** **deferred**. |
...
| **v1.5 (V15)** | **`V15-M00`** through **`V15-M08`** **closed** on `main` (M08 implementation: [PR #133](https://github.com/m-cahill/starlab/pull/133); M07: [PR #129](https://github.com/m-cahill/starlab/pull/129); M06: [PR #127](https://github.com/m-cahill/starlab/pull/127)); **`V15-M08`** — **`implementation_ready_waiting_for_operator_run`** (no completed long campaign on `main`). **`V15-M09`** — **not started**. M07: training-run **receipt** + shakedown **tooling** — **not** long campaign. M06: protocol + `fixture_ci` + optional **operator_declared** — **not** human-panel **execution**; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**. | Full GPU run + **strong-agent** eval + XAI + **human-panel** eval — **chartered in v1.5**, not satisfied by **PX2** alone | **M09+** (eval / promotion), then human / XAI per roadmap |
...
**Current (v1.5):** **`V15-M09`** — *Checkpoint Evaluation and Promotion* — **not started** (awaits explicit plan approval). **Prior:** **`V15-M08`** — *Long GPU Campaign Execution* — **implementation PR closed** on `main` ([PR #133](https://github.com/m-cahill/starlab/pull/133); merge `33b27738…`; **authoritative PR-head CI** [`24940027890`](https://github.com/m-cahill/starlab/actions/runs/24940027890); **merge-boundary `main` CI** [`24940102671`](https://github.com/m-cahill/starlab/actions/runs/24940102671)); **public closeout** **`implementation_ready_waiting_for_operator_run`**; **no** operator-local long campaign **completed**; **`long_gpu_run_authorized` false** on fixture/public path. **Closed v1.5 line on `main`:** **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M03`**, **`V15-M04`**, **`V15-M05`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**. **Authority:** **`docs/starlab-v1.5.md`**. M08 runtime: **`docs/runtime/v15_long_gpu_campaign_execution_v1.md`**. M07 (closed) runtime: **`docs/runtime/v15_training_smoke_short_gpu_shakedown_v1.md`**, implementation [PR #129](https://github.com/m-cahill/starlab/pull/129) — **authoritative PR-head CI** [`24925848388`](https://github.com/m-cahill/starlab/actions/runs/24925848388); **merge-boundary `main` CI** [`24925929052`](https://github.com/m-cahill/starlab/actions/runs/24925929052) — **success**; **operator-local shakedown** status: **tooling-only** / **`operator_local_short_gpu_not_run`** (closeout host). M06 (closed): **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; M05: **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**; M04: **`docs/runtime/v15_xai_evidence_contract_v1.md`**; M03: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; M02: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**; M01: **`docs/runtime/v15_training_scale_provenance_asset_registers_v1.md`**.
...
### V15-M09 — *Checkpoint Evaluation and Promotion* — **not started**

**V15-M09** is **not opened** in-repo; **no** checkpoint promotion work has started publicly. Awaits explicit plan approval per **`docs/starlab-v1.5.md`**.
