...
| Last closed milestone (v1.5) | **`V15-M37`** — *2-Hour Run Blocker Discovery & Operator Readiness Audit* — **closed** on `main` ([PR #173](https://github.com/m-cahill/starlab/pull/173); merge `291aa417a95e5fe7e1047b3406bfbf8296972a4a`; **authoritative PR-head CI** [`25136254104`](https://github.com/m-cahill/starlab/actions/runs/25136254104) on head `03e8def63967361de26e06d85b48e38bc1673a1c`; superseded PR-head [`25135628928`](https://github.com/m-cahill/starlab/actions/runs/25135628928), [`25135999735`](https://github.com/m-cahill/starlab/actions/runs/25135999735) — **not** merge authority; **merge-boundary `main` CI** [`25136423879`](https://github.com/m-cahill/starlab/actions/runs/25136423879) — **success**); **`starlab.v15.two_hour_run_blocker_discovery.v1`** / **`emit_v15_m37_two_hour_run_blocker_discovery`**; merge CI **`--fixture-ci`** — **`fixture_schema_only_no_operator_audit`**. **Strongest allowed claim:** governed **blocker-discovery/readiness-audit** surface for a future **V15-M39** **7200s** attempt — **not** executing that run. **`docs/starlab-v1.5.md`** **§V15-M37**. **Prior:** **`V15-M36`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`V15-M35`** ([PR #171](https://github.com/m-cahill/starlab/pull/171)); **`V15-M34`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)). |
...
| Current milestone | **`V15-M38`** — *2-Hour Run Remediation & Launch Rehearsal* — **provisional** — see **`docs/starlab-v1.5.md`** (**`V15-M37`** **closed** [PR #173](https://github.com/m-cahill/starlab/pull/173)). **`starlab.v15.two_hour_run_remediation_launch_rehearsal.v1`** (**`emit_v15_m38_two_hour_run_remediation_launch_rehearsal`**); **`docs/runtime/v15_two_hour_run_remediation_launch_rehearsal_v1.md`** — launch rehearsal + frozen **M39** command; **does not** execute the **7200s** run. **`V15-M37`** — **`starlab.v15.two_hour_run_blocker_discovery.v1`** (**`emit_v15_m37_two_hour_run_blocker_discovery`**); **`docs/runtime/v15_two_hour_run_blocker_discovery_v1.md`** — inventories blockers/readiness gaps for a planned **V15-M39** **7200s** attempt (**M37** does **not** execute that run); **no** benchmark-pass claim by default; **no** T2/T3. **`V15-M36`** — **`starlab.v15.smoke_benchmark_execution.v1`** (**`emit_v15_m36_smoke_benchmark_execution`**) — **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`docs/runtime/v15_smoke_benchmark_execution_surface_v1.md`**. |
| v1.5 ID anchors (M00–M37 quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`**, **`V15-M36`**, (**`V15-M37`** **closed** [PR #173](https://github.com/m-cahill/starlab/pull/173); **`V15-M38`** provisional next). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M38`** — *2-Hour Run Remediation & Launch Rehearsal* — **provisional** — remediates material **M37** blockers / launch rehearsal posture for **M39** (**`V15-M37`** **closed** [PR #173](https://github.com/m-cahill/starlab/pull/173)); **no** full 7200s execution claim by default; **no** strength claim; **no** checkpoint promotion; **no** showcase / XAI / human-panel / **v2** — see **`docs/starlab-v1.5.md`**. **`V15-M36`** **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`V15-M35`** **closed** ([PR #171](https://github.com/m-cahill/starlab/pull/171)). **`V15-M34`** **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
