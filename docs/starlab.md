...
| Current milestone | **`V15-M00`** — v1.5 **Training Readiness Charter and Long GPU Run Gate** — **authoritative v1.5 governance:** **`docs/starlab-v1.5.md`** (**not** **v2**). **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**; **PX2** did **not** perform a **long wall-clock GPU training session** as a program deliverable. Default **CI** remains **CPU** fixture self-play / bootstrap paths. **`PX2-M03`** history: **`docs/runtime/px2_industrial_self_play_campaign_v1.md`** (slices + **§8q**); **readiness** `docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`. **`PX2-M04`** / **`PX2-M05`** — **planned**; **`PX1-M05`** optional; **v2** not opened. |
...
| Next planned follow-on | **v1.5** continues on **`docs/starlab-v1.5.md`** (milestone table). **`V15-M00`** does **not** claim a completed long GPU run. **`PX2-M04`** / **`PX2-M05`** — **planned only** on the **PX2** namespace — **not** auto-opened by **PX2** transition closeout. **`PX1-M05`** optional. **`docs/starlab-vision.md`** **v2** directions remain **outside** the closed **M00–M61** arc until **explicit** recharter — **v2** is **deferred** / **not** opened. |
...
| **v1.5 (V15)** | **`V15-M00`**: charter + long GPU run **gate** + public **`docs/starlab-v1.5.md`** — **not** long run completed in **V15-M00** | Full GPU training session + **strong-agent** benchmark + replay-native **XAI** + checkpoint/data/**weight** provenance + **human-panel** or bounded “beats most humans” eval — **chartered in v1.5**, not in **PX2** | **V15-M00**+ |
...
**Current:** **`V15-M00`** — v1.5 **Training Readiness Charter and Long GPU Run Gate** — **authoritative public detail:** **`docs/starlab-v1.5.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**; **PX2** did **not** run a **long wall-clock GPU** training **campaign** as a program deliverable. **PX2-M03** readiness (historical): **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`**; runtime **`docs/runtime/px2_industrial_self_play_campaign_v1.md`** (slices + §8q). **Last closed PX2 milestone:** **`PX2-M03`** — prior **`PX2-M02`** ([PR #96](https://github.com/m-cahill/starlab/pull/96)). **`PX2-M04`** / **`PX2-M05`** — **planned only**. **`PX1-M05`** **optional**; **v2** **not** opened.

### V15-M00 — v1.5 Training Readiness Charter and Long GPU Run Gate

**Intent:** Establish **v1.5** public governance (`docs/starlab-v1.5.md`), training readiness charter JSON (`python -m starlab.v15.emit_v15_training_readiness_charter`), and runtime narrative (`docs/runtime/v15_training_readiness_charter_v1.md`) — **not** long GPU execution, **not** strength proof.

**Non-claims:** **Not** a claim that long training **ran**; **not** **PX2-M04**; **not** strength / human-benchmark / XAI completion.
