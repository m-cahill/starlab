...
| Last closed milestone (v1.5) | **`V15-M32`** — *Bounded Candidate Checkpoint Evaluation Execution* — **closed** on `main` ([PR #168](https://github.com/m-cahill/starlab/pull/168); merge `c853205c3f24a6196d582fa5f7f496c29e8c1942`; PR-head [`25095213484`](https://github.com/m-cahill/starlab/actions/runs/25095213484); merge-boundary [`25095686610`](https://github.com/m-cahill/starlab/actions/runs/25095686610) — **success**) — **`starlab.v15.candidate_checkpoint_evaluation_execution.v1`** + profile **`starlab.v15.m32.bounded_candidate_evaluation_execution.v1`** — fixture / metadata-only bounded execution over sealed **`§V15-M31`** — **`evaluation_execution_performed` ≠ `benchmark_passed`**. **`docs/starlab-v1.5.md`** **§V15-M32**; **`docs/runtime/v15_candidate_checkpoint_evaluation_execution_v1.md`**. **Prior:** **`V15-M31`** harness gate (**§V15-M31**); **`V15-M30`** sealed package (**§V15-M30**). |
...
| Current milestone | **`V15-M33`** — *Candidate Checkpoint Model-Load and CUDA Inference Probe* — **opened** (**`docs/starlab-v1.5.md`** **`§V15-M33`**) — **`starlab.v15.candidate_checkpoint_model_load_cuda_probe.v1`**; **`python -m starlab.v15.emit_v15_m33_candidate_checkpoint_model_load_cuda_probe`**; **`docs/runtime/v15_candidate_checkpoint_model_load_cuda_probe_v1.md`** — SHA-before-load + minimal inference (**not** benchmark, strength, promotion, **72-hour** campaign, XAI, human-panel, showcase, **v2**, or **T2/T3**) |
...
| Next planned follow-on | Roadmap: **`V15-M34`** — short sustained candidate evaluation / rehearsal gate or loader remediation — see **`docs/starlab-v1.5.md`**. **`V15-M33`** — model-load / CUDA probe (**not** a benchmark pass). |
