...
| Current milestone | **Next: `V15-M01`** — *Training-Scale Provenance and Asset Registers* — **not** started; awaits **explicit** plan approval. **Last closed (v1.5):** **`V15-M00`** on `main` ([PR #116](https://github.com/m-cahill/starlab/pull/116)) — see **`docs/starlab-v1.5.md`**. **PX2** (through **`PX2-M03`**) is **closed** / **transition-complete**; **PX2** did **not** perform a **long wall-clock GPU training session** as a program deliverable. Default **CI** remains **CPU** fixture self-play / bootstrap paths. **`PX2-M04`** / **`PX2-M05`** — **planned**; **`PX1-M05`** optional; **v2** not opened. |
...
**Next (not started):** **`V15-M01`** — *Training-Scale Provenance and Asset Registers* — awaits **explicit** plan approval before work begins.
