...
| Current milestone | **`V15-M40`** — *2-Hour Run Remediation / Retry Gate* — **opened** on branch **`v15-m40-two-hour-run-remediation-retry-gate`** ([PR #176](https://github.com/m-cahill/starlab/pull/176) — **pre-merge** on `main`); **not** Phase VI **M40** training charter — **different namespace**. **Operator-local (2026-04-29):** **`environment_ok_existing_venv`**; **`emit_v15_m37`** **`operator_audit`** from real **M27/M28/M29/M34/M35** JSON; **`emit_v15_m38`** **`operator_preflight`** → **`m39_launch_ready` true**; **`emit_v15_m39`** **`operator_preflight`** → **`operator_preflight_ready_for_2hour_attempt`** — posture **`m39_operator_preflight_ready_awaiting_7200s_launch_authorization`** (**7200s** subprocess **not** run in **V15-M40**). See **`docs/starlab-v1.5.md`** **§V15-M40** and **`docs/runtime/v15_two_hour_operator_run_attempt_v1.md`**. **`V15-M39`** — **Phase A** **closed** [PR #175](https://github.com/m-cahill/starlab/pull/175); **Phase B** first attempt **`operator_preflight_blocked_missing_m38_rehearsal`**. **No** benchmark pass, strength, promotion, **T2**/**T3**, XAI, human-panel, showcase, or **v2** claims. |
| v1.5 ID anchors (M00–M40 quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`**, **`V15-M36`**, **`V15-M37`** **closed** [PR #173](https://github.com/m-cahill/starlab/pull/173), **`V15-M38`** **closed** [PR #174](https://github.com/m-cahill/starlab/pull/174), **`V15-M39`** **Phase A closed** [PR #175](https://github.com/m-cahill/starlab/pull/175), **`V15-M40`** **opened** branch **`v15-m40-two-hour-run-remediation-retry-gate`** ([PR #176](https://github.com/m-cahill/starlab/pull/176); **pre-merge**). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | After **V15-M40** governance **PR** merges: **V15-M39** Phase B **`run_v15_m39_two_hour_operator_run_attempt`** (**7200s**) **only** under explicit dual-guard operator authorization when sealed **M38** + **`operator_preflight_ready_for_2hour_attempt`** hold on that station — then *2-Hour Run Package & Evaluation Readiness* or honest partial/failed receipts per runtime vocabulary. **`V15-M40`** — **`m39_operator_preflight_ready_awaiting_7200s_launch_authorization`** (operator-local chain restored **2026-04-29**; artifacts **local `out/`** only). **`V15-M39`** — **Phase A** **closed** [PR #175](https://github.com/m-cahill/starlab/pull/175). **`V15-M38`** / **`V15-M37`** / **`V15-M36`** — **closed** on **`main`** as above. |
