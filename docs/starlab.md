...
| Next planned follow-on | **`V15-M39`** — *2-Hour Operator Run Attempt* — **provisional** — **not** opened on `main`; follows **`V15-M38`** **closed** ([PR #174](https://github.com/m-cahill/starlab/pull/174); merge `9cf2944d…`; PR-head [`25138210391`](https://github.com/m-cahill/starlab/actions/runs/25138210391); merge-boundary [`25138442045`](https://github.com/m-cahill/starlab/actions/runs/25138442045)); use frozen **M38** launch command/runbook when gated — see **`docs/starlab-v1.5.md`**. **`V15-M36`** **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`V15-M35`** **closed** ([PR #171](https://github.com/m-cahill/starlab/pull/171)). **`V15-M34`** **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
