...
| Current milestone | **M40** — SC2 Substrate Review & Expansion Decision (**stub**; Phase VI; see §11). |
| Next flagship | **M40** — Phase VI substrate review (**not** claimed until closed on `main` with authoritative CI). |
...
| Still **not** proved (default) | **Benchmark integrity**, **replay↔execution equivalence**, **live SC2 in CI**, **M40** / **M41** Phase VI product work, **operating manual v1** — see §11 *explicit non-claims*. |
...
| M40 | SC2 Substrate Review & Expansion Decision | VI | In progress | v0.0.40-m40 | — |
...
### M40 — SC2 Substrate Review & Expansion Decision

**Status:** **Current (stub)** — charter `docs/company_secrets/milestones/M40/M40_plan.md` (stub). **M39** is **closed** on `main` (see **M39 — closed** below). **Not** **M41** platform charter unless **M40** completes; **not** benchmark integrity, **not** live SC2 in CI, **not** agent training tracks by default.
...
- **M40** / **M41** Phase VI **product** milestones (**not** claimed until each closes with recorded CI).
