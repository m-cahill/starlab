...
| M32 | Audit Closure I — Coverage, Clone-to-Run Baseline, and Operating Manual Scaffold | V | In progress | v0.0.32-m32 | — |
| M33 | Audit Closure II — CI Tiering, Architecture Surface, and Field-Test Readiness | V | Planned | v0.0.33-m33 | — |
...
| **M32** | **Audit closure I** — measurable test coverage + JUnit in CI; clone-to-run / smoke / field-test documentation; `Makefile` developer surface; draft `docs/starlab_operating_manual_v0.md`; public `docs/audit/DeferredIssuesRegistry.md` (**in progress**). |
| **M33** | **Audit closure II** — CI tiering / parallel jobs; deeper field-test posture; optional coverage-gate hardening if deferred from M32 (planned). |
...
**Status:** **Current** milestone — **M32** (corrective / operational hardening — see `docs/company_secrets/milestones/M32/M32_plan.md`). **M31** is **closed** on `main` ([PR #37](https://github.com/m-cahill/starlab/pull/37); merge commit `41d62056e1956627b63152221932dc9c2423429c`; **authoritative PR-head CI** [`24225153475`](https://github.com/m-cahill/starlab/actions/runs/24225153475); **merge-boundary `main` CI** [`24226308356`](https://github.com/m-cahill/starlab/actions/runs/24226308356); see §18 / `M31_run1.md`); plan `docs/company_secrets/milestones/M31/M31_plan.md` (**Complete**); closeout `M31_run1.md`, `M31_summary.md`, `M31_audit.md`.

**M32 objective:** Raise the audit floor with **measured coverage** and **JUnit** artifacts in CI, a truthful **clone-to-run** and **fixture-backed smoke / field-test** path (`make smoke`, `make fieldtest` using the **M31** explorer CLI on checked-in fixtures), **`docs/architecture.md`**, **`docs/getting_started_clone_to_run.md`**, **`docs/starlab_operating_manual_v0.md`** (draft, subordinate to this ledger), and **`docs/audit/DeferredIssuesRegistry.md`**. The **planned program arc** is rechartered to **38 milestones (M00–M37)** (see §7 milestone table); **flagship proof pack** is **M35**; **second-environment / multi-environment charter (OD-007)** targets **M37**.
...
Until **M32** explicitly closes its chartered scope on `main`, treat the following as **not proved**:

- **Public flagship proof pack** (**M35** charter — **not** M32 scope).
- **M33 / M34** audit-closure completion (separate milestones).
...
- **Buyer-ready production operations** beyond documented clone-to-run / fixture smoke posture.
