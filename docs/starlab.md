...
**Status:** **Current** milestone — **M29** (**stub-only** for product code — see `docs/company_secrets/milestones/M29/M29_plan.md`). **M28** is **closed** on `main` ([PR #34](https://github.com/m-cahill/starlab/pull/34); merge commit `1ef636524269ff77ac26ac37584d43b50e9fcbc6`; authoritative PR-head CI [`24220323130`](https://github.com/m-cahill/starlab/actions/runs/24220323130); merge-boundary `main` CI [`24220357580`](https://github.com/m-cahill/starlab/actions/runs/24220357580); see §18 / `M28_run1.md`).
