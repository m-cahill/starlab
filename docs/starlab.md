...
| Current milestone | **`V15-M37`** — *Bounded Operator Smoke Benchmark Attempt* — **provisional** — see **`docs/starlab-v1.5.md`**. **`V15-M36`** — **`starlab.v15.smoke_benchmark_execution.v1`** (**`emit_v15_m36_smoke_benchmark_execution`**) — **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`docs/runtime/v15_smoke_benchmark_execution_surface_v1.md`**. **M37** is **not** chartered as a full benchmark pass — **bounded operator-local smoke attempt** using the **M36** surface; **no** 2-hour run; **no** T2/T3 |
| v1.5 ID anchors (M00–M37 quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`**, **`V15-M36`**, (**`V15-M37`** **provisional next**). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M37`** — *Bounded Operator Smoke Benchmark Attempt* — **provisional** — sealed execution receipt / refusal; **no** strength claim; **no** checkpoint promotion; **no** showcase / XAI / human-panel / **v2** — see **`docs/starlab-v1.5.md`**. **`V15-M36`** **closed** on **`main`** ([PR #172](https://github.com/m-cahill/starlab/pull/172)); **`V15-M35`** **closed** ([PR #171](https://github.com/m-cahill/starlab/pull/171)). **`V15-M34`** **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
