...
| Current milestone | **`V15-M41`** — *2-Hour Run Package & Evaluation Readiness* — **opened / in progress** — **packages** the sealed **M39** Phase B completion evidence for future evaluation routing (**not** benchmark execution or checkpoint promotion); **`starlab.v15.two_hour_run_package_evaluation_readiness.v1`** / **`emit_v15_m41_two_hour_run_package_evaluation_readiness`** / **`docs/runtime/v15_two_hour_run_package_evaluation_readiness_v1.md`**; **M39** receipt **SHA-256** **`675ae631ff2fa8a9f71f2c03a93f3abbffbfe0c45fcb49a59c933920330b010c`**; **final candidate** **`51cea94ed5324087863b246b7b31a21021eba286924aea4609aa09466430a943`** (**candidate-only**). Context: **`V15-M39`** Phase B **`two_hour_operator_run_completed_with_candidate_checkpoint`** — **Phase A** **closed** [PR #175](https://github.com/m-cahill/starlab/pull/175); **Phase B** authorized **`7200s`** operator run **completed** per **`docs/starlab-v1.5.md`** / **`docs/runtime/v15_two_hour_operator_run_attempt_v1.md`** (**not** promoted; **not** benchmark/**T2**/**T3**). **`V15-M40`** — *2-Hour Run Remediation / Retry Gate* — **closed** on `main` ([PR #176](https://github.com/m-cahill/starlab/pull/176); merge `7f16a9a9e996716babc6a7f579e11ecb096a9a72` **2026-04-30T01:42:01Z** UTC; **authoritative PR-head CI** [`25142710989`](https://github.com/m-cahill/starlab/actions/runs/25142710989) on head `c878fa3cbeb542f4202e85aa98cadf7a291d141c`; **superseded PR-head CI** [`25142675947`](https://github.com/m-cahill/starlab/actions/runs/25142675947) — **cancelled** — **not** merge authority; **merge-boundary `main` CI** [`25142983709`](https://github.com/m-cahill/starlab/actions/runs/25142983709) — **success**); **not** Phase VI **M40**. Historic **M40** posture **`m39_operator_preflight_ready_awaiting_7200s_launch_authorization`** applied **before** the authorized Phase B launch. |
| v1.5 ID anchors (M00–M41 quick-scan governance) | Navigation-only compact IDs for governance tests: **`V15-M00`**, **`V15-M01`**, **`V15-M02`**, **`V15-M06`**, **`V15-M07`**, **`V15-M08`**, **`V15-M09`**, **`V15-M10`**, **`V15-M11`**, **`V15-M12`**, **`V15-M13`**, **`V15-M14`**, **`V15-M15`**, **`V15-M16`**, **`V15-M17`**, **`V15-M18`**, **`V15-M19`**, **`V15-M20`**, **`V15-M21`**, **`V15-M22`**, **`V15-M23`**, **`V15-M24`**, **`V15-M25`**, **`V15-M26`**, **`V15-M27`**, **`V15-M28`**, **`V15-M29`**, **`V15-M30`**, **`V15-M31`**, **`V15-M32`**, **`V15-M33`**, **`V15-M34`**, **`V15-M35`**, **`V15-M36`**, **`V15-M37`** **closed** [PR #173](https://github.com/m-cahill/starlab/pull/173), **`V15-M38`** **closed** [PR #174](https://github.com/m-cahill/starlab/pull/174), **`V15-M39`** **Phase A closed** [PR #175](https://github.com/m-cahill/starlab/pull/175), **`V15-M40`** **closed** on `main` [PR #176](https://github.com/m-cahill/starlab/pull/176) (merge `7f16a9a9e996716babc6a7f579e11ecb096a9a72`; PR-head [`25142710989`](https://github.com/m-cahill/starlab/actions/runs/25142710989); merge-boundary [`25142983709`](https://github.com/m-cahill/starlab/actions/runs/25142983709) — **success**), **`V15-M41`** **opened / in progress** (two-hour run **package** / evaluation-readiness emitter). **Authoritative** narrative, CI links, and non-claims: **`docs/starlab-v1.5.md`**. |
...
| Next planned follow-on | **`V15-M42`** — *Candidate Checkpoint Evaluation Package from 2-Hour Run* — consumes **M41** readiness bundle / **final candidate** SHA (**`51cea94ed5324087863b246b7b31a21021eba286924aea4609aa09466430a943`**) without benchmark pass or promotion claims. Re-attempt policy for a **new** **M39** run: **`run_v15_m39_two_hour_operator_run_attempt`** (**7200s**, dual guards) only when sealed **M38** + **`operator_preflight_ready_for_2hour_attempt`** hold **and** operator authorization applies on **that** station. **`V15-M41`** — *2-Hour Run Package & Evaluation Readiness* — **opened / in progress** on `main` implementation path. **`V15-M40`** — **closed** on `main` [PR #176](https://github.com/m-cahill/starlab/pull/176). **`V15-M39`** — **Phase A** **closed** [PR #175](https://github.com/m-cahill/starlab/pull/175); **Phase B** completion recorded with receipt **`675ae631ff2fa8a9f71f2c03a93f3abbffbfe0c45fcb49a59c933920330b010c`**. **`V15-M38`** / **`V15-M37`** / **`V15-M36`** — **closed** on **`main`** as above. |
