...
**PX2-M03 opening discipline:** **`PX2-M03`** opens only after a **positive** readiness/preflight decision recorded in **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`** — **not** automatically when **`PX2-M02`** closes. That readiness decision **permits** the milestone; the **first** committed implementation slice is **governed campaign wiring + fixture smoke** — **`docs/runtime/px2_industrial_self_play_campaign_v1.md`** — **not** the operator-local industrial self-play run (still **within** **`PX2-M03`**, later).
...
| **Later `PX2-M03` execution** | Operator-local industrial self-play (Blackwell-class **intent**), checkpoints/evals/promotion as implemented — **not** claimed by slice 1 |
...
| `PX2-M03` | Industrial Self-Play Campaign | **open** on `main` | Preflight **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`**; campaign **v1** runtime **`docs/runtime/px2_industrial_self_play_campaign_v1.md`** (slice 1: contract, bridge, fixture smoke). Operator-local industrial run — **later** in milestone — **not** **PX2-M04**; **not** demo refresh |
...
- **`PX2-M03`** **open** on `main` — industrial self-play **campaign** milestone (operator-local / Blackwell-class intent) — **readiness** **`docs/runtime/px2_industrial_self_play_campaign_readiness_v1.md`** — **not** merge-gate campaign execution; **not** **PX2-M04** promotion/exploit closure.
...
**Non-claims:** **not** self-play **evidence** in-repo; **not** Blackwell run **completed** by opening; **not** strength proof; slice 1 **not** substitute for industrial **`PX2-M03`** execution phase.
