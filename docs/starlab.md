...
| Current milestone | **`V15-M10`** — *Replay-Native XAI Demonstration* — **opened** (implementation) — `emit_v15_replay_native_xai_demonstration`; default fixture **contract + report** validation only. **Prior (v1.5):** **`V15-M09`** — *Checkpoint Evaluation and Promotion* — **closed** on `main` ([PR #135](https://github.com/m-cahill/starlab/pull/135)); **`blocked_missing_m08_campaign_receipt`**; **no** checkpoint promoted; `emit_v15_checkpoint_evaluation`, `emit_v15_checkpoint_promotion_decision`, **`docs/runtime/v15_checkpoint_evaluation_promotion_v1.md`**; **no** strong-agent, human, or XAI claims by default. **Prior:** **`V15-M08`** — **closed** on `main` ([PR #133](https://github.com/m-cahill/starlab/pull/133)); **`implementation_ready_waiting_for_operator_run`**; **`long_gpu_run_authorized` false** in fixture. **M08 artifacts:** `emit_v15_long_gpu_training_manifest`, `run_v15_long_gpu_campaign`, **`docs/runtime/v15_long_gpu_campaign_execution_v1.md`**. **Prior closed:** **`V15-M07`** — **`docs/runtime/v15_training_smoke_short_gpu_shakedown_v1.md`**; **M00–M06** — **`docs/starlab-v1.5.md`**. **PX2** (through **M03**) **closed** / **transition-complete**. **`PX2-M04`/`PX2-M05`** — **planned**; **v2** not opened. |
...
| Next planned follow-on | **`V15-M11`** (human panel / benchmark) after **M10** surface merge; **M10** — **`docs/runtime/v15_replay_native_xai_demonstration_v1.md`**. **V15-M09** **closed** on `main` — [PR #135](https://github.com/m-cahill/starlab/pull/135). **V15-M08** long-run **execution** (operator-authorized) remains **separate** from M09’s evaluation **surface** — see **`docs/starlab-v1.5.md`**. **v1.5** authority: **`docs/starlab-v1.5.md`**. **`PX2-M04`** / **`PX2-M05`** — **planned only**. **v2** **deferred**. |
...
| **v1.5 (V15)** | **`V15-M00`** through **`V15-M09`** **closed** on `main` (M09: [PR #135](https://github.com/m-cahill/starlab/pull/135); M08: [PR #133](https://github.com/m-cahill/starlab/pull/133); M07: [PR #129](https://github.com/m-cahill/starlab/pull/129); M06: [PR #127](https://github.com/m-cahill/starlab/pull/127)); **`V15-M08`** — **`implementation_ready_waiting_for_operator_run`**. **`V15-M09`** — checkpoint evaluation / promotion **governance surface closed** (see **`docs/runtime/v15_checkpoint_evaluation_promotion_v1.md`**; **default** **`blocked_missing_m08_campaign_receipt`**). M07: training-run **receipt** + shakedown **tooling** — **not** long campaign. M06: protocol + `fixture_ci` + optional **operator_declared** — **not** human-panel **execution**; see **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**. | Full GPU run + **strong-agent** eval + XAI + **human-panel** eval — **chartered in v1.5**, not satisfied by **PX2** alone | **M10+** (XAI / human) per roadmap; **M10** **not started** until separately approved |
...
**Current (v1.5):** **`V15-M10`** — *Replay-Native XAI Demonstration* — **opened** (governance surface: `starlab.v15.replay_native_xai_demonstration.v1`; `docs/runtime/v15_replay_native_xai_demonstration_v1.md`; default `fixture_contract_only` / `blocked_missing_promoted_checkpoint`). **Prior:** **`V15-M09`** — *Checkpoint Evaluation and Promotion* — **closed** on `main` (implementation [PR #135](https://github.com/m-cahill/starlab/pull/135); merge `eaa928d2…` **2026-04-25T23:12:19Z** UTC; **authoritative PR-head CI** [`24942859847`](https://github.com/m-cahill/starlab/actions/runs/24942859847); **merge-boundary `main` CI** [`24942925570`](https://github.com/m-cahill/starlab/actions/runs/24942925570) on merge commit `eaa928d2…`); **closeout** **`blocked_missing_m08_campaign_receipt`** — **no** checkpoint **promoted**; **no** public register rows; `emit_v15_checkpoint_evaluation`, `emit_v15_checkpoint_promotion_decision`; **runtime** **`docs/runtime/v15_checkpoint_evaluation_promotion_v1.md`**; **not** a strong-agent, human, or XAI performance claim. **Prior:** **`V15-M08`** — *Long GPU Campaign Execution* — **implementation closed** on `main` ([PR #133](https://github.com/m-cahill/starlab/pull/133); merge `33b27738…`; **authoritative PR-head CI** [`24940027890`](https://github.com/m-cahill/starlab/actions/runs/24940027890); **merge-boundary `main` CI** [`24940102671`](https://github.com/m-cahill/starlab/actions/runs/24940102671)); **public closeout** **`implementation_ready_waiting_for_operator_run`**; **no** operator-local long campaign **completed**; **`long_gpu_run_authorized` false** on fixture/public path. **Closed v1.5 line on `main`:** **`V15-M00`**…**`V15-M09`**. **Authority:** **`docs/starlab-v1.5.md`**. M08 runtime: **`docs/runtime/v15_long_gpu_campaign_execution_v1.md`**. M07 (closed) runtime: **`docs/runtime/v15_training_smoke_short_gpu_shakedown_v1.md`**, [PR #129](https://github.com/m-cahill/starlab/pull/129) — **authoritative PR-head CI** [`24925848388`](https://github.com/m-cahill/starlab/actions/runs/24925848388); **merge-boundary `main` CI** [`24925929052`](https://github.com/m-cahill/starlab/actions/runs/24925929052) — **success**; **operator-local shakedown** status: **tooling-only** / **`operator_local_short_gpu_not_run`**. **`V15-M06`**: **`docs/runtime/v15_human_panel_benchmark_protocol_v1.md`**; **`V15-M05`**: **`docs/runtime/v15_strong_agent_benchmark_protocol_v1.md`**; **`V15-M04`**: **`docs/runtime/v15_xai_evidence_contract_v1.md`**; **`V15-M03`**: **`docs/runtime/v15_checkpoint_lineage_resume_discipline_v1.md`**; **`V15-M02`**: **`docs/runtime/v15_long_gpu_run_environment_lock_v1.md`**; **`V15-M01`**: **`docs/runtime/v15_training_scale_provenance_asset_registers_v1.md`**.
...
### V15-M10 — *Replay-Native XAI Demonstration* — **opened** (implementation)

**V15-M10** defines `starlab.v15.replay_native_xai_demonstration.v1` with `python -m starlab.v15.emit_v15_replay_native_xai_demonstration` (default **`fixture_ci`**; optional **`operator_declared`**; optional **`operator_preflight`**). Emits `v15_replay_native_xai_demonstration.json`, JSON report, and `v15_xai_explanation_report.md`. **Not** real XAI inference, **not** faithfulness proof, **not** a promoted-checkpoint claim on the default path. **Runtime** **`docs/runtime/v15_replay_native_xai_demonstration_v1.md`**. See **`docs/starlab-v1.5.md`** (M10 non-claims). *Future doc-density cleanup* may consolidate redundant V15 runtime pointers here without duplicating `docs/starlab-v1.5.md` narrative.
