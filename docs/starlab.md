...
| Current milestone | **`V15-M35`** — *Candidate Checkpoint Smoke Benchmark Readiness* — **provisional** — stub only; **not** an executed benchmark by default — see **`docs/starlab-v1.5.md`** |
...
| Next planned follow-on | **`V15-M35`** — *Candidate Checkpoint Smoke Benchmark Readiness* — **provisional** stub; see **`docs/starlab-v1.5.md`**. **`V15-M34`** **closed** on **`main`** ([PR #170](https://github.com/m-cahill/starlab/pull/170)) — operator-local **M32→M33** CUDA chain for SHA **`eac6fc1f37aa958279a80209822765ecfa6aa2525ed64a8bee88c0ac2be13d26`**. |
