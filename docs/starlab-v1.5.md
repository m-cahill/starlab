...
| **V15-M08** | Long GPU Campaign Execution — **implementation in progress** (`emit_v15_long_gpu_training_manifest`, `run_v15_long_gpu_campaign`; `docs/runtime/v15_long_gpu_campaign_execution_v1.md`) — **not** operator long-run **closed** until receipts; fixture **`long_gpu_run_authorized` false** |
