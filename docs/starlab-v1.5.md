...
| **V15-M12** | Showcase Agent Release Pack — **opened / implementation** — release-pack **surface** only; default blocked / fixture; **`docs/runtime/v15_showcase_agent_release_pack_v1.md`** |
