...
| **V15-M15** | Operator Evidence Collection Preflight — **closed** on `main` ([PR #141](https://github.com/m-cahill/starlab/pull/141)) — **`docs/runtime/v15_operator_evidence_collection_preflight_v1.md`**; **not** operator evidence collection; preflight/sequencing only; **M16**–**M21** **proposed** |
...
| V15-M15 | Operator evidence collection preflight and sequencing (contract + checklist) | **closed** on `main` (PR #141); **`preflight_plan_ready`**; **not** collection; **V15-M16**+ **proposed** |
| V15-M16 | Short GPU / environment evidence (operator-local) | private artifacts; no public claim by default |
