...
| **V15-M09** | Checkpoint Evaluation and Promotion — **governance surface implemented** (implementation PR pending merge); default posture **blocked** / **not promoted** when M08 campaign receipt absent; **`docs/runtime/v15_checkpoint_evaluation_promotion_v1.md`** |
