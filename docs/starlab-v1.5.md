...
| **V15-M10** | Replay-Native XAI Demonstration — **opened** (implementation) — `emit_v15_replay_native_xai_demonstration`; `docs/runtime/v15_replay_native_xai_demonstration_v1.md`; default **fixture** / **blocked**; **not** real inference |
