...
| **V15-M15** | Operator Evidence Collection Preflight — **closed** on `main` ([PR #141](https://github.com/m-cahill/starlab/pull/141)) — **`docs/runtime/v15_operator_evidence_collection_preflight_v1.md`**; **not** operator evidence collection; preflight/sequencing only; **M17**–**M21** **proposed** in the preflight map (**M16** **closed** on `main` — [PR #142](https://github.com/m-cahill/starlab/pull/142)) |
...
| **V15-M17** | Long GPU Campaign Evidence Collection — **opened / implementation** (not closed on `main` at this checkpoint) |
...
| V15-M16 | Short GPU / environment evidence (operator-local optional) | **closed** on `main` (PR #142); fixture CI + optional dual-guarded probe; **`long_gpu_run_authorized` false**; evidence **surface ready**; **V15-M17**+ **proposed** |
| V15-M17 | Long GPU campaign evidence collection | **implementation**; preflight + M16 SHA binding; no default campaign-complete claim |
