...
| **V15-M15** | Operator Evidence Collection Preflight — **closed** on `main` ([PR #141](https://github.com/m-cahill/starlab/pull/141)) — **`docs/runtime/v15_operator_evidence_collection_preflight_v1.md`**; **not** operator evidence collection; preflight/sequencing only; **M17**–**M21** **proposed** after **M16** opens |
| **V15-M16** | Short GPU / Environment Evidence Collection — **opened / implementation** — **`docs/runtime/v15_short_gpu_environment_evidence_v1.md`**; bounded environment / short-GPU evidence; **not** long GPU campaign |
...
| V15-M16 | Short GPU / environment evidence (operator-local optional) | **opened / implementation**; fixture CI + optional dual-guarded probe; **`long_gpu_run_authorized` false**; **V15-M17**+ **proposed** |
