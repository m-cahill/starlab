...
| **V15-M13** | v2 Go / No-Go Decision — **opened / implementation** — decision surface only; default no-go / fixture; **`docs/runtime/v15_v2_go_no_go_decision_v1.md`** |
