...
| **V15-M06** | Human Panel Benchmark Protocol — **in progress** (protocol + fixture; not human **execution**; await merge) |
| **V15-M07** | Training Smoke and Short GPU Shakedown — **not** started (awaits plan approval) |
...
- `starlab.v15.human_panel_benchmark.v1` (**M06** — human-panel **protocol** contract; **in progress**; embeds **`protocol_profile_id`:** `starlab.v15.human_panel_benchmark_protocol.v1`)
