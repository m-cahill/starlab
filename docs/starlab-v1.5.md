...
| **V15-M15** | Operator Evidence Collection Preflight — **opened** / **implementation** — **`docs/runtime/v15_operator_evidence_collection_preflight_v1.md`**; **not** operator evidence collection; **M16**–**M21** **proposed** |
...
| V15-M15 | Operator evidence collection preflight and sequencing (contract + checklist) | **implementation**; preflight/definition only; **not** collection |
