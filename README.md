...
| | |
| --- | --- |
| **Current milestone** | **M43** — Hierarchical Training Pipeline v1 (**stub**; Phase VI; **not** claimed until merged to `main`) |
