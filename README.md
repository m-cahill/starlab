...
6. **Governed Agent Training, Comparison, and Local Validation** (Phase VI — **M40**–**M45**; **M40** charter **closed** on `main`; **M41** replay-imitation training pipeline **closed** on `main`; **M42** learned-agent comparison harness **closed** on `main`; **M43** hierarchical training pipeline **closed** on `main`; **M44**–**M45** stub until each closes)
...
| | |
| --- | --- |
| **Current milestone** | **M44** — Local Live-Play Validation Harness v1 (**stub**; Phase VI; **not** claimed until closed on `main`) |
| **Last closed** | **M43** — Hierarchical Training Pipeline v1 ([PR #54](https://github.com/m-cahill/starlab/pull/54)); prior **M42** — [PR #53](https://github.com/m-cahill/starlab/pull/53) |
| **Next** | **M45** — Self-Play / RL Bootstrap v1 (**planned**; stub until chartered) |
